...
/**
 * ResourceLimitExceededError Class Doc Comment
 *
 * @category Class
 * @package  AffinidiTdk\Clients\Iota
 * @author   OpenAPI Generator team
 ...
 */
class ResourceLimitExceededError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResourceLimitExceededError';
    ...
    public const NAME_RESOURCE_LIMIT_EXCEEDED_ERROR = 'ResourceLimitExceededError';
    public const MESSAGE_RESOURCE_LIMIT_EXCEEDED___PARAM = 'Resource limit exceeded: ${param}.';
    public const HTTP_STATUS_CODE_NUMBER_422 = 422;
    ...
    {
        return [
            self::NAME_RESOURCE_LIMIT_EXCEEDED_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_RESOURCE_LIMIT_EXCEEDED___PARAM,
        ];
    }
    ...
    {
        return [
            self::HTTP_STATUS_CODE_NUMBER_422,
        ];
    }
