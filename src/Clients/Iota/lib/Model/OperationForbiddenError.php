 ...
 */
class OperationForbiddenError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OperationForbiddenError';
    ...
    public const NAME_OPERATION_FORBIDDEN_ERROR = 'OperationForbiddenError';
    public const MESSAGE_OPERATION_FORBIDDEN___PARAM = 'Operation forbidden: ${param}.';
    ...
    {
        return [
            self::NAME_OPERATION_FORBIDDEN_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_OPERATION_FORBIDDEN___PARAM,
        ];
    }
