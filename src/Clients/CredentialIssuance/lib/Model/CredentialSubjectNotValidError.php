...
/**
 * CredentialSubjectNotValidError Class Doc Comment
 *
 * @category Class
 * @package  AffinidiTdk\Clients\CredentialIssuance
 * @author   OpenAPI Generator team
 ...
 */
class CredentialSubjectNotValidError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CredentialSubjectNotValidError';
    ...
    public const NAME_CREDENTIAL_SUBJECT_NOT_VALID_ERROR = 'CredentialSubjectNotValidError';
    public const MESSAGE_CREDENTIAL_SUBJECT_IS_NOT_ACCORDING_TO_THE_VC_SCHEMA = 'Credential subject is not according to the vc schema';
    ...
    {
        return [
            self::NAME_CREDENTIAL_SUBJECT_NOT_VALID_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_CREDENTIAL_SUBJECT_IS_NOT_ACCORDING_TO_THE_VC_SCHEMA,
        ];
    }
