...
/**
 * ProjectCredentialConfigNotExistError Class Doc Comment
 *
 * @category Class
 * @package  AffinidiTdk\Clients\CredentialIssuance
 * @author   OpenAPI Generator team
 ...
 */
class ProjectCredentialConfigNotExistError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectCredentialConfigNotExistError';
    ...
    public const NAME_PROJECT_CREDENTIAL_CONFIG_NOT_EXIST_ERROR = 'ProjectCredentialConfigNotExistError';
    public const MESSAGE_CREDENTIAL_CONFIG_IS_NOT_AVAILABLE_FOR_THE_PROJECT = 'Credential config is not available for the project';
    ...
    {
        return [
            self::NAME_PROJECT_CREDENTIAL_CONFIG_NOT_EXIST_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_CREDENTIAL_CONFIG_IS_NOT_AVAILABLE_FOR_THE_PROJECT,
        ];
    }
