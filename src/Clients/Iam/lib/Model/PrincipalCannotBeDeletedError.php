 ...
 */
class PrincipalCannotBeDeletedError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PrincipalCannotBeDeletedError';
    ...
    public const NAME_PRINCIPAL_CANNOT_BE_DELETED_ERROR = 'PrincipalCannotBeDeletedError';
    public const MESSAGE_CANNOT_DELETE_OWN_RECORD_FROM_THE_PROJECT_WITH_THE_SAME_PRINCIPAL_ID = 'Cannot delete own record from the project with the same principalId';
    public const HTTP_STATUS_CODE_NUMBER_409 = 409;
    ...
    {
        return [
            self::NAME_PRINCIPAL_CANNOT_BE_DELETED_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_CANNOT_DELETE_OWN_RECORD_FROM_THE_PROJECT_WITH_THE_SAME_PRINCIPAL_ID,
        ];
    }
    ...
    {
        return [
            self::HTTP_STATUS_CODE_NUMBER_409,
        ];
    }
