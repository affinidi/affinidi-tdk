...
/**
 * ResourceCreationError Class Doc Comment
 *
 * @category Class
 * @package  AffinidiTdk\Clients\LoginConfiguration
 * @author   OpenAPI Generator team
 ...
 */
class ResourceCreationError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResourceCreationError';
    ...
    public const NAME_RESOURCE_CREATION_ERROR = 'ResourceCreationError';
    public const MESSAGE_FAILED_TO_CREATE_RESOURCES = 'Failed to create resources.';
    public const HTTP_STATUS_CODE_NUMBER_424 = 424;
    ...
    {
        return [
            self::NAME_RESOURCE_CREATION_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_FAILED_TO_CREATE_RESOURCES,
        ];
    }
    ...
    {
        return [
            self::HTTP_STATUS_CODE_NUMBER_424,
        ];
    }
