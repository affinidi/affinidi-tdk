...
/**
 * InvalidGroupsError Class Doc Comment
 *
 * @category Class
 * @package  AffinidiTdk\Clients\LoginConfiguration
 * @author   OpenAPI Generator team
 ...
 */
class InvalidGroupsError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvalidGroupsError';
    ...
    public const NAME_INVALID_GROUPS_ERROR = 'InvalidGroupsError';
    public const MESSAGE_INVALID_GROUPS_NAMES = 'Invalid groups names';
    ...
    {
        return [
            self::NAME_INVALID_GROUPS_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_INVALID_GROUPS_NAMES,
        ];
    }
