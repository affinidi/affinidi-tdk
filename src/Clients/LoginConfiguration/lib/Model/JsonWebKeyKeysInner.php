...
/**
 * JsonWebKeyKeysInner Class Doc Comment
 *
 * @category Class
 * @package  AffinidiTdk\Clients\LoginConfiguration
 * @author   OpenAPI Generator team
 ...
 */
class JsonWebKeyKeysInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'JsonWebKey_keys_inner';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['x5c'] === null) {
            $invalidProperties[] = "'x5c' can't be null";
        }
