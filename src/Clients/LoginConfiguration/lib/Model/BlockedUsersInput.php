...
/**
 * BlockedUsersInput Class Doc Comment
 *
 * @category Class
 * @package  AffinidiTdk\Clients\LoginConfiguration
 * @author   OpenAPI Generator team
 ...
 */
class BlockedUsersInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BlockedUsersInput';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['user_ids']) > 25)) {
            $invalidProperties[] = "invalid value for 'user_ids', number of items must be less than or equal to 25.";
        }
    ...
    public function setUserIds($user_ids)
    {
        ...
        if ((count($user_ids) > 25)) {
            throw new \InvalidArgumentException('invalid value for $user_ids when calling BlockedUsersInput., number of items must be less than or equal to 25.');
        }
