...
/**
 * GroupsPerUserLimitExceededError Class Doc Comment
 *
 * @category Class
 * @package  AffinidiTdk\Clients\LoginConfiguration
 * @author   OpenAPI Generator team
 ...
 */
class GroupsPerUserLimitExceededError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GroupsPerUserLimitExceededError';
    ...
    public const NAME_GROUPS_PER_USER_LIMIT_EXCEEDED_ERROR = 'GroupsPerUserLimitExceededError';
    public const MESSAGE_AMOUNT_OF_GROUPS_PER_USER_IS_LIMITED = 'Amount of groups per user is limited.';
    ...
    {
        return [
            self::NAME_GROUPS_PER_USER_LIMIT_EXCEEDED_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_AMOUNT_OF_GROUPS_PER_USER_IS_LIMITED,
        ];
    }
