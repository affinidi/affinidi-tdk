...
export const KeyApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['KeyApi.signCredential']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const KeyApiFactory = function (
  ...
  return {
    ...
    signCredential(
      ...
      return localVarFp
        .signCredential(id, signCredentialInputDto, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
...
export const SeedApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.exportSeedAsMnemonic(id, body, options);
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
...
export const SeedApiFactory = function (
  ...
  return {
    ...
    exportSeedAsMnemonic(
      ...
      return localVarFp
        .exportSeedAsMnemonic(id, body, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
