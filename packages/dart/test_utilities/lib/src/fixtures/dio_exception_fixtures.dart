...
class DioExceptionFixtures {
  ...
  static DioException socketExceptionWithMessage({String message = 'Failed to connect'}) => DioException(
        requestOptions: RequestOptions(),
  ...
  static DioException httpExceptionWithMessage({String message = 'Connection failed'}) => DioException(
        requestOptions: RequestOptions(),
