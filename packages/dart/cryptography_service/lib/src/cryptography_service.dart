...
// import 'package:avmp_application/application_logger.dart';
import 'package:avmp_cryptography_service/src/cryptography_service_interface.dart';
import 'package:avmp_cryptography_service/src/models/verify_jwt_result.dart';
...
class CryptographyService implements CryptographyServiceInterface {
  ...
  // final ApplicationLogger _logger;

  CryptographyService();
  // CryptographyService({
  //   required ApplicationLogger logger,
  // }) : _logger = logger;
