...
void main() {
  final Environment local = Environment.getEnvironmentConfig(EnvironmentType.local);
  final Environment development = Environment.getEnvironmentConfig(EnvironmentType.dev);
