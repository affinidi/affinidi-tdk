...
part of 'json_web_key_keys_inner.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$JsonWebKeyKeysInner extends JsonWebKeyKeysInner {
  @override
  final String alg;
  @override
  final String? crv;
  ...
  bool operator ==(Object other) {
    ...
    return other is JsonWebKeyKeysInner &&
        alg == other.alg &&
        crv == other.crv &&
        d == other.d &&
        dp == other.dp &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'JsonWebKeyKeysInner')
          ..add('alg', alg)
          ..add('crv', crv)
          ..add('d', d)
          ..add('dp', dp)
...
class JsonWebKeyKeysInnerBuilder
    implements Builder<JsonWebKeyKeysInner, JsonWebKeyKeysInnerBuilder> {
  _$JsonWebKeyKeysInner? _$v;
  ...
  JsonWebKeyKeysInnerBuilder() {
    JsonWebKeyKeysInner._defaults(this);
  }

  JsonWebKeyKeysInnerBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _alg = $v.alg;
      _crv = $v.crv;
  ...
  @override
  void update(void Function(JsonWebKeyKeysInnerBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  JsonWebKeyKeysInner build() => _build();
