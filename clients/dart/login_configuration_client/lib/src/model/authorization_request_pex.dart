...
@BuiltValue()
abstract class AuthorizationRequestPex
    implements Built<AuthorizationRequestPex, AuthorizationRequestPexBuilder> {
  /// State parameter
  ...
  static Serializer<AuthorizationRequestPex> get serializer =>
      _$AuthorizationRequestPexSerializer();
}

class _$AuthorizationRequestPexSerializer
    implements PrimitiveSerializer<AuthorizationRequestPex> {
  @override
