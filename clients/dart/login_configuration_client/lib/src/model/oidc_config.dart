...
@BuiltValue()
abstract class OIDCConfig implements Built<OIDCConfig, OIDCConfigBuilder> {
  ...
  BuiltList<OIDCConfigCredentialsSupportedDraft00Inner>? get credentialsSupportedDraft00;
  ...
  factory OIDCConfig([void updates(OIDCConfigBuilder b)]) = _$OIDCConfig;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OIDCConfigBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OIDCConfig> get serializer => _$OIDCConfigSerializer();
}

class _$OIDCConfigSerializer implements PrimitiveSerializer<OIDCConfig> {
  @override
  final Iterable<Type> types = const [OIDCConfig, _$OIDCConfig];

  @override
  final String wireName = r'OIDCConfig';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.credentialsSupportedDraft00 != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(BuiltList, [FullType(OIDCConfigCredentialsSupportedDraft00Inner)]),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required OIDCConfigBuilder result,
  ...
  @override
  OIDCConfig deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = OIDCConfigBuilder();
