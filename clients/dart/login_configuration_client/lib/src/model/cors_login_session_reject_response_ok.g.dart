...
part of 'cors_login_session_reject_response_ok.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$CorsLoginSessionRejectResponseOK
    extends CorsLoginSessionRejectResponseOK {
  @override
  ...
  CorsLoginSessionRejectResponseOKBuilder toBuilder() =>
      CorsLoginSessionRejectResponseOKBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is CorsLoginSessionRejectResponseOK &&
        corsLoginSessionRejectResponseOk ==
            other.corsLoginSessionRejectResponseOk;
  }

  @override
  int get hashCode {
    var _$hash = 0;
    _$hash = $jc(_$hash, corsLoginSessionRejectResponseOk.hashCode);
    _$hash = $jf(_$hash);
    return _$hash;
  }
...
class CorsLoginSessionRejectResponseOKBuilder
  ...
  CorsLoginSessionRejectResponseOKBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _corsLoginSessionRejectResponseOk = $v.corsLoginSessionRejectResponseOk;
      _$v = null;
    }
    return this;
  }
  ...
  @override
  void replace(CorsLoginSessionRejectResponseOK other) {
    _$v = other as _$CorsLoginSessionRejectResponseOK;
  }

  @override
  void update(void Function(CorsLoginSessionRejectResponseOKBuilder)? updates) {
