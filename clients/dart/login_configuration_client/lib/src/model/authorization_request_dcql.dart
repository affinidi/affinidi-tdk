...
@BuiltValue()
abstract class AuthorizationRequestDcql implements Built<AuthorizationRequestDcql, AuthorizationRequestDcqlBuilder> {
  /// State parameter
  ...
  factory AuthorizationRequestDcql([void updates(AuthorizationRequestDcqlBuilder b)]) = _$AuthorizationRequestDcql;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AuthorizationRequestDcqlBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AuthorizationRequestDcql> get serializer => _$AuthorizationRequestDcqlSerializer();
}

class _$AuthorizationRequestDcqlSerializer implements PrimitiveSerializer<AuthorizationRequestDcql> {
  @override
  final Iterable<Type> types = const [AuthorizationRequestDcql, _$AuthorizationRequestDcql];
