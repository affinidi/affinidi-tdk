...
class ConfigurationApi {
  ...
  Future<Response<CreateLoginConfigurationOutput>> createLoginConfigurations({
    ...
    CreateLoginConfigurationOutput? _responseData;
    ...
    return Response<CreateLoginConfigurationOutput>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [configurationId] - The id of the login configuration
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<LoginConfigurationClientMetadataOutput>>
    ...
    LoginConfigurationClientMetadataOutput? _responseData;
    ...
    return Response<LoginConfigurationClientMetadataOutput>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<LoginConfigurationObject>> getLoginConfigurationsById({
    ...
    LoginConfigurationObject? _responseData;
    ...
    return Response<LoginConfigurationObject>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ListLoginConfigurationOutput>> listLoginConfigurations({
    ...
    ListLoginConfigurationOutput? _responseData;
    ...
    return Response<ListLoginConfigurationOutput>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [configurationId] - The id of the login configuration
  /// * [updateLoginConfigurationInput] - UpdateLoginConfigurationsById
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
