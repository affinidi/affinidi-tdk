...
class IdpApi {
  ...
  Future<Response<void>> v1LoginProjectProjectIdOauth2AuthGet({ 
    ...
    final _path = r'/v1/login/project/{projectId}/oauth2/auth'.replaceAll('{' r'projectId' '}', encodeQueryParameter(_serializers, projectId, const FullType(String)).toString());
  ...
  Future<Response<void>> v1LoginProjectProjectIdOauth2RevokePost({ 
    ...
    final _path = r'/v1/login/project/{projectId}/oauth2/revoke'.replaceAll('{' r'projectId' '}', encodeQueryParameter(_serializers, projectId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> v1LoginProjectProjectIdOauth2SessionsLogoutGet({ 
    ...
    final _path = r'/v1/login/project/{projectId}/oauth2/sessions/logout'.replaceAll('{' r'projectId' '}', encodeQueryParameter(_serializers, projectId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<OAuth2Token>> v1LoginProjectProjectIdOauth2TokenPost({ 
    ...
    final _path = r'/v1/login/project/{projectId}/oauth2/token'.replaceAll('{' r'projectId' '}', encodeQueryParameter(_serializers, projectId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<GetUserInfo>> v1LoginProjectProjectIdUserinfoGet({ 
    ...
    final _path = r'/v1/login/project/{projectId}/userinfo'.replaceAll('{' r'projectId' '}', encodeQueryParameter(_serializers, projectId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<JsonWebKey>> v1LoginProjectProjectIdWellKnownJwksJsonGet({ 
    ...
    final _path = r'/v1/login/project/{projectId}/.well-known/jwks.json'.replaceAll('{' r'projectId' '}', encodeQueryParameter(_serializers, projectId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OIDCConfig>> v1LoginProjectProjectIdWellKnownOpenidConfigurationGet({ 
    required String projectId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/login/project/{projectId}/.well-known/openid-configuration'.replaceAll('{' r'projectId' '}', encodeQueryParameter(_serializers, projectId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
