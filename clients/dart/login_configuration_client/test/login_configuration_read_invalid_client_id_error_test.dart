...
void main() {
  final instance = LoginConfigurationReadInvalidClientIdErrorBuilder();
  // TODO add properties to the builder and call build()

  group(LoginConfigurationReadInvalidClientIdError, () {
    // String name
    ...
    // BuiltList<InvalidParameterErrorDetailsInner> details
