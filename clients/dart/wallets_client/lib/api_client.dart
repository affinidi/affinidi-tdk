...
class ApiClient {
  ApiClient({this.basePath = 'https://apse1.api.affinidi.io/cwe', this.authentication, this.authTokenHook,});
  ...
  static dynamic fromJson(dynamic value, String targetType, {bool growable = false,}) {
    try {
      switch (targetType) {
        ...
        case 'CreateWalletInput':
          return CreateWalletInput.fromJson(value);
        case 'CreateWalletResponse':
          return CreateWalletResponse.fromJson(value);
        case 'DidKeyInputParams':
          return DidKeyInputParams.fromJson(value);
        case 'DidWebInputParams':
        ...
        case 'WalletDto':
          return WalletDto.fromJson(value);
        case 'WalletDtoKeysInner':
          return WalletDtoKeysInner.fromJson(value);
        case 'WalletsListDto':
          return WalletsListDto.fromJson(value);
        default:
          dynamic match;
