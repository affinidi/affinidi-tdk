...
import 'package:affinidi_tdk_wallets_client/src/model/sign_credentials_jwt_input_dto.dart';
import 'package:affinidi_tdk_wallets_client/src/model/sign_credentials_jwt_result_dto.dart';
import 'package:affinidi_tdk_wallets_client/src/model/sign_credentials_ldp_input_dto.dart';
...
class WalletApi {
  ...
  ///
  /// Parameters:
  /// * [createWalletInput] - CreateWallet
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CreateWalletResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CreateWalletResponse>> createWallet({
    ...
    try {
      const _type = FullType(CreateWalletInput);
      _bodyData = createWalletInput == null
          ? null
    ...
    CreateWalletResponse? _responseData;
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteWallet({
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [WalletDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WalletDto>> getWallet({
    required String walletId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  Future<Response<WalletsListDto>> listWallets({
    ...
    return Response<WalletsListDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [walletId] - id of the wallet
  /// * [signCredentialInputDto] - SignCredential
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SignCredentialResultDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SignCredentialResultDto>> signCredential({
    required String walletId,
    required SignCredentialInputDto signCredentialInputDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    SignCredentialResultDto? _responseData;
    ...
    return Response<SignCredentialResultDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [walletId] - id of the wallet
  /// * [signCredentialsJwtInputDto] - signCredentialsJwt
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SignCredentialsJwtResultDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SignCredentialsJwtResultDto>> signCredentialsJwt({
    required String walletId,
    required SignCredentialsJwtInputDto signCredentialsJwtInputDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    SignCredentialsJwtResultDto? _responseData;
    ...
    return Response<SignCredentialsJwtResultDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [walletId] - id of the wallet
  /// * [signCredentialsLdpInputDto] - signCredentialsLdp
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SignCredentialsLdpResultDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SignCredentialsLdpResultDto>> signCredentialsLdp({
    required String walletId,
    required SignCredentialsLdpInputDto signCredentialsLdpInputDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    SignCredentialsLdpResultDto? _responseData;
    ...
    return Response<SignCredentialsLdpResultDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [walletId] - id of the wallet
  /// * [signCredentialsDm2SdJwtInputDto] - SignCredentialsDm1SdJwt
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SignCredentialsDm2SdJwtResultDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SignCredentialsDm2SdJwtResultDto>> signCredentialsSdJwt({
    required String walletId,
    required SignCredentialsDm2SdJwtInputDto signCredentialsDm2SdJwtInputDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    SignCredentialsDm2SdJwtResultDto? _responseData;
    ...
    return Response<SignCredentialsDm2SdJwtResultDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SignJwtTokenOK] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SignJwtTokenOK>> signJwtToken({
    required String walletId,
    required SignJwtToken signJwtToken,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(SignJwtToken);
    ...
    return Response<SignJwtTokenOK>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [walletId] - id of the wallet
  /// * [signPresentationLdpInputDto] - signPresentationLdp
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SignPresentationLdpResultDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SignPresentationLdpResultDto>> signPresentationsLdp({
    required String walletId,
    required SignPresentationLdpInputDto signPresentationLdpInputDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    SignPresentationLdpResultDto? _responseData;
    ...
    return Response<SignPresentationLdpResultDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [walletId] - id of the wallet
  /// * [updateWalletInput] - UpdateWallet
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [WalletDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WalletDto>> updateWallet({
    required String walletId,
    required UpdateWalletInput updateWalletInput,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
