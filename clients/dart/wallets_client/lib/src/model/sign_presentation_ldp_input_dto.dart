...
@BuiltValue()
abstract class SignPresentationLdpInputDto implements Built<SignPresentationLdpInputDto, SignPresentationLdpInputDtoBuilder> {
  ...
  factory SignPresentationLdpInputDto([void updates(SignPresentationLdpInputDtoBuilder b)]) = _$SignPresentationLdpInputDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SignPresentationLdpInputDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SignPresentationLdpInputDto> get serializer => _$SignPresentationLdpInputDtoSerializer();
}

class _$SignPresentationLdpInputDtoSerializer implements PrimitiveSerializer<SignPresentationLdpInputDto> {
  @override
  final Iterable<Type> types = const [SignPresentationLdpInputDto, _$SignPresentationLdpInputDto];
