...
@BuiltValue()
abstract class DidWebInputParams
    implements Built<DidWebInputParams, DidWebInputParamsBuilder> {
  ...
  factory DidWebInputParams([void updates(DidWebInputParamsBuilder b)]) =
      _$DidWebInputParams;
  ...
  static Serializer<DidWebInputParams> get serializer =>
      _$DidWebInputParamsSerializer();
}

class _$DidWebInputParamsSerializer
    implements PrimitiveSerializer<DidWebInputParams> {
  @override
...
class DidWebInputParamsDidMethodEnum extends EnumClass {
  ...
  static const DidWebInputParamsDidMethodEnum web =
      _$didWebInputParamsDidMethodEnum_web;

  static Serializer<DidWebInputParamsDidMethodEnum> get serializer =>
      _$didWebInputParamsDidMethodEnumSerializer;

  const DidWebInputParamsDidMethodEnum._(String name) : super(name);

  static BuiltSet<DidWebInputParamsDidMethodEnum> get values =>
      _$didWebInputParamsDidMethodEnumValues;
  static DidWebInputParamsDidMethodEnum valueOf(String name) =>
      _$didWebInputParamsDidMethodEnumValueOf(name);
}
