...
@BuiltValue()
abstract class SignPresentationLdpResultDto implements Built<SignPresentationLdpResultDto, SignPresentationLdpResultDtoBuilder> {
  ...
  factory SignPresentationLdpResultDto([void updates(SignPresentationLdpResultDtoBuilder b)]) = _$SignPresentationLdpResultDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SignPresentationLdpResultDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SignPresentationLdpResultDto> get serializer => _$SignPresentationLdpResultDtoSerializer();
}

class _$SignPresentationLdpResultDtoSerializer implements PrimitiveSerializer<SignPresentationLdpResultDto> {
  @override
  final Iterable<Type> types = const [SignPresentationLdpResultDto, _$SignPresentationLdpResultDto];
