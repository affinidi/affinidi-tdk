...
/// * [didMethod]
@BuiltValue()
abstract class DidKeyInputParams
    implements Built<DidKeyInputParams, DidKeyInputParamsBuilder> {
  ...
  factory DidKeyInputParams([void updates(DidKeyInputParamsBuilder b)]) =
      _$DidKeyInputParams;
  ...
  static Serializer<DidKeyInputParams> get serializer =>
      _$DidKeyInputParamsSerializer();
}

class _$DidKeyInputParamsSerializer
    implements PrimitiveSerializer<DidKeyInputParams> {
  @override
...
class DidKeyInputParamsDidMethodEnum extends EnumClass {
  ...
  static const DidKeyInputParamsDidMethodEnum key =
      _$didKeyInputParamsDidMethodEnum_key;

  static Serializer<DidKeyInputParamsDidMethodEnum> get serializer =>
      _$didKeyInputParamsDidMethodEnumSerializer;

  const DidKeyInputParamsDidMethodEnum._(String name) : super(name);

  static BuiltSet<DidKeyInputParamsDidMethodEnum> get values =>
      _$didKeyInputParamsDidMethodEnumValues;
  static DidKeyInputParamsDidMethodEnum valueOf(String name) =>
      _$didKeyInputParamsDidMethodEnumValueOf(name);
}
