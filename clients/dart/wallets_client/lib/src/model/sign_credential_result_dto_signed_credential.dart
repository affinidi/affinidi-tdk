...
@BuiltValue()
abstract class SignCredentialResultDtoSignedCredential
    implements
        Built<SignCredentialResultDtoSignedCredential,
  ...
  factory SignCredentialResultDtoSignedCredential(
          [void updates(SignCredentialResultDtoSignedCredentialBuilder b)]) =
      _$SignCredentialResultDtoSignedCredential;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SignCredentialResultDtoSignedCredentialBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SignCredentialResultDtoSignedCredential> get serializer =>
      _$SignCredentialResultDtoSignedCredentialSerializer();
}

class _$SignCredentialResultDtoSignedCredentialSerializer
    implements PrimitiveSerializer<SignCredentialResultDtoSignedCredential> {
  @override
  ...
  Iterable<Object?> _serializeProperties(Serializers serializers,
      SignCredentialResultDtoSignedCredential object) sync* {}
