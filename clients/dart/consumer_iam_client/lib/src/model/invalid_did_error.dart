...
abstract class InvalidDIDError
  ...
  // enum messageEnum {  Unable to resolve DID method,  };
...
class InvalidDIDErrorMessageEnum extends EnumClass {
  @BuiltValueEnumConst(wireName: r'Unable to resolve DID method')
  static const InvalidDIDErrorMessageEnum unableToResolveDIDMethod =
