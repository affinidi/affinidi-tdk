...
abstract class InvalidParameterError
  ...
  // enum messageEnum {  Invalid parameter,  };
...
class InvalidParameterErrorMessageEnum extends EnumClass {
  @BuiltValueEnumConst(wireName: r'Invalid parameter')
  static const InvalidParameterErrorMessageEnum invalidParameter =
      _$invalidParameterErrorMessageEnum_invalidParameter;
