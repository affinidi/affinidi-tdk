...
import 'package:affinidi_tdk_consumer_iam_client/src/serializers.dart';
import 'package:affinidi_tdk_consumer_iam_client/src/auth/api_key_auth.dart';
import 'package:affinidi_tdk_consumer_iam_client/src/auth/basic_auth.dart';
import 'package:affinidi_tdk_consumer_iam_client/src/auth/bearer_auth.dart';
import 'package:affinidi_tdk_consumer_iam_client/src/auth/oauth.dart';
import 'package:affinidi_tdk_consumer_iam_client/src/api/authz_api.dart';
import 'package:affinidi_tdk_consumer_iam_client/src/api/consumer_auth_api.dart';
import 'package:affinidi_tdk_consumer_iam_client/src/api/well_known_api.dart';

class AffinidiTdkConsumerIamClient {
  static const String basePath = r'https://apse1.api.affinidi.io/cid';

  final Dio dio;
  final Serializers serializers;

  AffinidiTdkConsumerIamClient({
    Dio? dio,
