...
part 'api/x_affinidi_tdk_api.dart';

part 'model/build_credential_request_input.dart';
part 'model/build_credential_request_output.dart';
...
part 'model/verify_credential_share_response_input.dart';
part 'model/verify_credential_share_response_output.dart';
