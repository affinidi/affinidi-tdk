...
class WellKnownOpenIdCredentialIssuerResponse {
  ...
  List<CreateIssuanceConfigInputCredentialSupportedInner> credentialsSupported;
  ...
  static WellKnownOpenIdCredentialIssuerResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return WellKnownOpenIdCredentialIssuerResponse(
        ...
        credentialsSupported: CreateIssuanceConfigInputCredentialSupportedInner.listFromJson(json[r'credentials_supported']),
