...
/// * [altText]
@BuiltValue()
abstract class SupportedCredentialMetadataDisplayInnerLogo
    implements
        Built<SupportedCredentialMetadataDisplayInnerLogo,
  ...
  factory SupportedCredentialMetadataDisplayInnerLogo(
          [void updates(
              SupportedCredentialMetadataDisplayInnerLogoBuilder b)]) =
      _$SupportedCredentialMetadataDisplayInnerLogo;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SupportedCredentialMetadataDisplayInnerLogoBuilder b) =>
      b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SupportedCredentialMetadataDisplayInnerLogo>
      get serializer =>
          _$SupportedCredentialMetadataDisplayInnerLogoSerializer();
}

class _$SupportedCredentialMetadataDisplayInnerLogoSerializer
    implements
        PrimitiveSerializer<SupportedCredentialMetadataDisplayInnerLogo> {
  @override
