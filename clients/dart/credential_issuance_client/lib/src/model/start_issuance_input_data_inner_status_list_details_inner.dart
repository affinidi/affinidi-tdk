...
/// * [standard]
@BuiltValue()
abstract class StartIssuanceInputDataInnerStatusListDetailsInner
    implements
        Built<StartIssuanceInputDataInnerStatusListDetailsInner,
  ...
  factory StartIssuanceInputDataInnerStatusListDetailsInner(
          [void updates(
              StartIssuanceInputDataInnerStatusListDetailsInnerBuilder b)]) =
      _$StartIssuanceInputDataInnerStatusListDetailsInner;
  ...
  static Serializer<StartIssuanceInputDataInnerStatusListDetailsInner>
      get serializer =>
          _$StartIssuanceInputDataInnerStatusListDetailsInnerSerializer();
}

class _$StartIssuanceInputDataInnerStatusListDetailsInnerSerializer
    implements
        PrimitiveSerializer<StartIssuanceInputDataInnerStatusListDetailsInner> {
  @override
...
class StartIssuanceInputDataInnerStatusListDetailsInnerPurposeEnum
  ...
  static const StartIssuanceInputDataInnerStatusListDetailsInnerPurposeEnum
      REVOCABLE =
  ...
  static BuiltSet<StartIssuanceInputDataInnerStatusListDetailsInnerPurposeEnum>
      get values =>
          _$startIssuanceInputDataInnerStatusListDetailsInnerPurposeEnumValues;
  static StartIssuanceInputDataInnerStatusListDetailsInnerPurposeEnum valueOf(
          String name) =>
...
class StartIssuanceInputDataInnerStatusListDetailsInnerStandardEnum
  ...
  static BuiltSet<StartIssuanceInputDataInnerStatusListDetailsInnerStandardEnum>
      get values =>
          _$startIssuanceInputDataInnerStatusListDetailsInnerStandardEnumValues;
  static StartIssuanceInputDataInnerStatusListDetailsInnerStandardEnum valueOf(
          String name) =>
