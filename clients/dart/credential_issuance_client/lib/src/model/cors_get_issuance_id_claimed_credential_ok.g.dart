...
part of 'cors_get_issuance_id_claimed_credential_ok.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$CorsGetIssuanceIdClaimedCredentialOK
    extends CorsGetIssuanceIdClaimedCredentialOK {
  @override
  ...
  CorsGetIssuanceIdClaimedCredentialOKBuilder toBuilder() =>
      CorsGetIssuanceIdClaimedCredentialOKBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is CorsGetIssuanceIdClaimedCredentialOK &&
  ...
  int get hashCode {
    var _$hash = 0;
    _$hash = $jc(_$hash, corsGetIssuanceIdClaimedCredentialOk.hashCode);
    _$hash = $jf(_$hash);
    return _$hash;
  }
...
class CorsGetIssuanceIdClaimedCredentialOKBuilder
  ...
  CorsGetIssuanceIdClaimedCredentialOKBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _corsGetIssuanceIdClaimedCredentialOk =
          $v.corsGetIssuanceIdClaimedCredentialOk;
      _$v = null;
    }
    return this;
  }
  ...
  @override
  void replace(CorsGetIssuanceIdClaimedCredentialOK other) {
    _$v = other as _$CorsGetIssuanceIdClaimedCredentialOK;
  }
