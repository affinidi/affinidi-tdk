...
part of 'cors_get_well_known_open_id_credential_issuer_ok.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$CorsGetWellKnownOpenIdCredentialIssuerOK
    extends CorsGetWellKnownOpenIdCredentialIssuerOK {
  @override
  ...
  bool operator ==(Object other) {
    ...
    return other is CorsGetWellKnownOpenIdCredentialIssuerOK &&
        corsGetWellKnownOpenIdCredentialIssuerOk ==
            other.corsGetWellKnownOpenIdCredentialIssuerOk;
  }

  @override
  int get hashCode {
    var _$hash = 0;
    _$hash = $jc(_$hash, corsGetWellKnownOpenIdCredentialIssuerOk.hashCode);
    _$hash = $jf(_$hash);
    return _$hash;
  }
...
class CorsGetWellKnownOpenIdCredentialIssuerOKBuilder
  ...
  CorsGetWellKnownOpenIdCredentialIssuerOKBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _corsGetWellKnownOpenIdCredentialIssuerOk =
          $v.corsGetWellKnownOpenIdCredentialIssuerOk;
      _$v = null;
    }
    return this;
  }
