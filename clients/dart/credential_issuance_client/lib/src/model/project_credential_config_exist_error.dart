...
abstract class ProjectCredentialConfigExistError
  ...
  static Serializer<ProjectCredentialConfigExistError> get serializer =>
      _$ProjectCredentialConfigExistErrorSerializer();
}

class _$ProjectCredentialConfigExistErrorSerializer
    implements PrimitiveSerializer<ProjectCredentialConfigExistError> {
  @override
...
class ProjectCredentialConfigExistErrorNameEnum extends EnumClass {
  ...
  static BuiltSet<ProjectCredentialConfigExistErrorNameEnum> get values =>
      _$projectCredentialConfigExistErrorNameEnumValues;
  static ProjectCredentialConfigExistErrorNameEnum valueOf(String name) =>
      _$projectCredentialConfigExistErrorNameEnumValueOf(name);
}

class ProjectCredentialConfigExistErrorMessageEnum extends EnumClass {
  @BuiltValueEnumConst(
      wireName:
          r'Credential configuration already exists for this project and only one configuration is allowed per project')
  ...
  static ProjectCredentialConfigExistErrorMessageEnum valueOf(String name) =>
      _$projectCredentialConfigExistErrorMessageEnumValueOf(name);
}

class ProjectCredentialConfigExistErrorHttpStatusCodeEnum extends EnumClass {
  @BuiltValueEnumConst(wireNumber: 400)
  static const ProjectCredentialConfigExistErrorHttpStatusCodeEnum number400 =
