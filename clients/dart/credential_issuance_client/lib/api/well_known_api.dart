...
class WellKnownApi {
  ...
  Future<WellKnownOpenIdCredentialIssuerResponse?> getWellKnownOpenIdCredentialIssuer(String projectId,) async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'WellKnownOpenIdCredentialIssuerResponse',) as WellKnownOpenIdCredentialIssuerResponse;
