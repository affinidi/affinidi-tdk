...
// tests for IssuanceConfigDtoCredentialSupportedInner
void main() {
  // final instance = IssuanceConfigDtoCredentialSupportedInner();

  group('test IssuanceConfigDtoCredentialSupportedInner', () {
