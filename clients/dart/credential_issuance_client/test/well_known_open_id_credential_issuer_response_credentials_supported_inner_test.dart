...
void main() {
  // final instance = WellKnownOpenIdCredentialIssuerResponseCredentialsSupportedInner();

  group('test WellKnownOpenIdCredentialIssuerResponseCredentialsSupportedInner', () {
