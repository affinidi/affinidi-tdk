...
class PexQueryApi {
  ...
  const PexQueryApi(this._dio, this._serializers);
  ...
  /// * [createPexQueryInput] - CreatePexQuery
  ...
  Future<Response<PexQueryDto>> createPexQuery({
    ...
    try {
      ...
      _bodyData =
          _serializers.serialize(createPexQueryInput, specifiedType: _type);
  ...
  Future<Response<JsonObject>> deletePexQueries({
    ...
    try {
      ...
      _bodyData =
          _serializers.serialize(deletePexQueriesInput, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  Future<Response<ListPexQueriesOK>> listPexQueries({
    ...
    ListPexQueriesOK? _responseData;
    ...
    return Response<ListPexQueriesOK>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [configurationId] - ID of the Affinidi Iota Framework configuration.
  /// * [savePexQueriesUpdateInput] - SavePexQueriesInput
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<JsonObject>> savePexQueries({
    ...
    try {
      ...
      _bodyData = _serializers.serialize(savePexQueriesUpdateInput,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  /// * [configurationId] - ID of the Affinidi Iota Framework configuration.
  /// * [queryId] - The ID of the query.
  /// * [updatePexQueryInput] - UpdatePexQueryById
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<PexQueryDto>> updatePexQueryById({
    ...
    try {
      ...
      _bodyData =
          _serializers.serialize(updatePexQueryInput, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
