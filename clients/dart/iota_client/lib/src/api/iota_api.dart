...
class IotaApi {
  ...
  const IotaApi(this._dio, this._serializers);
  ...
  Future<Response<AwsExchangeCredentialsOK>> awsExchangeCredentials({
    ...
    try {
      ...
      _bodyData =
          _serializers.serialize(awsExchangeCredentials, specifiedType: _type);
    ...
    AwsExchangeCredentialsOK? _responseData;
    ...
    return Response<AwsExchangeCredentialsOK>(
      data: _responseData,
  ...
  Future<Response<IotaExchangeCredentialsOK>>
    ...
    try {
      ...
      _bodyData = _serializers.serialize(awsExchangeCredentialsProjectToken,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
    ...
    IotaExchangeCredentialsOK? _responseData;
    ...
    return Response<IotaExchangeCredentialsOK>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<FetchIOTAVPResponseOK>> fetchIotaVpResponse({
    ...
    try {
      ...
      _bodyData = _serializers.serialize(fetchIOTAVPResponseInput,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
    ...
    FetchIOTAVPResponseOK? _responseData;
    ...
    return Response<FetchIOTAVPResponseOK>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<InitiateDataSharingRequestOK>> initiateDataSharingRequest({
    ...
    try {
      ...
      _bodyData = _serializers.serialize(initiateDataSharingRequestInput,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
    ...
    InitiateDataSharingRequestOK? _responseData;
    ...
    return Response<InitiateDataSharingRequestOK>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [iotaExchangeCredentials] - IotaAwsExchangeCredentials
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<IotaExchangeCredentialsOK>> iotaExchangeCredentials({
    ...
    try {
      ...
      _bodyData =
          _serializers.serialize(iotaExchangeCredentials, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
