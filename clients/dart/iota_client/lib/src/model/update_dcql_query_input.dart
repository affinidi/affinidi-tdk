...
@BuiltValue()
abstract class UpdateDcqlQueryInput implements Built<UpdateDcqlQueryInput, UpdateDcqlQueryInputBuilder> {
  ...
  factory UpdateDcqlQueryInput([void updates(UpdateDcqlQueryInputBuilder b)]) = _$UpdateDcqlQueryInput;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpdateDcqlQueryInputBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpdateDcqlQueryInput> get serializer => _$UpdateDcqlQueryInputSerializer();
}

class _$UpdateDcqlQueryInputSerializer implements PrimitiveSerializer<UpdateDcqlQueryInput> {
  @override
  final Iterable<Type> types = const [UpdateDcqlQueryInput, _$UpdateDcqlQueryInput];
