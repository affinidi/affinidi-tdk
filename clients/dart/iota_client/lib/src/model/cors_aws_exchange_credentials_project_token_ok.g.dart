...
part of 'cors_aws_exchange_credentials_project_token_ok.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$CorsAwsExchangeCredentialsProjectTokenOK
    extends CorsAwsExchangeCredentialsProjectTokenOK {
  @override
  ...
  CorsAwsExchangeCredentialsProjectTokenOKBuilder toBuilder() =>
      CorsAwsExchangeCredentialsProjectTokenOKBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is CorsAwsExchangeCredentialsProjectTokenOK &&
  ...
  int get hashCode {
    var _$hash = 0;
    _$hash = $jc(_$hash, corsAwsExchangeCredentialsProjectTokenOk.hashCode);
    _$hash = $jf(_$hash);
    return _$hash;
  }
...
class CorsAwsExchangeCredentialsProjectTokenOKBuilder
  ...
  CorsAwsExchangeCredentialsProjectTokenOKBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _corsAwsExchangeCredentialsProjectTokenOk =
          $v.corsAwsExchangeCredentialsProjectTokenOk;
      _$v = null;
    }
    return this;
  }
  ...
  @override
  void replace(CorsAwsExchangeCredentialsProjectTokenOK other) {
    _$v = other as _$CorsAwsExchangeCredentialsProjectTokenOK;
  }
