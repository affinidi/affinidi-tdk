...
part of 'cors_initiate_data_sharing_request_ok.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$CorsInitiateDataSharingRequestOK
    extends CorsInitiateDataSharingRequestOK {
  @override
  ...
  bool operator ==(Object other) {
    ...
    return other is CorsInitiateDataSharingRequestOK &&
        corsInitiateDataSharingRequestOk ==
            other.corsInitiateDataSharingRequestOk;
  }

  @override
  int get hashCode {
    var _$hash = 0;
    _$hash = $jc(_$hash, corsInitiateDataSharingRequestOk.hashCode);
    _$hash = $jf(_$hash);
    return _$hash;
  }
...
class CorsInitiateDataSharingRequestOKBuilder
  ...
  CorsInitiateDataSharingRequestOKBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _corsInitiateDataSharingRequestOk = $v.corsInitiateDataSharingRequestOk;
      _$v = null;
    }
    return this;
  }
  ...
  @override
  void update(void Function(CorsInitiateDataSharingRequestOKBuilder)? updates) {
