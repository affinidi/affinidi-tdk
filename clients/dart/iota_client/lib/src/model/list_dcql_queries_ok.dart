...
/// * [lastEvaluatedKey] 
@BuiltValue()
abstract class ListDcqlQueriesOK implements Built<ListDcqlQueriesOK, ListDcqlQueriesOKBuilder> {
  ...
  factory ListDcqlQueriesOK([void updates(ListDcqlQueriesOKBuilder b)]) = _$ListDcqlQueriesOK;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ListDcqlQueriesOKBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ListDcqlQueriesOK> get serializer => _$ListDcqlQueriesOKSerializer();
}

class _$ListDcqlQueriesOKSerializer implements PrimitiveSerializer<ListDcqlQueriesOK> {
  @override
