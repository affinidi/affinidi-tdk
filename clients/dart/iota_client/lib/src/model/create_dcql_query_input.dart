...
@BuiltValue()
abstract class CreateDcqlQueryInput
    implements Built<CreateDcqlQueryInput, CreateDcqlQueryInputBuilder> {
  ...
  factory CreateDcqlQueryInput([void updates(CreateDcqlQueryInputBuilder b)]) =
      _$CreateDcqlQueryInput;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CreateDcqlQueryInputBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CreateDcqlQueryInput> get serializer =>
      _$CreateDcqlQueryInputSerializer();
}

class _$CreateDcqlQueryInputSerializer
    implements PrimitiveSerializer<CreateDcqlQueryInput> {
  @override
