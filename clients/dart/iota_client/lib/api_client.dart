...
class ApiClient {
  ApiClient({this.basePath = 'https://apse1.api.affinidi.io/ais', this.authentication, this.authTokenHook,});
    ...
    try {
      switch (targetType) {
        ...
        case 'AlreadyExistsError':
          return AlreadyExistsError.fromJson(value);
        case 'AwsExchangeCredentials':
        ...
        case 'ListLoggedConsentsOK':
          return ListLoggedConsentsOK.fromJson(value);
        case 'ListPexQueriesOK':
          return ListPexQueriesOK.fromJson(value);
        case 'MessagePublishingError':
          return MessagePublishingError.fromJson(value);
        case 'NotFoundError':
          return NotFoundError.fromJson(value);
        case 'OperationForbiddenError':
          return OperationForbiddenError.fromJson(value);
        case 'PexQueryDto':
          return PexQueryDto.fromJson(value);
        case 'PrepareRequest':
          return PrepareRequest.fromJson(value);
        case 'PrepareRequestCreated':
          return PrepareRequestCreated.fromJson(value);
        case 'PrepareRequestCreatedData':
        ...
        case 'UpdateConfigurationByIdOK':
          return UpdateConfigurationByIdOK.fromJson(value);
        case 'UpdatePexQueryInput':
          return UpdatePexQueryInput.fromJson(value);
