...
class CorsAwsExchangeCredentialsProjectTokenOK {
  ...
  static CorsAwsExchangeCredentialsProjectTokenOK? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CorsAwsExchangeCredentialsProjectTokenOK(
        corsAwsExchangeCredentialsProjectTokenOk: mapValueOfType<String>(json, r'corsAwsExchangeCredentialsProjectTokenOk'),
      );
    }
    return null;
  }

  static List<CorsAwsExchangeCredentialsProjectTokenOK> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CorsAwsExchangeCredentialsProjectTokenOK>[];
  ...
  static Map<String, CorsAwsExchangeCredentialsProjectTokenOK> mapFromJson(dynamic json) {
    final map = <String, CorsAwsExchangeCredentialsProjectTokenOK>{};
  ...
  static Map<String, List<CorsAwsExchangeCredentialsProjectTokenOK>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CorsAwsExchangeCredentialsProjectTokenOK>>{};
    if (json is Map && json.isNotEmpty) {
