...
// tests for UpdateConfigurationByIdInputClientMetadata
void main() {
  final instance = UpdateConfigurationByIdInputClientMetadataBuilder();
  // TODO add properties to the builder and call build()

  group(UpdateConfigurationByIdInputClientMetadata, () {
