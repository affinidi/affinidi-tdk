...
class ListIssuanceResponse {
  ...
  ListIssuanceResponse({
    this.issuanceIds = const [],
  });

  /// The list of all issuances for the Project
  List<String> issuanceIds;

  @override
  bool operator ==(Object other) => identical(this, other) || other is ListIssuanceResponse &&
    _deepEquality.equals(other.issuanceIds, issuanceIds);

  @override
  int get hashCode =>
    // ignore: unnecessary_parenthesis
    (issuanceIds.hashCode);

  @override
  String toString() => 'ListIssuanceResponse[issuanceIds=$issuanceIds]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      json[r'issuanceIds'] = this.issuanceIds;
    return json;
  }
  ...
  static ListIssuanceResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ListIssuanceResponse(
        issuanceIds: json[r'issuanceIds'] is Iterable
            ? (json[r'issuanceIds'] as Iterable).cast<String>().toList(growable: false)
            : const [],
      );
    }
    return null;
