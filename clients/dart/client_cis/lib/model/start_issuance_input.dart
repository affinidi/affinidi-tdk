...
class StartIssuanceInput {
  ...
  @override
  String toString() => 'StartIssuanceInput[holderDid=$holderDid, issuanceId=$issuanceId, data=$data]';
  ...
  static StartIssuanceInput? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return StartIssuanceInput(
        ...
        data: StartIssuanceInputData.fromJson(json[r'data'])!,
      );
    }
    return null;
  }
