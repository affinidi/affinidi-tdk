...
@BuiltValue()
abstract class W3cPresentationContext
    implements Built<W3cPresentationContext, W3cPresentationContextBuilder> {
  /// One Of [BuiltList<W3cPresentationContextOneOfInner>], [BuiltMap<String, JsonObject>], [String]
  OneOf get oneOf;

  W3cPresentationContext._();

  factory W3cPresentationContext(
          [void updates(W3cPresentationContextBuilder b)]) =
      _$W3cPresentationContext;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(W3cPresentationContextBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<W3cPresentationContext> get serializer =>
      _$W3cPresentationContextSerializer();
}

class _$W3cPresentationContextSerializer
    implements PrimitiveSerializer<W3cPresentationContext> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
      Serializers serializers, W3cPresentationContext object) sync* {}
  ...
  W3cPresentationContext deserialize(
    ...
    final targetType = const FullType(OneOf, [
      ...
      FullType(BuiltList, [FullType(W3cPresentationContextOneOfInner)]),
    ]);
