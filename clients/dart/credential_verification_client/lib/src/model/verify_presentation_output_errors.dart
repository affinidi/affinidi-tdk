...
@BuiltValue()
abstract class VerifyPresentationOutputErrors implements Built<VerifyPresentationOutputErrors, VerifyPresentationOutputErrorsBuilder> {
  /// Any Of [BuiltList<BuiltMap<String, BuiltList<JsonObject>>>], [BuiltList<String>]
  AnyOf get anyOf;

  VerifyPresentationOutputErrors._();

  factory VerifyPresentationOutputErrors([void updates(VerifyPresentationOutputErrorsBuilder b)]) = _$VerifyPresentationOutputErrors;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(VerifyPresentationOutputErrorsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<VerifyPresentationOutputErrors> get serializer => _$VerifyPresentationOutputErrorsSerializer();
}

class _$VerifyPresentationOutputErrorsSerializer implements PrimitiveSerializer<VerifyPresentationOutputErrors> {
  @override
  final Iterable<Type> types = const [VerifyPresentationOutputErrors, _$VerifyPresentationOutputErrors];
