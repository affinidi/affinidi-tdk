...
class FilterItems {
  /// Returns a new [FilterItems] instance.
  FilterItems({
    this.const_,
    this.enum_ = const [],
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FilterItems &&
    other.const_ == const_ &&
  ...
  /// Returns a new [FilterItems] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static FilterItems? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FilterItems[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FilterItems[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<FilterItems> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <FilterItems>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FilterItems.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, FilterItems> mapFromJson(dynamic json) {
    final map = <String, FilterItems>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FilterItems.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of FilterItems-objects as value to a dart map
  static Map<String, List<FilterItems>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FilterItems>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = FilterItems.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
