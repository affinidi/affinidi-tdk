...
class Error {
  ...
  int get hashCode =>
    ...
    (debugId == null ? 0 : debugId!.hashCode) +
    (details.hashCode);

  @override
  String toString() => 'Error[errorCode=$errorCode, errorMessage=$errorMessage, message=$message, name=$name, debugId=$debugId, details=$details]';
