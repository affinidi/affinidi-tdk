...
part of 'vdip_request_issuance_message.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

VdipRequestIssuanceMessage _$VdipRequestIssuanceMessageFromJson(
        Map<String, dynamic> json) =>
    VdipRequestIssuanceMessage(
      id: json['id'] as String,
      body: VdipRequestIssuanceMessageBody.fromJson(
...
Map<String, dynamic> _$VdipRequestIssuanceMessageToJson(
        VdipRequestIssuanceMessage instance) =>
    <String, dynamic>{
      'id': instance.id,
