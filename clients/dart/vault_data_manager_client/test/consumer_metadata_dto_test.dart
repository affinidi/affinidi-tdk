...
// tests for ConsumerMetadataDto
void main() {
  final instance = ConsumerMetadataDtoBuilder();
  // TODO add properties to the builder and call build()

  group(ConsumerMetadataDto, () {
    // String nodeId
    ...
    // int fileCount
    test('to test the property `fileCount`', () async {
      // TODO
    });

    // int folderCount
    test('to test the property `folderCount`', () async {
      // TODO
    });

    // int profileCount
    test('to test the property `profileCount`', () async {
      // TODO
    });
    ...
    // String consumerId
    test('to test the property `consumerId`', () async {
      // TODO
    });
