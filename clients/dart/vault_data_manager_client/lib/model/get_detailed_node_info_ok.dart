...
class GetDetailedNodeInfoOK {
  /// Returns a new [GetDetailedNodeInfoOK] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GetDetailedNodeInfoOK &&
    other.nodeId == nodeId &&
    other.status == status &&
  ...
  @override
  String toString() => 'GetDetailedNodeInfoOK[nodeId=$nodeId, status=$status, fileCount=$fileCount, profileCount=$profileCount, folderCount=$folderCount, vcCount=$vcCount, name=$name, consumerId=$consumerId, parentNodeId=$parentNodeId, profileId=$profileId, createdAt=$createdAt, modifiedAt=$modifiedAt, createdBy=$createdBy, modifiedBy=$modifiedBy, description=$description, type=$type, link=$link, schema=$schema, consumedFileStorage=$consumedFileStorage, edekInfo=$edekInfo, metadata=$metadata, getUrl=$getUrl]';
  ...
  /// Returns a new [GetDetailedNodeInfoOK] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GetDetailedNodeInfoOK? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "GetDetailedNodeInfoOK[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "GetDetailedNodeInfoOK[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return GetDetailedNodeInfoOK(
        ...
        getUrl: mapValueOfType<String>(json, r'getUrl'),
      );
    }
    return null;
  }

  static List<GetDetailedNodeInfoOK> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <GetDetailedNodeInfoOK>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GetDetailedNodeInfoOK.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, GetDetailedNodeInfoOK> mapFromJson(dynamic json) {
    final map = <String, GetDetailedNodeInfoOK>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GetDetailedNodeInfoOK.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of GetDetailedNodeInfoOK-objects as value to a dart map
  static Map<String, List<GetDetailedNodeInfoOK>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<GetDetailedNodeInfoOK>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = GetDetailedNodeInfoOK.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
