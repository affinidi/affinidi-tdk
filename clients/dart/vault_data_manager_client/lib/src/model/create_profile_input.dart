...
abstract class CreateProfileInput implements Built<CreateProfileInput, CreateProfileInputBuilder> {
  ...
  BuiltList<CreateProfileInputRightsEnum>? get rights;
...
class _$CreateProfileInputSerializer implements PrimitiveSerializer<CreateProfileInput> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.rights != null) {
      ...
      yield serializers.serialize(
        object.rights,
        specifiedType: const FullType(BuiltList, [FullType(CreateProfileInputRightsEnum)]),
      );
    }
  }
      ...
      switch (key) {
        ...
        case r'rights':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(CreateProfileInputRightsEnum)]),
          ) as BuiltList<CreateProfileInputRightsEnum>;
...
class CreateProfileInputRightsEnum extends EnumClass {

  @BuiltValueEnumConst(wireName: r'READ')
  static const CreateProfileInputRightsEnum READ = _$createProfileInputRightsEnum_READ;
  @BuiltValueEnumConst(wireName: r'WRITE')
  static const CreateProfileInputRightsEnum WRITE = _$createProfileInputRightsEnum_WRITE;

  static Serializer<CreateProfileInputRightsEnum> get serializer => _$createProfileInputRightsEnumSerializer;

  const CreateProfileInputRightsEnum._(String name): super(name);

  static BuiltSet<CreateProfileInputRightsEnum> get values => _$createProfileInputRightsEnumValues;
  static CreateProfileInputRightsEnum valueOf(String name) => _$createProfileInputRightsEnumValueOf(name);
}
