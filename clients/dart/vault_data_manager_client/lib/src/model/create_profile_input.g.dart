...
const CreateProfileInputRightsEnum _$createProfileInputRightsEnum_READ =
    const CreateProfileInputRightsEnum._('READ');
const CreateProfileInputRightsEnum _$createProfileInputRightsEnum_WRITE =
    const CreateProfileInputRightsEnum._('WRITE');

CreateProfileInputRightsEnum _$createProfileInputRightsEnumValueOf(
    String name) {
  switch (name) {
    case 'READ':
      return _$createProfileInputRightsEnum_READ;
    case 'WRITE':
      return _$createProfileInputRightsEnum_WRITE;
    default:
      throw new ArgumentError(name);
  }
}

final BuiltSet<CreateProfileInputRightsEnum>
    _$createProfileInputRightsEnumValues = new BuiltSet<
        CreateProfileInputRightsEnum>(const <CreateProfileInputRightsEnum>[
  _$createProfileInputRightsEnum_READ,
  _$createProfileInputRightsEnum_WRITE,
]);

Serializer<CreateProfileInputRightsEnum>
    _$createProfileInputRightsEnumSerializer =
    new _$CreateProfileInputRightsEnumSerializer();

class _$CreateProfileInputRightsEnumSerializer
    implements PrimitiveSerializer<CreateProfileInputRightsEnum> {
  ...
  @override
  final Iterable<Type> types = const <Type>[CreateProfileInputRightsEnum];
  @override
  final String wireName = 'CreateProfileInputRightsEnum';

  @override
  Object serialize(Serializers serializers, CreateProfileInputRightsEnum object,
          {FullType specifiedType = FullType.unspecified}) =>
      _toWire[object.name] ?? object.name;

  @override
  CreateProfileInputRightsEnum deserialize(
          Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      CreateProfileInputRightsEnum.valueOf(
...
class _$CreateProfileInput extends CreateProfileInput {
  ...
  @override
  final BuiltList<CreateProfileInputRightsEnum>? rights;
...
class CreateProfileInputBuilder
  ...
  ListBuilder<CreateProfileInputRightsEnum>? _rights;
  ListBuilder<CreateProfileInputRightsEnum> get rights =>
      _$this._rights ??= new ListBuilder<CreateProfileInputRightsEnum>();
  set rights(ListBuilder<CreateProfileInputRightsEnum>? rights) =>
