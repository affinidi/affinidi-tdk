...
class NodesApi {
  ...
  Future<Response<CreateNodeOK>> createNode({
    ...
    final folderId = createNodeInput.parentNodeId;
    final _path = folderId != null ? '/v1/nodes/$folderId' : '/v1/nodes';
    ...
    final _queryParameters = <String, dynamic>{
      if (parentNodeId != null)
        r'parentNodeId': encodeQueryParameter(
            _serializers, parentNodeId, const FullType(String)),
    };
  ...
  Future<Response<GetDetailedNodeInfoOK>> getDetailedNodeInfo({
    ...
    GetDetailedNodeInfoOK? _responseData;
    ...
    return Response<GetDetailedNodeInfoOK>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ListNodeChildrenOK>> listNodeChildren({
    ...
    ListNodeChildrenOK? _responseData;
    ...
    return Response<ListNodeChildrenOK>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ListRootNodeChildrenOK>> listRootNodeChildren({
    ...
    ListRootNodeChildrenOK? _responseData;
    ...
    return Response<ListRootNodeChildrenOK>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [nodeId] - nodeId of the TRASH_BIN
  /// * [nodeIdToRemove] - nodeId of the node to be deleted from TRASH_BIN
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Parameters:
  /// * [nodeId] - nodeId of the TRASH_BIN
  /// * [nodeIdToRestore] - nodeId of the node to be restored from TRASH_BIN
