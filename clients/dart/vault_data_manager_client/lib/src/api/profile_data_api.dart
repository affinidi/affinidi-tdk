...
class ProfileDataApi {
  ...
  const ProfileDataApi(this._dio, this._serializers);

  /// queryProfileData
  /// Retrieves information from a profile.
  ///
  /// Parameters:
  /// * [nodeId] - the nodeId of the node being operated on
  /// * [dek] - A base64url encoded data encryption key, encrypted using VFS public
  /// * [query] - data query, TBD maybe encode it with base64 to make it url friendly?
  ...
  Future<Response<QueryProfileDataOK>> queryProfileData({
    ...
    QueryProfileDataOK? _responseData;
    ...
    return Response<QueryProfileDataOK>(
      data: _responseData,
  ...
  Future<Response<UpdateProfileDataOK>> updateProfileData({
    ...
    UpdateProfileDataOK? _responseData;
    ...
    return Response<UpdateProfileDataOK>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
