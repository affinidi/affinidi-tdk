...
class FilesApi {
  ...
  ///
  /// Parameters:
  /// * [scannedFileJobId] - Scanned file jobId.
  ...
  Future<Response<GetScannedFileInfoOK>> getScannedFileInfo({ 
    ...
    GetScannedFileInfoOK? _responseData;
    ...
    return Response<GetScannedFileInfoOK>(
      data: _responseData,
  ...
  Future<Response<ListScannedFilesOK>> listScannedFiles({ 
    ...
    ListScannedFilesOK? _responseData;
    ...
    return Response<ListScannedFilesOK>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [startFileScanInput] - StartFileScan
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<StartFileScanOK>> startFileScan({ 
    ...
    return Response<StartFileScanOK>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
