...
class ConfigurationApi {
  ...
  /// * [String] clientId (required):
  ///   OAuth 2.0 Client ID
  Future<LoginConfigurationClientMetadata?> getClientMetadataByClientId(String clientId,) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'LoginConfigurationClientMetadata',) as LoginConfigurationClientMetadata;
