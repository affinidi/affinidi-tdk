...
// tests for CreateLoginConfigurationOutput
void main() {
  // final instance = CreateLoginConfigurationOutput();

  group('test CreateLoginConfigurationOutput', () {
    // Configuration ari
    // String ari
    ...
    // LoginConfigurationClientMetadata clientMetadata
