...
| _CorsApi_         | [**corsConsumerAuthTokenEndpoint**](doc//CorsApi.md#corsconsumerauthtokenendpoint)   | **OPTIONS** /v1/consumer/oauth2/token            | CORS Support                          |
| _DefaultApi_      | [**v1AuthAdminProxyDelete**](doc//DefaultApi.md#v1authadminproxydelete)              | **DELETE** /v1/auth/admin/{proxy+}               |
| _DefaultApi_      | [**v1AuthAdminProxyGet**](doc//DefaultApi.md#v1authadminproxyget)                    | **GET** /v1/auth/admin/{proxy+}                  |
| _DefaultApi_      | [**v1AuthAdminProxyPatch**](doc//DefaultApi.md#v1authadminproxypatch)                | **PATCH** /v1/auth/admin/{proxy+}                |
| _DefaultApi_      | [**v1AuthAdminProxyPost**](doc//DefaultApi.md#v1authadminproxypost)                  | **POST** /v1/auth/admin/{proxy+}                 |
| _DefaultApi_      | [**v1AuthAdminProxyPut**](doc//DefaultApi.md#v1authadminproxyput)                    | **PUT** /v1/auth/admin/{proxy+}                  |
| _DefaultApi_      | [**v1IdpUiProxyDelete**](doc//DefaultApi.md#v1idpuiproxydelete)                      | **DELETE** /v1/idp/ui/{proxy+}                   |
| _DefaultApi_      | [**v1IdpUiProxyGet**](doc//DefaultApi.md#v1idpuiproxyget)                            | **GET** /v1/idp/ui/{proxy+}                      |
| _DefaultApi_      | [**v1IdpUiProxyPatch**](doc//DefaultApi.md#v1idpuiproxypatch)                        | **PATCH** /v1/idp/ui/{proxy+}                    |
| _DefaultApi_      | [**v1IdpUiProxyPost**](doc//DefaultApi.md#v1idpuiproxypost)                          | **POST** /v1/idp/ui/{proxy+}                     |
| _DefaultApi_      | [**v1IdpUiProxyPut**](doc//DefaultApi.md#v1idpuiproxyput)                            | **PUT** /v1/idp/ui/{proxy+}                      |
...
| _XAffinidiTdkApi_ | [**addPrincipalToProject**](doc//XAffinidiTdkApi.md#addprincipaltoproject)           | **POST** /v1/projects/principals                 |
| _XAffinidiTdkApi_ | [**consumerAuthTokenEndpoint**](doc//XAffinidiTdkApi.md#consumerauthtokenendpoint)   | **POST** /v1/consumer/oauth2/token               | The Consumer OAuth 2.0 Token Endpoint |
| _XAffinidiTdkApi_ | [**createProject**](doc//XAffinidiTdkApi.md#createproject)                           | **POST** /v1/projects                            |
| _XAffinidiTdkApi_ | [**createProjectScopedToken**](doc//XAffinidiTdkApi.md#createprojectscopedtoken)     | **POST** /v1/sts/create-project-scoped-token     |
| _XAffinidiTdkApi_ | [**createToken**](doc//XAffinidiTdkApi.md#createtoken)                               | **POST** /v1/tokens                              |
| _XAffinidiTdkApi_ | [**deletePrincipalFromProject**](doc//XAffinidiTdkApi.md#deleteprincipalfromproject) | **DELETE** /v1/projects/principals/{principalId} |
| _XAffinidiTdkApi_ | [**deleteToken**](doc//XAffinidiTdkApi.md#deletetoken)                               | **DELETE** /v1/tokens/{tokenId}                  |
| _XAffinidiTdkApi_ | [**getPolicies**](doc//XAffinidiTdkApi.md#getpolicies)                               | **GET** /v1/policies/principals/{principalId}    |
| _XAffinidiTdkApi_ | [**getToken**](doc//XAffinidiTdkApi.md#gettoken)                                     | **GET** /v1/tokens/{tokenId}                     |
| _XAffinidiTdkApi_ | [**getWellKnownJwks**](doc//XAffinidiTdkApi.md#getwellknownjwks)                     | **GET** /.well-known/jwks.json                   |
| _XAffinidiTdkApi_ | [**listPrincipalsOfProject**](doc//XAffinidiTdkApi.md#listprincipalsofproject)       | **GET** /v1/projects/principals                  |
| _XAffinidiTdkApi_ | [**listProject**](doc//XAffinidiTdkApi.md#listproject)                               | **GET** /v1/projects                             |
| _XAffinidiTdkApi_ | [**listToken**](doc//XAffinidiTdkApi.md#listtoken)                                   | **GET** /v1/tokens                               |
| _XAffinidiTdkApi_ | [**updatePolicies**](doc//XAffinidiTdkApi.md#updatepolicies)                         | **PUT** /v1/policies/principals/{principalId}    |
| _XAffinidiTdkApi_ | [**updateProject**](doc//XAffinidiTdkApi.md#updateproject)                           | **PATCH** /v1/projects/{projectId}               |
| _XAffinidiTdkApi_ | [**updateToken**](doc//XAffinidiTdkApi.md#updatetoken)                               | **PATCH** /v1/tokens/{tokenId}                   |
| _XAffinidiTdkApi_ | [**v1AuthProxyDelete**](doc//XAffinidiTdkApi.md#v1authproxydelete)                   | **DELETE** /v1/auth/{proxy+}                     |
| _XAffinidiTdkApi_ | [**v1AuthProxyGet**](doc//XAffinidiTdkApi.md#v1authproxyget)                         | **GET** /v1/auth/{proxy+}                        |
| _XAffinidiTdkApi_ | [**v1AuthProxyPatch**](doc//XAffinidiTdkApi.md#v1authproxypatch)                     | **PATCH** /v1/auth/{proxy+}                      |
| _XAffinidiTdkApi_ | [**v1AuthProxyPost**](doc//XAffinidiTdkApi.md#v1authproxypost)                       | **POST** /v1/auth/{proxy+}                       |
| _XAffinidiTdkApi_ | [**v1AuthProxyPut**](doc//XAffinidiTdkApi.md#v1authproxyput)                         | **PUT** /v1/auth/{proxy+}                        |
| _XAffinidiTdkApi_ | [**v1IdpProxyDelete**](doc//XAffinidiTdkApi.md#v1idpproxydelete)                     | **DELETE** /v1/idp/{proxy+}                      |
| _XAffinidiTdkApi_ | [**v1IdpProxyGet**](doc//XAffinidiTdkApi.md#v1idpproxyget)                           | **GET** /v1/idp/{proxy+}                         |
| _XAffinidiTdkApi_ | [**v1IdpProxyPatch**](doc//XAffinidiTdkApi.md#v1idpproxypatch)                       | **PATCH** /v1/idp/{proxy+}                       |
| _XAffinidiTdkApi_ | [**v1IdpProxyPost**](doc//XAffinidiTdkApi.md#v1idpproxypost)                         | **POST** /v1/idp/{proxy+}                        |
| _XAffinidiTdkApi_ | [**v1IdpProxyPut**](doc//XAffinidiTdkApi.md#v1idpproxyput)                           | **PUT** /v1/idp/{proxy+}                         |
| _XAffinidiTdkApi_ | [**whoami**](doc//XAffinidiTdkApi.md#whoami)                                         | **GET** /v1/sts/whoami                           |
