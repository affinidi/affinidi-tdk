...
class WellKnownApi {
  ...
  /// Performs an HTTP 'GET /.well-known/did.json' operation and returns the [Response].
  Future<Response> getWellKnownDidWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/.well-known/did.json';
  ...
  Future<GetWellKnownDidOK?> getWellKnownDid() async {
    final response = await getWellKnownDidWithHttpInfo();
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'GetWellKnownDidOK',) as GetWellKnownDidOK;
