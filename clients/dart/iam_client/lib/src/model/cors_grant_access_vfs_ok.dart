...
part 'cors_grant_access_vfs_ok.g.dart';
...
class _$CorsGrantAccessVfsOKSerializer implements PrimitiveSerializer<CorsGrantAccessVfsOK> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.corsGrantAccessVfsOk != null) {
      yield r'corsGrantAccessVfsOk';
      yield serializers.serialize(
        object.corsGrantAccessVfsOk,
  ...
  void _deserializeProperties(
    ...
    required CorsGrantAccessVfsOKBuilder result,
  ...
  @override
  CorsGrantAccessVfsOK deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CorsGrantAccessVfsOKBuilder();
