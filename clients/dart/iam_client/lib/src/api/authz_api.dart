...
class AuthzApi {
  ...
  const AuthzApi(this._dio, this._serializers);
  ...
  ///
  /// Parameters:
  /// * [vFSAccessRight] - Grant access to virtual file system
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<GrantAccessOutput>> grantAccessVfs({ 
    required VFSAccessRight vFSAccessRight,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/authz/vfs/access/{granteeDid}';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(VFSAccessRight);
      _bodyData = _serializers.serialize(vFSAccessRight, specifiedType: _type);
    ...
    GrantAccessOutput? _responseData;
    ...
    return Response<GrantAccessOutput>(
      data: _responseData,
  ...
  /// Parameters:
  /// * [granteeDid] 
  /// * [vFSAccessRight] - update access to virtual file system
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<UpdateAccessOutput>> updateAccessVfs({ 
    ...
    UpdateAccessOutput? _responseData;
    ...
    return Response<UpdateAccessOutput>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
