...
void main() {
  ...
  group(AuthzApi, () {
    ...
    //
    //Future<GrantAccessOutput> grantAccessVfs(VFSAccessRight vFSAccessRight) async
    ...
    // updateAccessVfs
    //
    //Future<UpdateAccessOutput> updateAccessVfs(String granteeDid, VFSAccessRight vFSAccessRight) async
