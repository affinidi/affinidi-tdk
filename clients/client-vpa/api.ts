...
export const CorsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.corsLoginSessionAcceptResponse(
          sessionId,
          options
        );
      const index = configuration?.serverIndex ?? 0;
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.corsLoginSessionRejectResponse(
          sessionId,
          options
        );
      const index = configuration?.serverIndex ?? 0;
...
export const CorsApiFactory = function (
  ...
  return {
    ...
    corsLoginSessionAcceptResponse(
      ...
      return localVarFp
        .corsLoginSessionAcceptResponse(sessionId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Enable CORS by returning correct headers
    ...
    corsLoginSessionRejectResponse(
      ...
      return localVarFp
        .corsLoginSessionRejectResponse(sessionId, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class CorsApi extends BaseAPI {
   ...
   * @memberof CorsApi
   */
  public corsLoginSessionAcceptResponse(
    sessionId: string,
    options?: RawAxiosRequestConfig
  ) {
   ...
   * @memberof CorsApi
   */
  public corsLoginSessionRejectResponse(
    sessionId: string,
    options?: RawAxiosRequestConfig
  ) {
    return CorsApiFp(this.configuration)
...
export const GroupApiFactory = function (
  ...
  return {
    ...
    listGroupUserMappings(
      ...
      return localVarFp
        .listGroupUserMappings(groupName, limit, exclusiveStartKey, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
