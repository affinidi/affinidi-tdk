 ...
 */
class UpdateTokenInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateTokenInput';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['name']) && !preg_match("/.{3,}/", $this->container['name'])) {
            $invalidProperties[] = "invalid value for 'name', must be conform to the pattern /.{3,}/.";
        }
    ...
    public function setName($name)
    {
        ...
        if ((!preg_match("/.{3,}/", ObjectSerializer::toString($name)))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling UpdateTokenInput., must conform to the pattern /.{3,}/.");
        }
