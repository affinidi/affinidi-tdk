 ...
 */
class ActionForbiddenError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActionForbiddenError';
    ...
    public const NAME_ACTION_FORBIDDEN_ERROR = 'ActionForbiddenError';
    public const MESSAGE_PRINCIPAL_CAN_NOT_EXECUTE_ACTION_ON_GIVEN_RESOURCE = 'Principal can not execute action on given resource';
    ...
    {
        return [
            self::NAME_ACTION_FORBIDDEN_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_PRINCIPAL_CAN_NOT_EXECUTE_ACTION_ON_GIVEN_RESOURCE,
        ];
    }
