 ...
 */
class CreateTokenInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateTokenInput';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/.{3,}/", $this->container['name'])) {
    ...
    public function setName($name)
    {
        ...
        if ((!preg_match("/.{3,}/", ObjectSerializer::toString($name)))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling CreateTokenInput., must conform to the pattern /.{3,}/.");
        }
