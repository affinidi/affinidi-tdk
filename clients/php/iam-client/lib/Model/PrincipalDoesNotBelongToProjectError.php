...
/**
 * PrincipalDoesNotBelongToProjectError Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PrincipalDoesNotBelongToProjectError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PrincipalDoesNotBelongToProjectError';
    ...
    public const NAME_PRINCIPAL_DOES_NOT_BELONG_TO_PROJECT_ERROR = 'PrincipalDoesNotBelongToProjectError';
    public const MESSAGE_PRINCIPAL_DOES_NOT_BELONG_TO_THE_GIVEN_PROJECT = 'Principal does not belong to the given project';
    public const HTTP_STATUS_CODE_NUMBER_403 = 403;
    ...
    {
        return [
            self::NAME_PRINCIPAL_DOES_NOT_BELONG_TO_PROJECT_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_PRINCIPAL_DOES_NOT_BELONG_TO_THE_GIVEN_PROJECT,
        ];
    }
    ...
    {
        return [
            self::HTTP_STATUS_CODE_NUMBER_403,
        ];
    }
