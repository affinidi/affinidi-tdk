 ...
 */
class PublicKeyCannotBeResolvedFromDidError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicKeyCannotBeResolvedFromDidError';
    ...
    public const NAME_PUBLIC_KEY_CANNOT_BE_RESOLVED_FROM_DID_ERROR = 'PublicKeyCannotBeResolvedFromDidError';
    public const MESSAGE_UNABLE_TO_RESOLVE_DID_METHOD__INVALID_PUBLIC_KEY = 'Unable to resolve DID method. Invalid public key';
    ...
    {
        return [
            self::NAME_PUBLIC_KEY_CANNOT_BE_RESOLVED_FROM_DID_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_UNABLE_TO_RESOLVE_DID_METHOD__INVALID_PUBLIC_KEY,
        ];
    }
