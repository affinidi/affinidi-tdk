 ...
 */
class JsonWebKeySetDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'JsonWebKeySetDto';
    ...
    */
    ...
    public function setKeys($keys)
    {
        ...
        if ((count($keys) < 1)) {
            throw new \InvalidArgumentException('invalid length for $keys when calling JsonWebKeySetDto., number of items must be greater than or equal to 1.');
        }
