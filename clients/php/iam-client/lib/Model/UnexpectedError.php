...
class UnexpectedError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const NAME_UNEXPECTED_ERROR = 'UnexpectedError';
    public const MESSAGE_UNEXPECTED_ERROR_OCCURRED = 'Unexpected Error Occurred.';
    ...
    {
        return [
            self::MESSAGE_UNEXPECTED_ERROR_OCCURRED,
        ];
    }
