...
/**
 * InvalidJwtTokenError Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InvalidJwtTokenError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvalidJwtTokenError';
    ...
    public const NAME_INVALID_JWT_TOKEN_ERROR = 'InvalidJwtTokenError';
    public const MESSAGE_JWT_TOKEN_IS_INVALID = 'JWT token is invalid';
    public const HTTP_STATUS_CODE_NUMBER_401 = 401;
    ...
    {
        return [
            self::NAME_INVALID_JWT_TOKEN_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_JWT_TOKEN_IS_INVALID,
        ];
    }
    ...
    {
        return [
            self::HTTP_STATUS_CODE_NUMBER_401,
        ];
    }
