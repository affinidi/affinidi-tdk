 ...
 */
class InvalidVPTokenCreationTimeError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvalidVPTokenCreationTimeError';
    ...
    public const NAME_INVALID_VP_TOKEN_CREATION_TIME_ERROR = 'InvalidVPTokenCreationTimeError';
    public const MESSAGE_VP_TOKEN_HAS_EXPIRED = 'VP token has expired';
    ...
    {
        return [
            self::NAME_INVALID_VP_TOKEN_CREATION_TIME_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_VP_TOKEN_HAS_EXPIRED,
        ];
    }
