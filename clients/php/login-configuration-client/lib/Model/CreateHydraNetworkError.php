...
/**
 * CreateHydraNetworkError Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateHydraNetworkError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateHydraNetworkError';
    ...
    public const NAME_CREATE_HYDRA_NETWORK_ERROR = 'CreateHydraNetworkError';
    public const MESSAGE_CREATE_HYDRA_NETWORK_ERROR = 'CreateHydraNetworkError';
    ...
    {
        return [
            self::NAME_CREATE_HYDRA_NETWORK_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_CREATE_HYDRA_NETWORK_ERROR,
        ];
    }
