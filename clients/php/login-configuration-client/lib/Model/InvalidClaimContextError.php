...
/**
 * InvalidClaimContextError Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InvalidClaimContextError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvalidClaimContextError';
    ...
    public const NAME_INVALID_CLAIM_CONTEXT_ERROR = 'InvalidClaimContextError';
    public const MESSAGE_INVALID_CLAIM_CONTEXT = 'Invalid Claim Context';
    ...
    {
        return [
            self::NAME_INVALID_CLAIM_CONTEXT_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_INVALID_CLAIM_CONTEXT,
        ];
    }
