...
/**
 * CreateLoginConfigurations400Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateLoginConfigurations400Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createLoginConfigurations_400_response';
    ...
    public const NAME_CREATE_PROJECT_NETWORK_ERROR = 'CreateProjectNetworkError';
    public const MESSAGE_CREATE_PROJECT_NETWORK_ERROR = 'CreateProjectNetworkError';
    ...
    {
        return [
            self::NAME_CREATE_PROJECT_NETWORK_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_CREATE_PROJECT_NETWORK_ERROR,
        ];
    }
