...
/**
 * GroupUserMappingDto Class Doc Comment
 *
 * @category Class
 * @package  AffinidiTdk\Clients\LoginConfiguration
 * @author   OpenAPI Generator team
 ...
 */
class GroupUserMappingDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GroupUserMappingDto';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['added_at'] === null) {
            $invalidProperties[] = "'added_at' can't be null";
        }
     ...
     * Sets added_at
     *
     * @param string $added_at Group to user mapping creation date
     *
     * @return self
     */
