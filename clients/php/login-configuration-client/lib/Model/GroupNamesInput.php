...
/**
 * GroupNamesInput Class Doc Comment
 *
 * @category Class
 * @package  AffinidiTdk\Clients\LoginConfiguration
 * @author   OpenAPI Generator team
 ...
 */
class GroupNamesInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GroupNamesInput';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['group_names']) > 25)) {
            $invalidProperties[] = "invalid value for 'group_names', number of items must be less than or equal to 25.";
        }
    ...
    public function setGroupNames($group_names)
    {
        ...
        if ((count($group_names) > 25)) {
            throw new \InvalidArgumentException('invalid value for $group_names when calling GroupNamesInput., number of items must be less than or equal to 25.');
        }
