...
/**
 * LoginConfigurationReadInvalidClientIdError Class Doc Comment
 *
 * @category Class
 * @package  AffinidiTdk\Clients\LoginConfiguration
 * @author   OpenAPI Generator team
 ...
 */
class LoginConfigurationReadInvalidClientIdError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoginConfigurationReadInvalidClientIdError';
    ...
    public const NAME_LOGIN_CONFIGURATION_READ_INVALID_CLIENT_ID_ERROR = 'LoginConfigurationReadInvalidClientIdError';
    public const MESSAGE_LOGIN_CONFIGURATION_READ_INVALID_CLIENT_ID_ERROR = 'LoginConfigurationReadInvalidClientIdError';
    ...
    {
        return [
            self::NAME_LOGIN_CONFIGURATION_READ_INVALID_CLIENT_ID_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_LOGIN_CONFIGURATION_READ_INVALID_CLIENT_ID_ERROR,
        ];
    }
