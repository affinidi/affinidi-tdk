 ...
 */
class GetRevocationCredentialStatusOK implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetRevocationCredentialStatusOK';
