...
/**
 * InvalidDidParameterError Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InvalidDidParameterError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvalidDidParameterError';
    ...
    public const NAME_INVALID_DID_PARAMETER_ERROR = 'InvalidDidParameterError';
    public const MESSAGE_GIVEN_DID_IN_FIELD_TO_DID_IS_INVALID__USE_ONLY_RESOLVABLE_FORM_OF_DID = 'Given did in field toDid is invalid. Use only resolvable form of did.';
    ...
    {
        return [
            self::NAME_INVALID_DID_PARAMETER_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_GIVEN_DID_IN_FIELD_TO_DID_IS_INVALID__USE_ONLY_RESOLVABLE_FORM_OF_DID,
        ];
    }
