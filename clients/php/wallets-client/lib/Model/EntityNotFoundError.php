...
/**
 * EntityNotFoundError Class Doc Comment
 *
 * @category Class
 * @package  AffinidiTdk\Clients\Wallets
 * @author   OpenAPI Generator team
 ...
 */
class EntityNotFoundError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EntityNotFoundError';
    ...
    public const NAME_ENTITY_NOT_FOUND_ERROR = 'EntityNotFoundError';
    public const MESSAGE_ENTITY_NOT_FOUND = 'Entity not found';
    public const HTTP_STATUS_CODE_NUMBER_404 = 404;
    ...
    {
        return [
            self::NAME_ENTITY_NOT_FOUND_ERROR,
        ];
    }
    ...
    {
        return [
            self::HTTP_STATUS_CODE_NUMBER_404,
        ];
    }
