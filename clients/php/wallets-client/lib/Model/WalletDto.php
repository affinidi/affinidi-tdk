...
class WalletDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'did_document' => 'object',
        'ari' => 'string',
        'keys' => '\OpenAPI\Client\Model\WalletDtoKeysInner[]',
        'created_at' => 'string',
        'modified_at' => 'string'
    ];
    ...
    */
     ...
     * Gets keys
     *
     * @return \OpenAPI\Client\Model\WalletDtoKeysInner[]|null
     */
     ...
     * Sets keys
     *
     * @param \OpenAPI\Client\Model\WalletDtoKeysInner[]|null $keys keys
     *
     * @return self
     */
