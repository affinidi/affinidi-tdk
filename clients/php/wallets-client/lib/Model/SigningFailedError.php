...
/**
 * SigningFailedError Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SigningFailedError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SigningFailedError';
    ...
    public const NAME_SIGNING_FAILED_ERROR = 'SigningFailedError';
    public const MESSAGE_SIGNING_FAILED = 'Signing failed.';
    ...
    {
        return [
            self::NAME_SIGNING_FAILED_ERROR,
        ];
    }
