...
/**
 * W3cCredentialStatus Class Doc Comment
 *
 * @category Class
 * @package  AffinidiTdk\Clients\CredentialVerification
 * @author   OpenAPI Generator team
 ...
 */
class W3cCredentialStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'W3cCredentialStatus';
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'type' => 'type',
        'revocation_list_index' => 'revocationListIndex',
    ...
    protected static $setters = [
        'id' => 'setId',
        'type' => 'setType',
        'revocation_list_index' => 'setRevocationListIndex',
    ...
    protected static $getters = [
        'id' => 'getId',
        'type' => 'getType',
        'revocation_list_index' => 'getRevocationListIndex',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('revocation_list_index', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['revocation_list_index'] === null) {
            $invalidProperties[] = "'revocation_list_index' can't be null";
        }
    ...
    /**
     * Gets revocation_list_index
     *
     * @return string
     */
    public function getRevocationListIndex()
    {
        return $this->container['revocation_list_index'];
    }

    /**
     * Sets revocation_list_index
     *
     * @param string $revocation_list_index revocation_list_index
     *
     * @return self
     */
    public function setRevocationListIndex($revocation_list_index)
    {
        if (is_null($revocation_list_index)) {
            throw new \InvalidArgumentException('non-nullable revocation_list_index cannot be null');
        }
        $this->container['revocation_list_index'] = $revocation_list_index;
     ...
     *
     * @param string $revocation_list_credential revocation_list_credential
     *
     * @return self
     */
