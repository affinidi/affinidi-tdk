 ...
 */
class SubmissionRequirement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubmissionRequirement';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('from_nested', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['rule']) && !in_array($this->container['rule'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'rule', must be one of '%s'",
                $this->container['rule'],
    ...
    {
        return $this->container['from_nested'];
    }
     ...
     * @return self
     */
    public function setFromNested($from_nested)
    {
        if (is_null($from_nested)) {
            throw new \InvalidArgumentException('non-nullable from_nested cannot be null');
        }
        $this->container['from_nested'] = $from_nested;
