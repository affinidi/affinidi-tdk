...
class Field implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const PREDICATE_REQUIRED = 'required';
    public const PREDICATE_PREFERRED = 'preferred';
     ...
     * @return string[]
     */
    public function getPredicateAllowableValues()
    {
        return [
            self::PREDICATE_REQUIRED,
            self::PREDICATE_PREFERRED,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getPredicateAllowableValues();
        if (!is_null($this->container['predicate']) && !in_array($this->container['predicate'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'predicate', must be one of '%s'",
    ...
    public function setPredicate($predicate)
    {
        ...
        $allowedValues = $this->getPredicateAllowableValues();
        if (!in_array($predicate, $allowedValues, true)) {
