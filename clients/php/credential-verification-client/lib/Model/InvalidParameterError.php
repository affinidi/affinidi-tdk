 ...
 */
class InvalidParameterError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvalidParameterError';
    ...
    protected static $openAPITypes = [
        ...
        'trace_id' => 'string',
        'details' => '\OpenAPI\Client\Model\NotFoundErrorDetailsInner[]'
    ];
    ...
    public const NAME_INVALID_PARAMETER_ERROR = 'InvalidParameterError';
    public const MESSAGE_INVALID_PARAMETER___PARAM = 'Invalid parameter: ${param}.';
    ...
    {
        return [
            self::NAME_INVALID_PARAMETER_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_INVALID_PARAMETER___PARAM,
        ];
    }
    ...
    */
     ...
     * Gets details
     *
     * @return \OpenAPI\Client\Model\NotFoundErrorDetailsInner[]|null
     */
     ...
     * Sets details
     *
     * @param \OpenAPI\Client\Model\NotFoundErrorDetailsInner[]|null $details details
     *
     * @return self
     */
