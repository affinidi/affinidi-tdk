...
class NotFoundError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const NAME_NOT_FOUND_ERROR = 'NotFoundError';
    public const MESSAGE_NOT_FOUND___PARAM = 'Not found: ${param}.';
    ...
    {
        return [
            self::MESSAGE_NOT_FOUND___PARAM,
        ];
    }
