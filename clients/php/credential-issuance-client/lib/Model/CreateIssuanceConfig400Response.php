...
/**
 * CreateIssuanceConfig400Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateIssuanceConfig400Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createIssuanceConfig_400_response';
    ...
    public const NAME_INVALID_ISSUER_WALLET_ERROR = 'InvalidIssuerWalletError';
    public const MESSAGE_ISSUER_WALLET_ID_IS_INVALID = 'issuer wallet id is invalid';
    ...
    {
        return [
            self::NAME_INVALID_ISSUER_WALLET_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_ISSUER_WALLET_ID_IS_INVALID,
        ];
    }
