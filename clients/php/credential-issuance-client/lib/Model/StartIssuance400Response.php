...
/**
 * StartIssuance400Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StartIssuance400Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'startIssuance_400_response';
    ...
    public const NAME_MISSING_HOLDER_DID_ERROR = 'MissingHolderDidError';
    public const MESSAGE_HOLDER_DID_IS_REQUIRED_IN_THIS_CLAIM_MODE = 'holderDID is required in this claimMode';
    ...
    {
        return [
            self::NAME_MISSING_HOLDER_DID_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_HOLDER_DID_IS_REQUIRED_IN_THIS_CLAIM_MODE,
        ];
    }
