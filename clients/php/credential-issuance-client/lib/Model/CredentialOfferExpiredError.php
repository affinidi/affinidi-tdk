...
/**
 * CredentialOfferExpiredError Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CredentialOfferExpiredError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CredentialOfferExpiredError';
    ...
    public const NAME_CREDENTIAL_OFFER_EXPIRED_ERROR = 'CredentialOfferExpiredError';
    public const MESSAGE_CREDENTIAL_OFFER_IS_EXPIRED = 'Credential offer is expired';
    ...
    {
        return [
            self::NAME_CREDENTIAL_OFFER_EXPIRED_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_CREDENTIAL_OFFER_IS_EXPIRED,
        ];
    }
