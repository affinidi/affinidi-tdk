...
/**
 * CredentialOfferClaimedError Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CredentialOfferClaimedError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CredentialOfferClaimedError';
    ...
    public const NAME_CREDENTIAL_OFFER_CLAIMED_ERROR = 'CredentialOfferClaimedError';
    public const MESSAGE_CREDENTIAL_OFFER_IS_ALREADY_CLAIMED = 'Credential offer is already claimed';
    ...
    {
        return [
            self::NAME_CREDENTIAL_OFFER_CLAIMED_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_CREDENTIAL_OFFER_IS_ALREADY_CLAIMED,
        ];
    }
