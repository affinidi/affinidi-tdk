 ...
 */
class ListIssuanceRecordResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListIssuanceRecordResponse';
    ...
    protected static $openAPITypes = [
        'flow_data' => '\OpenAPI\Client\Model\FlowData[]',
    ...
    {
        $this->setIfExists('flow_data', $data ?? [], null);
    ...
    */
     ...
     * Gets flow_data
     *
     * @return \OpenAPI\Client\Model\FlowData[]|null
     */
    public function getFlowData()
    {
        return $this->container['flow_data'];
    }

    /**
     * Sets flow_data
     *
     * @param \OpenAPI\Client\Model\FlowData[]|null $flow_data flow_data
     *
     * @return self
     */
    public function setFlowData($flow_data)
    {
        if (is_null($flow_data)) {
            throw new \InvalidArgumentException('non-nullable flow_data cannot be null');
        }
        $this->container['flow_data'] = $flow_data;
