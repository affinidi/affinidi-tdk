...
/**
 * CreateIssuanceConfigInput Class Doc Comment
 *
 * @category Class
 * @package  AffinidiTdk\Clients\CredentialIssuance
 * @author   OpenAPI Generator team
 ...
 */
class CreateIssuanceConfigInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateIssuanceConfigInput';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['issuer_wallet_id'] === null) {
            $invalidProperties[] = "'issuer_wallet_id' can't be null";
        }
        if (!is_null($this->container['credential_offer_duration']) && ($this->container['credential_offer_duration'] > 604801)) {
            $invalidProperties[] = "invalid value for 'credential_offer_duration', must be smaller than or equal to 604801.";
        }

        if (!is_null($this->container['credential_offer_duration']) && ($this->container['credential_offer_duration'] < 1)) {
            $invalidProperties[] = "invalid value for 'credential_offer_duration', must be bigger than or equal to 1.";
        }
        ...
        if ($this->container['credential_supported'] === null) {
            $invalidProperties[] = "'credential_supported' can't be null";
        }
    ...
    public function setName($name)
    {
        ...
        if ((!preg_match("/^(?!\\s*$).+/", ObjectSerializer::toString($name)))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling CreateIssuanceConfigInput., must conform to the pattern /^(?!\\s*$).+/.");
        }
     ...
     *
     * @param string $issuer_wallet_id Issuer Wallet id
     *
     * @return self
     */
    ...
    public function setCredentialOfferDuration($credential_offer_duration)
    {
        ...
        if (($credential_offer_duration > 604801)) {
            throw new \InvalidArgumentException('invalid value for $credential_offer_duration when calling CreateIssuanceConfigInput., must be smaller than or equal to 604801.');
        }
        if (($credential_offer_duration < 1)) {
            throw new \InvalidArgumentException('invalid value for $credential_offer_duration when calling CreateIssuanceConfigInput., must be bigger than or equal to 1.');
        }
     ...
     * Sets format
     *
     * @param string|null $format String identifying the format of this Credential, i.e., ldp_vc. Depending on the format value, the object contains further elements defining the type
     *
     * @return self
     */
     ...
     *
     * @return \AffinidiTdk\Clients\CredentialIssuance\Model\CredentialSupportedObject[]
     */
     ...
     *
     * @param \AffinidiTdk\Clients\CredentialIssuance\Model\CredentialSupportedObject[] $credential_supported credential_supported
     *
     * @return self
     */
