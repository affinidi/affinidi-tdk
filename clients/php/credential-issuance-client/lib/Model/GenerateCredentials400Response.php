...
/**
 * GenerateCredentials400Response Class Doc Comment
 *
 * @category Class
 * @package  AffinidiTdk\Clients\CredentialIssuance
 * @author   OpenAPI Generator team
 ...
 */
class GenerateCredentials400Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'generateCredentials_400_response';
    ...
    public const NAME_INVALID_PROOF_ERROR = 'InvalidProofError';
    public const MESSAGE_THE_PROOF_IN_THE_CREDENTIAL_REQUEST_IS_INVALID = 'The proof in the Credential Request is invalid';
    ...
    {
        return [
            self::MESSAGE_THE_PROOF_IN_THE_CREDENTIAL_REQUEST_IS_INVALID,
        ];
    }
