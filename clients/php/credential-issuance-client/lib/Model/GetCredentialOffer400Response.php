...
/**
 * GetCredentialOffer400Response Class Doc Comment
 *
 * @category Class
 * @package  AffinidiTdk\Clients\CredentialIssuance
 * @author   OpenAPI Generator team
 ...
 */
class GetCredentialOffer400Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getCredentialOffer_400_response';
    ...
    public const NAME_VC_CLAIMED_ERROR = 'VcClaimedError';
    public const MESSAGE_THE_REQUESTED_VC_HAS_ALREADY_BEEN_CLAIMED_BY_THE_USER = 'The requested VC has already been claimed by the user';
    ...
    {
        return [
            self::MESSAGE_THE_REQUESTED_VC_HAS_ALREADY_BEEN_CLAIMED_BY_THE_USER,
        ];
    }
