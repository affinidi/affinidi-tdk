...
/**
 * InvalidCredentialTypeError Class Doc Comment
 *
 * @category Class
 * @package  AffinidiTdk\Clients\CredentialIssuance
 * @author   OpenAPI Generator team
 ...
 */
class InvalidCredentialTypeError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvalidCredentialTypeError';
    ...
    public const NAME_INVALID_CREDENTIAL_TYPE_ERROR = 'InvalidCredentialTypeError';
    public const MESSAGE_THE_REQUESTED_CREDENTIAL_TYPE_IS_NOT_SUPPORTED = 'The requested credential type is not supported';
    ...
    {
        return [
            self::NAME_INVALID_CREDENTIAL_TYPE_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_THE_REQUESTED_CREDENTIAL_TYPE_IS_NOT_SUPPORTED,
        ];
    }
