...
class ProjectCredentialConfigExistError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const MESSAGE_CREDENTIAL_CONFIG_IS_EXIST_FOR_THE_PROJECT_ONE_CONFIG_IS_ALLOWED_FOR_EACH_PROJECT = 'Credential config is exist for the project, one config is allowed for each project';
    ...
    {
        return [
            self::MESSAGE_CREDENTIAL_CONFIG_IS_EXIST_FOR_THE_PROJECT_ONE_CONFIG_IS_ALLOWED_FOR_EACH_PROJECT,
        ];
    }
