 ...
 */
class UpdateIssuanceConfigInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateIssuanceConfigInput';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((!preg_match("/^(?!\\s*$).+/", ObjectSerializer::toString($name)))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling UpdateIssuanceConfigInput., must conform to the pattern /^(?!\\s*$).+/.");
        }
    ...
    public function setCredentialOfferDuration($credential_offer_duration)
    {
        ...
        if (($credential_offer_duration > 604801)) {
            throw new \InvalidArgumentException('invalid value for $credential_offer_duration when calling UpdateIssuanceConfigInput., must be smaller than or equal to 604801.');
        }
        if (($credential_offer_duration < 1)) {
            throw new \InvalidArgumentException('invalid value for $credential_offer_duration when calling UpdateIssuanceConfigInput., must be bigger than or equal to 1.');
        }
