...
/**
 * InvalidCredentialRequestError Class Doc Comment
 *
 * @category Class
 * @package  AffinidiTdk\Clients\CredentialIssuance
 * @author   OpenAPI Generator team
 ...
 */
class InvalidCredentialRequestError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvalidCredentialRequestError';
    ...
    public const NAME_INVALID_CREDENTIAL_REQUEST_ERROR = 'InvalidCredentialRequestError';
    public const MESSAGE_CREDENTIAL_REQUEST_IS_INVALID = 'Credential Request is invalid';
    ...
    {
        return [
            self::NAME_INVALID_CREDENTIAL_REQUEST_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_CREDENTIAL_REQUEST_IS_INVALID,
        ];
    }
