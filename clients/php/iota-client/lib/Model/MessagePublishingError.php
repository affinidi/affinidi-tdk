...
/**
 * MessagePublishingError Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MessagePublishingError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MessagePublishingError';
    ...
    public const NAME_MESSAGE_PUBLISHING_ERROR = 'MessagePublishingError';
    public const MESSAGE_NOT_ABLE_TO_PUBLISH_MESSAGES_TO_TOPIC = 'Not able to publish messages to topic';
    ...
    {
        return [
            self::NAME_MESSAGE_PUBLISHING_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_NOT_ABLE_TO_PUBLISH_MESSAGES_TO_TOPIC,
        ];
    }
