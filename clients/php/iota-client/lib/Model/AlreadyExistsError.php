...
/**
 * AlreadyExistsError Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AlreadyExistsError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlreadyExistsError';
    ...
    public const NAME_ALREADY_EXISTS_ERROR = 'AlreadyExistsError';
    public const MESSAGE_ALREADY_EXISTS___PARAM = 'Already exists: ${param}.';
    ...
    {
        return [
            self::NAME_ALREADY_EXISTS_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_ALREADY_EXISTS___PARAM,
        ];
    }
