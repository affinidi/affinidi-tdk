 ...
 */
class InitiateDataSharingRequestOK implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InitiateDataSharingRequestOK';
