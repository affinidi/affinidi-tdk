 ...
 */
class CreateIotaConfigurationInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateIotaConfigurationInput';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['token_max_age']) && ($this->container['token_max_age'] < 1)) {
            $invalidProperties[] = "invalid value for 'token_max_age', must be bigger than or equal to 1.";
        }
     ...
     *
     * @param bool $enable_consent_audit_log Records the user's consent when they share their data, including the type of data shared when enabled.
     *
     * @return self
     */
    ...
    public function setTokenMaxAge($token_max_age)
    {
        ...
        if (($token_max_age < 1)) {
            throw new \InvalidArgumentException('invalid value for $token_max_age when calling CreateIotaConfigurationInput., must be bigger than or equal to 1.');
        }
