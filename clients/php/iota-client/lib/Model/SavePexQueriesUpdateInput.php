 ...
 */
class SavePexQueriesUpdateInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SavePexQueriesUpdateInput';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['queries']) && (count($this->container['queries']) > 25)) {
            $invalidProperties[] = "invalid value for 'queries', number of items must be less than or equal to 25.";
        }
    ...
    public function setQueries($queries)
    {
        ...
        if ((count($queries) > 25)) {
            throw new \InvalidArgumentException('invalid value for $queries when calling SavePexQueriesUpdateInput., number of items must be less than or equal to 25.');
        }
