...
/**
 * CallbackInput Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CallbackInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CallbackInput';
    ...
    */
     ...
     * Sets state
     *
     * @param string $state A randomly generated string that follows a valid UUID (version 1-5) format to validate the session.
     *
     * @return self
     */
     ...
     * Sets error
     *
     * @param string|null $error A short string indicating the error code reported by the service. It follows the OAuth 2.0 error code format (e.g., invalid_request, access_denied). The default is access_denied.
     *
     * @return self
     */
     ...
     *
     * @param string|null $error_description A human-readable description that provides detailed information about the error.
     *
     * @return self
     */
     ...
     * Sets onboarded
     *
     * @param bool|null $onboarded It specifies whether the data sharing flow triggered an onboarding process to the Affinidi Vault [New User].
     *
     * @return self
     */
