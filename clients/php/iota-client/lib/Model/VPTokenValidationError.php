 ...
 */
class VPTokenValidationError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VPTokenValidationError';
    ...
    public const NAME_VP_TOKEN_VALIDATION_ERROR = 'VPTokenValidationError';
    public const MESSAGE_VP_TOKEN_VALIDATION_ENDED_WITH_AN_ERROR = 'VP token validation ended with an error';
    ...
    {
        return [
            self::NAME_VP_TOKEN_VALIDATION_ERROR,
        ];
    }
    ...
    {
        return [
            self::MESSAGE_VP_TOKEN_VALIDATION_ENDED_WITH_AN_ERROR,
        ];
    }
