...
/**
 * SavePexQueriesUpdateInputQueriesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SavePexQueriesUpdateInputQueriesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SavePexQueriesUpdateInput_queries_inner';
    ...
    */
     ...
     * Sets vp_definition
     *
     * @param string|null $vp_definition The presentation definition describing the data requirement that must be satisfied by the user. The value is in a JSON stringify format.
     *
     * @return self
     */
