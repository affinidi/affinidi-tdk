# affinidi_tdk_consumer_iam_client.ConsumerAuthApi
...
with affinidi_tdk_consumer_iam_client.ApiClient(configuration) as api_client:
    ...
    api_instance = affinidi_tdk_consumer_iam_client.ConsumerAuthApi(api_client)
    consumer_auth_token_endpoint_input = affinidi_tdk_consumer_iam_client.ConsumerAuthTokenEndpointInput() # ConsumerAuthTokenEndpointInput | ConsumerAuthTokenEndpoint
