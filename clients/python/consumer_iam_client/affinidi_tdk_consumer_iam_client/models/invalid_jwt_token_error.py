...
class InvalidJwtTokenError(BaseModel):
    """
    ...
    details: Optional[conlist(InvalidJwtTokenErrorDetailsInner)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InvalidJwtTokenError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InvalidJwtTokenError:
        """Create an instance of InvalidJwtTokenError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InvalidJwtTokenError.parse_obj(obj)

        _obj = InvalidJwtTokenError.parse_obj({
            "name": obj.get("name"),
            "message": obj.get("message"),
            "http_status_code": obj.get("httpStatusCode"),
            "trace_id": obj.get("traceId"),
            "details": [InvalidJwtTokenErrorDetailsInner.from_dict(_item) for _item in obj.get("details")] if obj.get("details") is not None else None
        })
        return _obj
