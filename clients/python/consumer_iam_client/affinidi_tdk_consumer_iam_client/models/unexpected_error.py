...
class UnexpectedError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UnexpectedError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UnexpectedError:
        """Create an instance of UnexpectedError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UnexpectedError.parse_obj(obj)

        _obj = UnexpectedError.parse_obj({
            "name": obj.get("name"),
