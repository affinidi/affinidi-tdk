...
> FlowData change_credential_status(project_id, configuration_id, change_credential_status_input)
...
with affinidi_tdk_credential_issuance_client.ApiClient(configuration) as api_client:
    ...
    change_credential_status_input = affinidi_tdk_credential_issuance_client.ChangeCredentialStatusInput() # ChangeCredentialStatusInput | Request body for changing credential status

    try:
        # change credential status.
        api_response = api_instance.change_credential_status(project_id, configuration_id, change_credential_status_input)
...
| **change_credential_status_input** | [**ChangeCredentialStatusInput**](ChangeCredentialStatusInput.md) | Request body for changing credential status |
