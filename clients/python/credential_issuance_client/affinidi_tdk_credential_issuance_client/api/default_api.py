...
class DefaultApi:
    ...
    @validate_arguments
    def change_credential_status(self, project_id : Annotated[StrictStr, Field(..., description="project id")], configuration_id : Annotated[StrictStr, Field(..., description="configuration id")], **kwargs) -> FlowData:  # noqa: E501
        ...
        >>> thread = api.change_credential_status(project_id, configuration_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.change_credential_status_with_http_info(project_id, configuration_id, **kwargs)  # noqa: E501

    @validate_arguments
    def change_credential_status_with_http_info(self, project_id : Annotated[StrictStr, Field(..., description="project id")], configuration_id : Annotated[StrictStr, Field(..., description="configuration id")], **kwargs) -> ApiResponse:  # noqa: E501
        """change credential status.  # noqa: E501
        ...
        >>> thread = api.change_credential_status_with_http_info(project_id, configuration_id, async_req=True)
        >>> result = thread.get()
