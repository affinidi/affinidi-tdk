...
class UpdateIssuanceConfigInput(BaseModel):
    ...
    __properties = ["name", "description", "issuerWalletId", "credentialOfferDuration", "format", "issuerUri", "credentialSupported", "issuerMetadata", "redirectUri"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateIssuanceConfigInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateIssuanceConfigInput:
        """Create an instance of UpdateIssuanceConfigInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateIssuanceConfigInput.parse_obj(obj)

        _obj = UpdateIssuanceConfigInput.parse_obj({
            "name": obj.get("name"),
