...
class MissingHolderDidError(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MissingHolderDidError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MissingHolderDidError:
        """Create an instance of MissingHolderDidError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MissingHolderDidError.parse_obj(obj)

        _obj = MissingHolderDidError.parse_obj({
            "name": obj.get("name"),
