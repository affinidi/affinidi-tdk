...
class InvalidCredentialRequestError(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InvalidCredentialRequestError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InvalidCredentialRequestError:
        """Create an instance of InvalidCredentialRequestError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InvalidCredentialRequestError.parse_obj(obj)

        _obj = InvalidCredentialRequestError.parse_obj({
            "name": obj.get("name"),
