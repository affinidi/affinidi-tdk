...
class CredentialOfferExpiredError(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CredentialOfferExpiredError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CredentialOfferExpiredError:
        """Create an instance of CredentialOfferExpiredError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CredentialOfferExpiredError.parse_obj(obj)

        _obj = CredentialOfferExpiredError.parse_obj({
            "name": obj.get("name"),
