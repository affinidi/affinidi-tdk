...
class CredentialOfferClaimedError(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CredentialOfferClaimedError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CredentialOfferClaimedError:
        """Create an instance of CredentialOfferClaimedError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CredentialOfferClaimedError.parse_obj(obj)

        _obj = CredentialOfferClaimedError.parse_obj({
            "name": obj.get("name"),
