...
class CreateIssuanceConfig400Response(BaseModel):
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = CreateIssuanceConfig400Response.construct()
        error_messages = []
        match = 0
        ...
        if not isinstance(v, ProjectCredentialConfigNotExistError):
            ...
            match += 1
        # validate data type: ProjectCredentialConfigExistError
        if not isinstance(v, ProjectCredentialConfigExistError):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateIssuanceConfig400Response:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> CreateIssuanceConfig400Response:
        ...
        # deserialize data into ProjectCredentialConfigExistError
        try:
            instance.actual_instance = ProjectCredentialConfigExistError.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
