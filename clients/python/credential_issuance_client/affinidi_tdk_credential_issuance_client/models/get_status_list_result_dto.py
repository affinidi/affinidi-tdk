...
class GetStatusListResultDto(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetStatusListResultDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetStatusListResultDto:
        """Create an instance of GetStatusListResultDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetStatusListResultDto.parse_obj(obj)

        _obj = GetStatusListResultDto.parse_obj({
