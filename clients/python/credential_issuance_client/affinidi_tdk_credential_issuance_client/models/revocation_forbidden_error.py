...
class RevocationForbiddenError(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RevocationForbiddenError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RevocationForbiddenError:
        """Create an instance of RevocationForbiddenError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RevocationForbiddenError.parse_obj(obj)

        _obj = RevocationForbiddenError.parse_obj({
            "name": obj.get("name"),
