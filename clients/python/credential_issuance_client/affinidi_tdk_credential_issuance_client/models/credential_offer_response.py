...
class CredentialOfferResponse(BaseModel):
    ...
    """
    credential_issuer: StrictStr = Field(..., description="The URL of the Credential Issuer")
    credential_configuration_ids: conlist(StrictStr) = Field(..., description="Array of unique strings that each identify one of the keys in the name/value pairs stored in the credentialSupported")
