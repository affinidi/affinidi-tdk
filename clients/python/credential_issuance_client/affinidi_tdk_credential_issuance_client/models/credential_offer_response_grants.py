...
class CredentialOfferResponseGrants(BaseModel):
    ...
    """
    urnietfparamsoauthgrant_typepre_authorized_code: CredentialOfferResponseGrantsUrnIetfParamsOauthGrantTypePreAuthorizedCode = Field(..., alias="urn:ietf:params:oauth:grant-type:pre-authorized_code")
