...
class CredentialIssuanceIdExistError(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CredentialIssuanceIdExistError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CredentialIssuanceIdExistError:
        """Create an instance of CredentialIssuanceIdExistError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CredentialIssuanceIdExistError.parse_obj(obj)

        _obj = CredentialIssuanceIdExistError.parse_obj({
            "name": obj.get("name"),
