...
class IssuanceConfigDto(BaseModel):
    ...
    redirect_uri: Optional[StrictStr] = Field(default=None, alias="redirectUri", description="Uri to be redirect to after issuance")
    __properties = ["id", "name", "description", "issuerDid", "issuerWalletId", "credentialOfferDuration", "cNonceDuration", "format", "issuerUri", "credentialSupported", "issuerMetadata", "version", "redirectUri"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IssuanceConfigDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IssuanceConfigDto:
        """Create an instance of IssuanceConfigDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IssuanceConfigDto.parse_obj(obj)

        _obj = IssuanceConfigDto.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
