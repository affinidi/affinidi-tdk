...
import affinidi_tdk_client_kyc.models
from affinidi_tdk_client_kyc import rest
from affinidi_tdk_client_kyc.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(affinidi_tdk_client_kyc.models, klass)
