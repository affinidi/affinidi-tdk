...
class ConnectorsCreationRequest(BaseModel):
    """
    Request to create a new connector.   # noqa: E501
    """
    name: constr(strict=True, max_length=255, min_length=1) = Field(..., description="The name of the connector. ")
    data_source_ids: conlist(constr(strict=True, max_length=36, min_length=32)) = Field(..., alias="dataSourceIds", description="The list of data source IDs for the connector. ")
    ...
    __properties = ["name", "dataSourceIds", "config", "icon", "websiteUri"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConnectorsCreationRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConnectorsCreationRequest:
        """Create an instance of ConnectorsCreationRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConnectorsCreationRequest.parse_obj(obj)

        _obj = ConnectorsCreationRequest.parse_obj({
            "name": obj.get("name"),
