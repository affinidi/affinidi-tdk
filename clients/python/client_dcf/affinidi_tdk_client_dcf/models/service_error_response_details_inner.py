...
class ServiceErrorResponseDetailsInner(BaseModel):
    """
    Details about an input error informing about the location and the reason of the error.   # noqa: E501
    """
    issue: StrictStr = Field(..., description="Information about what the error is about. ")
    field: Optional[StrictStr] = Field(None, description="Indicates the field which contains or is the issue. ")
    value: Optional[StrictStr] = Field(None, description="Indicates the field value which contains or is the issue. ")
    location: Optional[StrictStr] = Field(None, description="Indicates where the error occurred. ")
