...
class DataSourceResponseDto(BaseModel):
    """
    An object that contains endpoint configurations for data retrievel   # noqa: E501
    """
    data_source_id: StrictStr = Field(..., alias="dataSourceId", description="The ID of the data source. ")
    data_source_config_id: StrictStr = Field(..., alias="dataSourceConfigId", description="The ID of the data source configuration. ")
    data_source_name: constr(strict=True, max_length=255) = Field(..., alias="dataSourceName", description="The name of the data source. ")
    description: Optional[constr(strict=True, max_length=4096)] = Field(None, description="The human readable description of the data source. ")
    ...
    status: StrictStr = Field(..., description="The status of the data source. ")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataSourceResponseDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DataSourceResponseDto:
        """Create an instance of DataSourceResponseDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DataSourceResponseDto.parse_obj(obj)

        _obj = DataSourceResponseDto.parse_obj({
