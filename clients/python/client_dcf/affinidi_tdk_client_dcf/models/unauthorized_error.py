...
class UnauthorizedError(BaseModel):
    ...
    def message_validate_enum(cls, value):
        ...
        if value not in ('Unauthorized request'):
            raise ValueError("must be one of enum values ('Unauthorized request')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UnauthorizedError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UnauthorizedError:
        """Create an instance of UnauthorizedError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UnauthorizedError.parse_obj(obj)

        _obj = UnauthorizedError.parse_obj({
            "name": obj.get("name"),
