...
class DataSourceConfigByIdResponseOneOf(BaseModel):
    """
    Specific data source configuration based on id provided   # noqa: E501
    """
    data_source_config: AuthConfigDto = Field(..., alias="dataSourceConfig")
    __properties = ["dataSourceConfig"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataSourceConfigByIdResponseOneOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DataSourceConfigByIdResponseOneOf:
        """Create an instance of DataSourceConfigByIdResponseOneOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DataSourceConfigByIdResponseOneOf.parse_obj(obj)

        _obj = DataSourceConfigByIdResponseOneOf.parse_obj({
            "data_source_config": AuthConfigDto.from_dict(obj.get("dataSourceConfig")) if obj.get("dataSourceConfig") is not None else None
        })
        return _obj
