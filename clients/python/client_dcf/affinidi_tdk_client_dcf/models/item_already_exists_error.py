...
class ItemAlreadyExistsError(BaseModel):
    ...
    def name_validate_enum(cls, value):
        ...
        if value not in ('ItemAlreadyExistsError'):
            raise ValueError("must be one of enum values ('ItemAlreadyExistsError')")
        return value
    ...
    def message_validate_enum(cls, value):
        ...
        if value not in ('Item already exists'):
            raise ValueError("must be one of enum values ('Item already exists')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ItemAlreadyExistsError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ItemAlreadyExistsError:
        """Create an instance of ItemAlreadyExistsError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ItemAlreadyExistsError.parse_obj(obj)

        _obj = ItemAlreadyExistsError.parse_obj({
            "name": obj.get("name"),
