...
class ActiveConnectionsDto(BaseModel):
    """
    Object describing the information about an active connection.   # noqa: E501
    """
    connector_id: Optional[StrictStr] = Field(None, alias="connectorId", description="The ID of the data connector. ")
    connection_id: Optional[StrictStr] = Field(None, alias="connectionId", description="The ID of the data connection. ")
    connector_name: Optional[StrictStr] = Field(None, alias="connectorName", description="The name of the data connector. ")
    ...
    activated_at: Optional[datetime] = Field(None, alias="activatedAt", description="The date and time at which the connection has been updated. ")
    __properties = ["connectorId", "connectionId", "connectorName", "createdAt", "activatedAt"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActiveConnectionsDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActiveConnectionsDto:
        """Create an instance of ActiveConnectionsDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActiveConnectionsDto.parse_obj(obj)

        _obj = ActiveConnectionsDto.parse_obj({
