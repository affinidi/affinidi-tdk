...
class TransformationTemplateDtoSchemaMapping(BaseModel):
    """
    TransformationTemplateDtoSchemaMapping
    """
    transformations: conlist(TransformationTemplateDtoSchemaMappingTransformationsInner) = Field(...)
    aggregations: conlist(TransformationTemplateDtoSchemaMappingAggregationsInner) = Field(...)
    __properties = ["transformations", "aggregations"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransformationTemplateDtoSchemaMapping:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransformationTemplateDtoSchemaMapping:
        """Create an instance of TransformationTemplateDtoSchemaMapping from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransformationTemplateDtoSchemaMapping.parse_obj(obj)

        _obj = TransformationTemplateDtoSchemaMapping.parse_obj({
            "transformations": [TransformationTemplateDtoSchemaMappingTransformationsInner.from_dict(_item) for _item in obj.get("transformations")] if obj.get("transformations") is not None else None,
            "aggregations": [TransformationTemplateDtoSchemaMappingAggregationsInner.from_dict(_item) for _item in obj.get("aggregations")] if obj.get("aggregations") is not None else None
        })
        return _obj
