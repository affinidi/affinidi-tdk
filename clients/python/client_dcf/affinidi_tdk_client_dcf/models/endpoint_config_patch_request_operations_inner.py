...
class EndpointConfigPatchRequestOperationsInner(BaseModel):
    """
    ...
    source_schema: Optional[Dict[str, Any]] = Field(None, alias="sourceSchema", description="Schema of the response returned by the chosen API endpoint. It serves as a reference to understand the structure and format of data returned by the data source API. ")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EndpointConfigPatchRequestOperationsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EndpointConfigPatchRequestOperationsInner:
        """Create an instance of EndpointConfigPatchRequestOperationsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EndpointConfigPatchRequestOperationsInner.parse_obj(obj)

        _obj = EndpointConfigPatchRequestOperationsInner.parse_obj({
