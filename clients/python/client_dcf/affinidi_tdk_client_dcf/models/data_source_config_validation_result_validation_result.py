...
class DataSourceConfigValidationResultValidationResult(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataSourceConfigValidationResultValidationResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DataSourceConfigValidationResultValidationResult:
        """Create an instance of DataSourceConfigValidationResultValidationResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DataSourceConfigValidationResultValidationResult.parse_obj(obj)

        _obj = DataSourceConfigValidationResultValidationResult.parse_obj({
