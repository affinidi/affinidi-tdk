...
class ResourceNotFoundError(BaseModel):
    ...
    def name_validate_enum(cls, value):
        ...
        if value not in ('ResourceNotFoundError'):
            raise ValueError("must be one of enum values ('ResourceNotFoundError')")
        return value
    ...
    def message_validate_enum(cls, value):
        ...
        if value not in ('The requested resource has not been found'):
            raise ValueError("must be one of enum values ('The requested resource has not been found')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceNotFoundError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceNotFoundError:
        """Create an instance of ResourceNotFoundError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceNotFoundError.parse_obj(obj)

        _obj = ResourceNotFoundError.parse_obj({
            "name": obj.get("name"),
