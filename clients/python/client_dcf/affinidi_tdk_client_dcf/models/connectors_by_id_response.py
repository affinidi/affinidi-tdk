...
class ConnectorsByIdResponse(BaseModel):
    """
    The requested connector.   # noqa: E501
    """
    connector: Optional[ConnectorDTO] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConnectorsByIdResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConnectorsByIdResponse:
        """Create an instance of ConnectorsByIdResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConnectorsByIdResponse.parse_obj(obj)

        _obj = ConnectorsByIdResponse.parse_obj({
