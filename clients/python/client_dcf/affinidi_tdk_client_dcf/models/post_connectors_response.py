...
class PostConnectorsResponse(BaseModel):
    """
    The Connector that hast just been created.   # noqa: E501
    """
    connector: ConnectorDTO = Field(...)
    __properties = ["connector"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostConnectorsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostConnectorsResponse:
        """Create an instance of PostConnectorsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostConnectorsResponse.parse_obj(obj)

        _obj = PostConnectorsResponse.parse_obj({
            "connector": ConnectorDTO.from_dict(obj.get("connector")) if obj.get("connector") is not None else None
        })
        return _obj
