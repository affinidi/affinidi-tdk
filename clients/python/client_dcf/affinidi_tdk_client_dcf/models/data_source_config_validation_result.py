...
class DataSourceConfigValidationResult(BaseModel):
    """
    DataSourceConfigValidationResult
    """
    validation_result: Optional[DataSourceConfigValidationResultValidationResult] = Field(None, alias="validationResult")
    __properties = ["validationResult"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataSourceConfigValidationResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DataSourceConfigValidationResult:
        """Create an instance of DataSourceConfigValidationResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DataSourceConfigValidationResult.parse_obj(obj)

        _obj = DataSourceConfigValidationResult.parse_obj({
            "validation_result": DataSourceConfigValidationResultValidationResult.from_dict(obj.get("validationResult")) if obj.get("validationResult") is not None else None
        })
        return _obj
