...
class ConfigTemplateDtoInner(BaseModel):
    """
    ConfigTemplateDtoInner
    """
    key: StrictStr = Field(..., description="The placeholder name from any template within the postDataSourceConfig payload. ")
    value: StrictStr = Field(..., description="The replacement field name as required by the data connector for the postDataSourceConfig templates. ")
    description: Optional[StrictStr] = Field(None, description="A descriptive comment giving context for the need of this custom field. ")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigTemplateDtoInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigTemplateDtoInner:
        """Create an instance of ConfigTemplateDtoInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigTemplateDtoInner.parse_obj(obj)

        _obj = ConfigTemplateDtoInner.parse_obj({
            "key": obj.get("key"),
            "value": obj.get("value"),
