...
class CallbackResponseOneOf(BaseModel):
    """
    Response payload sent after calling the callback endpoint.   # noqa: E501
    """
    connection_id: Optional[StrictStr] = Field(None, alias="connectionId", description="The ID of the data connector. ")
    data_source: Optional[StrictStr] = Field(None, alias="dataSource", description="The name of the data source. ")
    __properties = ["connectionId", "dataSource"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CallbackResponseOneOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CallbackResponseOneOf:
        """Create an instance of CallbackResponseOneOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CallbackResponseOneOf.parse_obj(obj)

        _obj = CallbackResponseOneOf.parse_obj({
