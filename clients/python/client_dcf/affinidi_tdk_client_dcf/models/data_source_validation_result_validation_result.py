...
class DataSourceValidationResultValidationResult(BaseModel):
    """
    DataSourceValidationResultValidationResult
    """
    is_successful: Optional[StrictBool] = Field(None, alias="isSuccessful")
    connection_id: Optional[StrictStr] = Field(None, alias="connectionId")
    response: Optional[conlist(StrictStr)] = None
    __properties = ["isSuccessful", "connectionId", "response"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataSourceValidationResultValidationResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DataSourceValidationResultValidationResult:
        """Create an instance of DataSourceValidationResultValidationResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DataSourceValidationResultValidationResult.parse_obj(obj)

        _obj = DataSourceValidationResultValidationResult.parse_obj({
            "is_successful": obj.get("isSuccessful"),
