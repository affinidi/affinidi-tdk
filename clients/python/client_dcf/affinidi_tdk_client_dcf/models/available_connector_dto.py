...
class AvailableConnectorDTO(BaseModel):
    """
    Defines the consumer facing information of a connector.   # noqa: E501
    """
    ...
    __properties = ["id", "name", "icon", "websiteUri"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AvailableConnectorDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AvailableConnectorDTO:
        """Create an instance of AvailableConnectorDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AvailableConnectorDTO.parse_obj(obj)

        _obj = AvailableConnectorDTO.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "icon": obj.get("icon"),
