...
class DataSourceCreationResponse(BaseModel):
    """
    Response payload after successful creation of a data source configuration.   # noqa: E501
    """
    data_source_id: Optional[StrictStr] = Field(None, alias="dataSourceId", description="The ID of the data source. ")
    __properties = ["dataSourceId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataSourceCreationResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DataSourceCreationResponse:
        """Create an instance of DataSourceCreationResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DataSourceCreationResponse.parse_obj(obj)

        _obj = DataSourceCreationResponse.parse_obj({
