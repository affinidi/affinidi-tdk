...
class PatchDataSourceStatusResponse(BaseModel):
    """
    ...
    __properties = ["ssoUrl", "dataSource"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchDataSourceStatusResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchDataSourceStatusResponse:
        """Create an instance of PatchDataSourceStatusResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchDataSourceStatusResponse.parse_obj(obj)

        _obj = PatchDataSourceStatusResponse.parse_obj({
            "sso_url": obj.get("ssoUrl"),
            "data_source": DataSource.from_dict(obj.get("dataSource")) if obj.get("dataSource") is not None else None
        })
        return _obj
