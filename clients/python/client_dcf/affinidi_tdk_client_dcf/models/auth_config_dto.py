...
class AuthConfigDto(BaseModel):
    """
    Object describing the information needed for a valid authentication configuration.   # noqa: E501
    """
    id: Optional[StrictStr] = Field(None, description="The ID of the data source. ")
    data_source_config_name: Optional[StrictStr] = Field(None, alias="dataSourceConfigName", description="The name of the data source configuration connected to this authentication configuration. ")
    status: Optional[StrictStr] = Field(None, description="The status of the data source config. ")
    auth_config_info: Optional[AuthConfigInfoDto] = Field(None, alias="authConfigInfo")
    __properties = ["id", "dataSourceConfigName", "status", "authConfigInfo"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuthConfigDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuthConfigDto:
        """Create an instance of AuthConfigDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuthConfigDto.parse_obj(obj)

        _obj = AuthConfigDto.parse_obj({
            "id": obj.get("id"),
