...
class AuthConfigInfoDtoRefreshTokenTemplateOperationsInnerFunctions(BaseModel):
    """
    An object defining functions which process the received refresh token data from the operation.   # noqa: E501
    """
    get_data: conlist(StrictStr) = Field(..., alias="getData")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuthConfigInfoDtoRefreshTokenTemplateOperationsInnerFunctions:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuthConfigInfoDtoRefreshTokenTemplateOperationsInnerFunctions:
        """Create an instance of AuthConfigInfoDtoRefreshTokenTemplateOperationsInnerFunctions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuthConfigInfoDtoRefreshTokenTemplateOperationsInnerFunctions.parse_obj(obj)

        _obj = AuthConfigInfoDtoRefreshTokenTemplateOperationsInnerFunctions.parse_obj({
