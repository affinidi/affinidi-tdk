...
class TransformationTemplateDtoSchemaMappingTransformationsInner(BaseModel):
    """
    TransformationTemplateDtoSchemaMappingTransformationsInner
    """
    name: constr(strict=True) = Field(...)
    fields: Optional[conlist(StrictStr, max_items=1)] = None
    result_field: Optional[StrictStr] = Field(None, alias="resultField")
    additional_properties: Dict[str, Any] = {}
    __properties = ["name", "fields", "resultField"]

    @validator('name')
    def name_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"^(multiply|filter|split|merge|clean|slice|map)$", value):
            raise ValueError(r"must validate the regular expression /^(multiply|filter|split|merge|clean|slice|map)$/")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransformationTemplateDtoSchemaMappingTransformationsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransformationTemplateDtoSchemaMappingTransformationsInner:
        """Create an instance of TransformationTemplateDtoSchemaMappingTransformationsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransformationTemplateDtoSchemaMappingTransformationsInner.parse_obj(obj)

        _obj = TransformationTemplateDtoSchemaMappingTransformationsInner.parse_obj({
            "name": obj.get("name"),
            "fields": obj.get("fields"),
            "result_field": obj.get("resultField")
        })
