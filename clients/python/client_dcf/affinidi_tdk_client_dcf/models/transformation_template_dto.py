...
class TransformationTemplateDto(BaseModel):
    """
    TransformationTemplateDto
    """
    endpoint: StrictStr = Field(...)
    target_schema_url: StrictStr = Field(..., alias="targetSchemaUrl")
    schema_mapping: TransformationTemplateDtoSchemaMapping = Field(..., alias="schemaMapping")
    __properties = ["endpoint", "targetSchemaUrl", "schemaMapping"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransformationTemplateDto:
    ...
    def to_dict(self):
        ...
        if self.schema_mapping:
            _dict['schemaMapping'] = self.schema_mapping.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> TransformationTemplateDto:
        """Create an instance of TransformationTemplateDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransformationTemplateDto.parse_obj(obj)

        _obj = TransformationTemplateDto.parse_obj({
            "endpoint": obj.get("endpoint"),
            "target_schema_url": obj.get("targetSchemaUrl"),
            "schema_mapping": TransformationTemplateDtoSchemaMapping.from_dict(obj.get("schemaMapping")) if obj.get("schemaMapping") is not None else None
        })
        return _obj
