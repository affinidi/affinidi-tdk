...
class AuthConfigInfoDtoRefreshTokenTemplate(BaseModel):
    """
    ...
    operations: conlist(AuthConfigInfoDtoRefreshTokenTemplateOperationsInner) = Field(..., description="A list of REST operations to retrieve an exchange token from the data source. ")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuthConfigInfoDtoRefreshTokenTemplate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuthConfigInfoDtoRefreshTokenTemplate:
        """Create an instance of AuthConfigInfoDtoRefreshTokenTemplate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuthConfigInfoDtoRefreshTokenTemplate.parse_obj(obj)

        _obj = AuthConfigInfoDtoRefreshTokenTemplate.parse_obj({
            "options": obj.get("options"),
            "operations": [AuthConfigInfoDtoRefreshTokenTemplateOperationsInner.from_dict(_item) for _item in obj.get("operations")] if obj.get("operations") is not None else None
        })
        return _obj
