...
class ConnectorDTO(BaseModel):
    """
    An object containing required information to define a connector.   # noqa: E501
    """
    id: constr(strict=True, max_length=36) = Field(..., description="The ID of the connector. ")
    name: constr(strict=True, max_length=255) = Field(..., description="The name of the connector. ")
    created_at: Optional[datetime] = Field(None, alias="createdAt", description="The date and time at which the connector has been created. ")
    data_source_ids: conlist(StrictStr) = Field(..., alias="dataSourceIds", description="A list of IDs of related data sources. ")
    config: ConnectorAuthConfig = Field(...)
    status: Optional[StrictStr] = Field(None, description="The state in which the connector is currently. ")
    icon: Union[StrictBytes, StrictStr] = Field(..., description="The icon of the connector as base64 encoded string. ")
    website_uri: Optional[StrictStr] = Field(None, alias="websiteUri", description="The URL of the website for the connector. ")
    __properties = ["id", "name", "createdAt", "dataSourceIds", "config", "status", "icon", "websiteUri"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConnectorDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConnectorDTO:
