...
class AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInnerFunctions(BaseModel):
    """
    An object defining functions which process the received authentication data from the operation.   # noqa: E501
    """
    get_data: Optional[conlist(StrictStr)] = Field(None, alias="getData")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInnerFunctions:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInnerFunctions:
        """Create an instance of AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInnerFunctions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInnerFunctions.parse_obj(obj)

        _obj = AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInnerFunctions.parse_obj({
