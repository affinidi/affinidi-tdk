...
class AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInner(BaseModel):
    """
    Describes the configuration for a single REST operation retrieving an exchange token from the data source.   # noqa: E501
    """
    template: Optional[Dict[str, Any]] = Field(None, description="An object which defines the REST operation as well as the URL to issue the request. ")
    functions: Optional[AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInnerFunctions] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInner:
        """Create an instance of AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInner.parse_obj(obj)

        _obj = AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInner.parse_obj({
            "template": obj.get("template"),
            "functions": AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInnerFunctions.from_dict(obj.get("functions")) if obj.get("functions") is not None else None
        })
        return _obj
