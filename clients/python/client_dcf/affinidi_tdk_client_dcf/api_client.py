...
import affinidi_tdk_client_dcf.models
from affinidi_tdk_client_dcf import rest
from affinidi_tdk_client_dcf.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(affinidi_tdk_client_dcf.models, klass)
