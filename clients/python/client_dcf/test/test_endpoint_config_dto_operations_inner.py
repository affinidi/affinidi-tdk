...
from affinidi_tdk_client_dcf.models.endpoint_config_dto_operations_inner import EndpointConfigDtoOperationsInner  # noqa: E501

class TestEndpointConfigDtoOperationsInner(unittest.TestCase):
    """EndpointConfigDtoOperationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointConfigDtoOperationsInner:
        """Test EndpointConfigDtoOperationsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointConfigDtoOperationsInner`
        """
        model = EndpointConfigDtoOperationsInner()  # noqa: E501
        if include_optional:
            return EndpointConfigDtoOperationsInner(
                template = { },
                functions = { },
                pagination = { },
                source_schema = { }
    ...
    def testEndpointConfigDtoOperationsInner(self):
        """Test EndpointConfigDtoOperationsInner"""
