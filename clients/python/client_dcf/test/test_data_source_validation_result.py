...
from affinidi_tdk_client_dcf.models.data_source_validation_result import DataSourceValidationResult  # noqa: E501

class TestDataSourceValidationResult(unittest.TestCase):
    """DataSourceValidationResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataSourceValidationResult:
        """Test DataSourceValidationResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataSourceValidationResult`
        """
        model = DataSourceValidationResult()  # noqa: E501
        if include_optional:
    ...
    def testDataSourceValidationResult(self):
        """Test DataSourceValidationResult"""
