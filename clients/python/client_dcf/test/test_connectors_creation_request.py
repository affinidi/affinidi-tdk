...
from affinidi_tdk_client_dcf.models.connectors_creation_request import ConnectorsCreationRequest  # noqa: E501

class TestConnectorsCreationRequest(unittest.TestCase):
    """ConnectorsCreationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectorsCreationRequest:
        """Test ConnectorsCreationRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectorsCreationRequest`
        """
        model = ConnectorsCreationRequest()  # noqa: E501
        if include_optional:
            return ConnectorsCreationRequest(
                name = 'HqXzyCBw3_uufVPIPFhB9J0',
                data_source_ids = [
                    'bf325375-030f-cba091737c574773100b012345678910111213141516171819202122232425262728293031'
                    ],
    ...
    def testConnectorsCreationRequest(self):
        """Test ConnectorsCreationRequest"""
