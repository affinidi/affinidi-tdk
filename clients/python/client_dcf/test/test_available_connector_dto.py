...
from affinidi_tdk_client_dcf.models.available_connector_dto import AvailableConnectorDTO  # noqa: E501

class TestAvailableConnectorDTO(unittest.TestCase):
    """AvailableConnectorDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AvailableConnectorDTO:
        """Test AvailableConnectorDTO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AvailableConnectorDTO`
        """
        model = AvailableConnectorDTO()  # noqa: E501
        if include_optional:
            return AvailableConnectorDTO(
                id = '',
                name = '',
                icon = 'YQ==',
                website_uri = ''
    ...
    def testAvailableConnectorDTO(self):
        """Test AvailableConnectorDTO"""
