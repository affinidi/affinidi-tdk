...
from affinidi_tdk_client_dcf.models.referential_integrity_error import ReferentialIntegrityError  # noqa: E501

class TestReferentialIntegrityError(unittest.TestCase):
    """ReferentialIntegrityError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReferentialIntegrityError:
        """Test ReferentialIntegrityError
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReferentialIntegrityError`
        """
        model = ReferentialIntegrityError()  # noqa: E501
        if include_optional:
    ...
    def testReferentialIntegrityError(self):
        """Test ReferentialIntegrityError"""
