...
from affinidi_tdk_client_dcf.models.active_connections_response import ActiveConnectionsResponse  # noqa: E501

class TestActiveConnectionsResponse(unittest.TestCase):
    """ActiveConnectionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActiveConnectionsResponse:
        """Test ActiveConnectionsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActiveConnectionsResponse`
        """
        model = ActiveConnectionsResponse()  # noqa: E501
        if include_optional:
            return ActiveConnectionsResponse(
                connections = [
                    affinidi_tdk_client_dcf.models.active_connections_dto.ActiveConnectionsDto(
                        connector_id = '', 
                        connection_id = '', 
                        connector_name = '', 
    ...
    def testActiveConnectionsResponse(self):
        """Test ActiveConnectionsResponse"""
