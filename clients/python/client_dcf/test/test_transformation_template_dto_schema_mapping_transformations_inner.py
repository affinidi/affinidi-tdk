...
from affinidi_tdk_client_dcf.models.transformation_template_dto_schema_mapping_transformations_inner import TransformationTemplateDtoSchemaMappingTransformationsInner  # noqa: E501

class TestTransformationTemplateDtoSchemaMappingTransformationsInner(unittest.TestCase):
    """TransformationTemplateDtoSchemaMappingTransformationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransformationTemplateDtoSchemaMappingTransformationsInner:
        """Test TransformationTemplateDtoSchemaMappingTransformationsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransformationTemplateDtoSchemaMappingTransformationsInner`
        """
        model = TransformationTemplateDtoSchemaMappingTransformationsInner()  # noqa: E501
        if include_optional:
            return TransformationTemplateDtoSchemaMappingTransformationsInner(
                name = 'map',
                fields = [
                    ''
                    ],
    ...
    def testTransformationTemplateDtoSchemaMappingTransformationsInner(self):
        """Test TransformationTemplateDtoSchemaMappingTransformationsInner"""
