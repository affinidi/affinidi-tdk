...
from affinidi_tdk_client_dcf.models.config_template_dto import ConfigTemplateDto  # noqa: E501

class TestConfigTemplateDto(unittest.TestCase):
    """ConfigTemplateDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigTemplateDto:
        """Test ConfigTemplateDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigTemplateDto`
        """
        model = ConfigTemplateDto()  # noqa: E501
        if include_optional:
    ...
    def testConfigTemplateDto(self):
        """Test ConfigTemplateDto"""
