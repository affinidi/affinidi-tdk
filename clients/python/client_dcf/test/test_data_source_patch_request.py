...
from affinidi_tdk_client_dcf.models.data_source_patch_request import DataSourcePatchRequest  # noqa: E501

class TestDataSourcePatchRequest(unittest.TestCase):
    """DataSourcePatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataSourcePatchRequest:
        """Test DataSourcePatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataSourcePatchRequest`
        """
        model = DataSourcePatchRequest()  # noqa: E501
        if include_optional:
            return DataSourcePatchRequest(
                data_source_name = 'UR,rZ#UM/?R,Fp^l6$ARjbhJk C>0',
                description = 'bf325375-030f-cba091737c574773100b012345678910111213141516171819202122232425262728293031',
                scope = 'UR,rZ#UM/?R,Fp^l6$ARjbhJk C>0',
                endpoint_config = affinidi_tdk_client_dcf.models.endpoint_config_patch_request.EndpointConfigPatchRequest(
                    options = {"headers":{"Accept":"application/json","Content-Type":"application/json"},"auth":{"bearer":"{{ACCESS_TOKEN}}"}}, 
                    operations = [
                        affinidi_tdk_client_dcf.models.endpoint_config_patch_request_operations_inner.EndpointConfigPatchRequest_operations_inner(
                            template = { }, 
                            functions = { }, 
                            pagination = { }, 
                            source_schema = { }, )
    ...
    def testDataSourcePatchRequest(self):
        """Test DataSourcePatchRequest"""
