...
from affinidi_tdk_client_dcf.models.connection_executed_temp_response import ConnectionExecutedTempResponse  # noqa: E501

class TestConnectionExecutedTempResponse(unittest.TestCase):
    """ConnectionExecutedTempResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectionExecutedTempResponse:
        """Test ConnectionExecutedTempResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectionExecutedTempResponse`
        """
        model = ConnectionExecutedTempResponse()  # noqa: E501
        if include_optional:
            return ConnectionExecutedTempResponse(
                credentials = None
            )
        else:
            return ConnectionExecutedTempResponse(
    ...
    def testConnectionExecutedTempResponse(self):
        """Test ConnectionExecutedTempResponse"""
