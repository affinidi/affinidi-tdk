...
from affinidi_tdk_client_dcf.models.executed_connection_request_response import ExecutedConnectionRequestResponse  # noqa: E501

class TestExecutedConnectionRequestResponse(unittest.TestCase):
    """ExecutedConnectionRequestResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExecutedConnectionRequestResponse:
        """Test ExecutedConnectionRequestResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExecutedConnectionRequestResponse`
        """
        model = ExecutedConnectionRequestResponse()  # noqa: E501
        if include_optional:
            return ExecutedConnectionRequestResponse(
                status = '',
                errors = [
                    ''
                    ],
    ...
    def testExecutedConnectionRequestResponse(self):
        """Test ExecutedConnectionRequestResponse"""
