...
from affinidi_tdk_client_dcf.models.auth_config_info_dto_refresh_token_template_operations_inner_functions import AuthConfigInfoDtoRefreshTokenTemplateOperationsInnerFunctions  # noqa: E501

class TestAuthConfigInfoDtoRefreshTokenTemplateOperationsInnerFunctions(unittest.TestCase):
    """AuthConfigInfoDtoRefreshTokenTemplateOperationsInnerFunctions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthConfigInfoDtoRefreshTokenTemplateOperationsInnerFunctions:
        """Test AuthConfigInfoDtoRefreshTokenTemplateOperationsInnerFunctions
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthConfigInfoDtoRefreshTokenTemplateOperationsInnerFunctions`
        """
        model = AuthConfigInfoDtoRefreshTokenTemplateOperationsInnerFunctions()  # noqa: E501
        if include_optional:
            return AuthConfigInfoDtoRefreshTokenTemplateOperationsInnerFunctions(
                get_data = [
                    ''
                    ]
            )
    ...
    def testAuthConfigInfoDtoRefreshTokenTemplateOperationsInnerFunctions(self):
        """Test AuthConfigInfoDtoRefreshTokenTemplateOperationsInnerFunctions"""
