...
from affinidi_tdk_client_dcf.models.auth_config_info_dto_exchange_token_template_operations_inner_functions import AuthConfigInfoDtoExchangeTokenTemplateOperationsInnerFunctions  # noqa: E501

class TestAuthConfigInfoDtoExchangeTokenTemplateOperationsInnerFunctions(unittest.TestCase):
    """AuthConfigInfoDtoExchangeTokenTemplateOperationsInnerFunctions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthConfigInfoDtoExchangeTokenTemplateOperationsInnerFunctions:
        """Test AuthConfigInfoDtoExchangeTokenTemplateOperationsInnerFunctions
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthConfigInfoDtoExchangeTokenTemplateOperationsInnerFunctions`
        """
        model = AuthConfigInfoDtoExchangeTokenTemplateOperationsInnerFunctions()  # noqa: E501
        if include_optional:
            return AuthConfigInfoDtoExchangeTokenTemplateOperationsInnerFunctions(
                get_data = [
                    ''
                    ]
            )
    ...
    def testAuthConfigInfoDtoExchangeTokenTemplateOperationsInnerFunctions(self):
        """Test AuthConfigInfoDtoExchangeTokenTemplateOperationsInnerFunctions"""
