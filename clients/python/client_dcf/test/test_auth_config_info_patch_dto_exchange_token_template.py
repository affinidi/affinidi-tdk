...
from affinidi_tdk_client_dcf.models.auth_config_info_patch_dto_exchange_token_template import AuthConfigInfoPatchDtoExchangeTokenTemplate  # noqa: E501

class TestAuthConfigInfoPatchDtoExchangeTokenTemplate(unittest.TestCase):
    """AuthConfigInfoPatchDtoExchangeTokenTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthConfigInfoPatchDtoExchangeTokenTemplate:
        """Test AuthConfigInfoPatchDtoExchangeTokenTemplate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthConfigInfoPatchDtoExchangeTokenTemplate`
        """
        model = AuthConfigInfoPatchDtoExchangeTokenTemplate()  # noqa: E501
        if include_optional:
            return AuthConfigInfoPatchDtoExchangeTokenTemplate(
                options = { },
                operations = [
    ...
    def testAuthConfigInfoPatchDtoExchangeTokenTemplate(self):
        """Test AuthConfigInfoPatchDtoExchangeTokenTemplate"""
