...
from affinidi_tdk_client_dcf.models.auth_config_info_patch_dto import AuthConfigInfoPatchDto  # noqa: E501

class TestAuthConfigInfoPatchDto(unittest.TestCase):
    """AuthConfigInfoPatchDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthConfigInfoPatchDto:
        """Test AuthConfigInfoPatchDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthConfigInfoPatchDto`
        """
        model = AuthConfigInfoPatchDto()  # noqa: E501
        if include_optional:
            return AuthConfigInfoPatchDto(
                auth_details = affinidi_tdk_client_dcf.models.auth_config_info_patch_dto_auth_details.AuthConfigInfoPatchDto_authDetails(
                    auth_url = 'UR,rZ#UM/?R,Fp^l6$ARjbhJk C>0', 
                    template = '', ),
                exchange_token_template = affinidi_tdk_client_dcf.models.auth_config_info_patch_dto_exchange_token_template.AuthConfigInfoPatchDto_exchangeTokenTemplate(
                    options = { }, 
                    operations = [
                        affinidi_tdk_client_dcf.models.auth_config_info_patch_dto_exchange_token_template_operations_inner.AuthConfigInfoPatchDto_exchangeTokenTemplate_operations_inner(
                            template = { }, 
                            functions = affinidi_tdk_client_dcf.models.auth_config_info_patch_dto_exchange_token_template_operations_inner_functions.AuthConfigInfoPatchDto_exchangeTokenTemplate_operations_inner_functions(
                                get_data = [
                                    ''
                                    ], ), )
                        ], ),
                refresh_token_template = affinidi_tdk_client_dcf.models.auth_config_info_patch_dto_refresh_token_template.AuthConfigInfoPatchDto_refreshTokenTemplate(
                    options = affinidi_tdk_client_dcf.models.options.options(), 
                    operations = [
                        affinidi_tdk_client_dcf.models.auth_config_info_patch_dto_refresh_token_template_operations_inner.AuthConfigInfoPatchDto_refreshTokenTemplate_operations_inner(
                            template = { }, 
                            functions = affinidi_tdk_client_dcf.models.auth_config_info_patch_dto_refresh_token_template_operations_inner_functions.AuthConfigInfoPatchDto_refreshTokenTemplate_operations_inner_functions(
                                get_data = [
                                    ''
                                    ], ), )
                        ], )
    ...
    def testAuthConfigInfoPatchDto(self):
        """Test AuthConfigInfoPatchDto"""
