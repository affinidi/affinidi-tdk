...
from affinidi_tdk_client_dcf.models.auth_config_info_dto_refresh_token_template import AuthConfigInfoDtoRefreshTokenTemplate  # noqa: E501

class TestAuthConfigInfoDtoRefreshTokenTemplate(unittest.TestCase):
    """AuthConfigInfoDtoRefreshTokenTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthConfigInfoDtoRefreshTokenTemplate:
        """Test AuthConfigInfoDtoRefreshTokenTemplate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthConfigInfoDtoRefreshTokenTemplate`
        """
        model = AuthConfigInfoDtoRefreshTokenTemplate()  # noqa: E501
        if include_optional:
            return AuthConfigInfoDtoRefreshTokenTemplate(
    ...
    def testAuthConfigInfoDtoRefreshTokenTemplate(self):
        """Test AuthConfigInfoDtoRefreshTokenTemplate"""
