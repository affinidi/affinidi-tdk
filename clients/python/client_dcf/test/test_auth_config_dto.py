...
from affinidi_tdk_client_dcf.models.auth_config_dto import AuthConfigDto  # noqa: E501

class TestAuthConfigDto(unittest.TestCase):
    """AuthConfigDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthConfigDto:
        """Test AuthConfigDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthConfigDto`
        """
        model = AuthConfigDto()  # noqa: E501
        if include_optional:
