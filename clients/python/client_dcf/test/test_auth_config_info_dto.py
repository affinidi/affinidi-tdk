...
from affinidi_tdk_client_dcf.models.auth_config_info_dto import AuthConfigInfoDto  # noqa: E501

class TestAuthConfigInfoDto(unittest.TestCase):
    """AuthConfigInfoDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthConfigInfoDto:
        """Test AuthConfigInfoDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthConfigInfoDto`
        """
        model = AuthConfigInfoDto()  # noqa: E501
        if include_optional:
            return AuthConfigInfoDto(
    ...
    def testAuthConfigInfoDto(self):
        """Test AuthConfigInfoDto"""
