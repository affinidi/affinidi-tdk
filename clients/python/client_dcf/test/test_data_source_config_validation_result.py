...
from affinidi_tdk_client_dcf.models.data_source_config_validation_result import DataSourceConfigValidationResult  # noqa: E501

class TestDataSourceConfigValidationResult(unittest.TestCase):
    """DataSourceConfigValidationResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataSourceConfigValidationResult:
        """Test DataSourceConfigValidationResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataSourceConfigValidationResult`
        """
        model = DataSourceConfigValidationResult()  # noqa: E501
        if include_optional:
            return DataSourceConfigValidationResult(
    ...
    def testDataSourceConfigValidationResult(self):
        """Test DataSourceConfigValidationResult"""
