...
from affinidi_tdk_client_dcf.models.auth_config_info_dto_auth_details import AuthConfigInfoDtoAuthDetails  # noqa: E501

class TestAuthConfigInfoDtoAuthDetails(unittest.TestCase):
    """AuthConfigInfoDtoAuthDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthConfigInfoDtoAuthDetails:
        """Test AuthConfigInfoDtoAuthDetails
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthConfigInfoDtoAuthDetails`
        """
        model = AuthConfigInfoDtoAuthDetails()  # noqa: E501
        if include_optional:
            return AuthConfigInfoDtoAuthDetails(
    ...
    def testAuthConfigInfoDtoAuthDetails(self):
        """Test AuthConfigInfoDtoAuthDetails"""
