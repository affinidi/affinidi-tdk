...
from affinidi_tdk_client_dcf.models.auth_config_info_patch_dto_refresh_token_template_operations_inner import AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInner  # noqa: E501

class TestAuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInner(unittest.TestCase):
    """AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInner:
        """Test AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInner`
        """
        model = AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInner()  # noqa: E501
        if include_optional:
            return AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInner(
                template = { },
    ...
    def testAuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInner(self):
        """Test AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInner"""
