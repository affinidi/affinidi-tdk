...
from affinidi_tdk_client_dcf.models.connector_auth_config import ConnectorAuthConfig  # noqa: E501

class TestConnectorAuthConfig(unittest.TestCase):
    """ConnectorAuthConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectorAuthConfig:
        """Test ConnectorAuthConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectorAuthConfig`
        """
        model = ConnectorAuthConfig()  # noqa: E501
        if include_optional:
    ...
    def testConnectorAuthConfig(self):
        """Test ConnectorAuthConfig"""
