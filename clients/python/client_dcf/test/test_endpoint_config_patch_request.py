...
from affinidi_tdk_client_dcf.models.endpoint_config_patch_request import EndpointConfigPatchRequest  # noqa: E501

class TestEndpointConfigPatchRequest(unittest.TestCase):
    """EndpointConfigPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointConfigPatchRequest:
        """Test EndpointConfigPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointConfigPatchRequest`
        """
        model = EndpointConfigPatchRequest()  # noqa: E501
        if include_optional:
            return EndpointConfigPatchRequest(
    ...
    def testEndpointConfigPatchRequest(self):
        """Test EndpointConfigPatchRequest"""
