...
from affinidi_tdk_client_dcf.models.get_data_sourceby_id_response import GetDataSourcebyIdResponse  # noqa: E501

class TestGetDataSourcebyIdResponse(unittest.TestCase):
    """GetDataSourcebyIdResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDataSourcebyIdResponse:
        """Test GetDataSourcebyIdResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDataSourcebyIdResponse`
        """
        model = GetDataSourcebyIdResponse()  # noqa: E501
        if include_optional:
            return GetDataSourcebyIdResponse(
                data_source_id = 'bf325375-030f-cba091737c574773100b012345678910111213141516171819202122232425262728293031',
                data_source_config_id = 'bf325375-030f-cba091737c574773100b012345678910111213141516171819202122232425262728293031',
                data_source_name = 'UR,rZ#UM/?R,Fp^l6$ARjbhJk C>0',
                description = 'UR,rZ#UM/?R,Fp^l6$ARjbhJk C>0',
                scope = 'UR,rZ#UM/?R,Fp^l6$ARjbhJk C>0',
                status = 'DRAFT',
                endpoint_config = affinidi_tdk_client_dcf.models.endpoint_config_dto.EndpointConfigDto(
                    options = {"headers":{"Accept":"application/json","Content-Type":"application/json"},"auth":{"bearer":"{{ACCESS_TOKEN}}"}}, 
                    operations = [
                        affinidi_tdk_client_dcf.models.endpoint_config_dto_operations_inner.EndpointConfigDto_operations_inner(
                            template = { }, 
                            functions = { }, 
                            pagination = { }, 
                            source_schema = { }, )
                        ], ),
                transformation_template = affinidi_tdk_client_dcf.models.transformation_template_dto.TransformationTemplateDto(
                    endpoint = '', 
                    target_schema_url = '', 
                    schema_mapping = affinidi_tdk_client_dcf.models.transformation_template_dto_schema_mapping.TransformationTemplateDto_schemaMapping(
                        transformations = [
                            { }
                            ], 
                        aggregations = [
                ...
                validation_result = affinidi_tdk_client_dcf.models.data_source_validation_result_validation_result.DataSourceValidationResult_validationResult(
                    is_successful = True, 
                    connection_id = '', 
                    response = [
                        ''
    ...
    def testGetDataSourcebyIdResponse(self):
        """Test GetDataSourcebyIdResponse"""
