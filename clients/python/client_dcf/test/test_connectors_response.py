...
from affinidi_tdk_client_dcf.models.connectors_response import ConnectorsResponse  # noqa: E501

class TestConnectorsResponse(unittest.TestCase):
    """ConnectorsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectorsResponse:
        """Test ConnectorsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectorsResponse`
        """
        model = ConnectorsResponse()  # noqa: E501
        if include_optional:
            return ConnectorsResponse(
                connectors = [
                    affinidi_tdk_client_dcf.models.connector_dto.ConnectorDTO(
                        id = '', 
                        name = '', 
    ...
    def testConnectorsResponse(self):
        """Test ConnectorsResponse"""
