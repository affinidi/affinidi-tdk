...
from affinidi_tdk_client_dcf.models.patch_data_source_config_status_response import PatchDataSourceConfigStatusResponse  # noqa: E501

class TestPatchDataSourceConfigStatusResponse(unittest.TestCase):
    """PatchDataSourceConfigStatusResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchDataSourceConfigStatusResponse:
        """Test PatchDataSourceConfigStatusResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchDataSourceConfigStatusResponse`
        """
        model = PatchDataSourceConfigStatusResponse()  # noqa: E501
        if include_optional:
            return PatchDataSourceConfigStatusResponse(
                sso_url = '',
    ...
    def testPatchDataSourceConfigStatusResponse(self):
        """Test PatchDataSourceConfigStatusResponse"""
