...
from affinidi_tdk_client_dcf.models.create_transformation_template_request import CreateTransformationTemplateRequest  # noqa: E501

class TestCreateTransformationTemplateRequest(unittest.TestCase):
    """CreateTransformationTemplateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateTransformationTemplateRequest:
        """Test CreateTransformationTemplateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateTransformationTemplateRequest`
        """
        model = CreateTransformationTemplateRequest()  # noqa: E501
        if include_optional:
            return CreateTransformationTemplateRequest(
    ...
    def testCreateTransformationTemplateRequest(self):
        """Test CreateTransformationTemplateRequest"""
