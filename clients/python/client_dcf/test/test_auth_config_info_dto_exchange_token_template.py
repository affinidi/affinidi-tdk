...
from affinidi_tdk_client_dcf.models.auth_config_info_dto_exchange_token_template import AuthConfigInfoDtoExchangeTokenTemplate  # noqa: E501

class TestAuthConfigInfoDtoExchangeTokenTemplate(unittest.TestCase):
    """AuthConfigInfoDtoExchangeTokenTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthConfigInfoDtoExchangeTokenTemplate:
        """Test AuthConfigInfoDtoExchangeTokenTemplate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthConfigInfoDtoExchangeTokenTemplate`
        """
        model = AuthConfigInfoDtoExchangeTokenTemplate()  # noqa: E501
        if include_optional:
            return AuthConfigInfoDtoExchangeTokenTemplate(
                options = { },
                operations = [
    ...
    def testAuthConfigInfoDtoExchangeTokenTemplate(self):
        """Test AuthConfigInfoDtoExchangeTokenTemplate"""
