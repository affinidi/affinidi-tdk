...
from affinidi_tdk_client_dcf.models.transformation_template_dto_schema_mapping_aggregations_inner import TransformationTemplateDtoSchemaMappingAggregationsInner  # noqa: E501

class TestTransformationTemplateDtoSchemaMappingAggregationsInner(unittest.TestCase):
    """TransformationTemplateDtoSchemaMappingAggregationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransformationTemplateDtoSchemaMappingAggregationsInner:
        """Test TransformationTemplateDtoSchemaMappingAggregationsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransformationTemplateDtoSchemaMappingAggregationsInner`
        """
        model = TransformationTemplateDtoSchemaMappingAggregationsInner()  # noqa: E501
        if include_optional:
            return TransformationTemplateDtoSchemaMappingAggregationsInner(
                name = 'mean',
                fields = [
                    ''
                    ],
    ...
    def testTransformationTemplateDtoSchemaMappingAggregationsInner(self):
        """Test TransformationTemplateDtoSchemaMappingAggregationsInner"""
