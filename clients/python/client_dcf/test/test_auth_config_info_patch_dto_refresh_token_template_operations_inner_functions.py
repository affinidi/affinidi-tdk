...
from affinidi_tdk_client_dcf.models.auth_config_info_patch_dto_refresh_token_template_operations_inner_functions import AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInnerFunctions  # noqa: E501

class TestAuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInnerFunctions(unittest.TestCase):
    """AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInnerFunctions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInnerFunctions:
        """Test AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInnerFunctions
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInnerFunctions`
        """
        model = AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInnerFunctions()  # noqa: E501
        if include_optional:
            return AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInnerFunctions(
                get_data = [
                    ''
                    ]
            )
    ...
    def testAuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInnerFunctions(self):
        """Test AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInnerFunctions"""
