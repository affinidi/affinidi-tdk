...
from affinidi_tdk_client_dcf.models.active_connections_dto import ActiveConnectionsDto  # noqa: E501

class TestActiveConnectionsDto(unittest.TestCase):
    """ActiveConnectionsDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActiveConnectionsDto:
        """Test ActiveConnectionsDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActiveConnectionsDto`
        """
        model = ActiveConnectionsDto()  # noqa: E501
        if include_optional:
    ...
    def testActiveConnectionsDto(self):
        """Test ActiveConnectionsDto"""
