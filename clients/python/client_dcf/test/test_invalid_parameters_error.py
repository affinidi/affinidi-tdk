...
from affinidi_tdk_client_dcf.models.invalid_parameters_error import InvalidParametersError  # noqa: E501

class TestInvalidParametersError(unittest.TestCase):
    """InvalidParametersError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvalidParametersError:
        """Test InvalidParametersError
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvalidParametersError`
        """
        model = InvalidParametersError()  # noqa: E501
        if include_optional:
            return InvalidParametersError(
                name = 'InvalidParametersError',
                message = '${className} invalid parameters.',
    ...
    def testInvalidParametersError(self):
        """Test InvalidParametersError"""
