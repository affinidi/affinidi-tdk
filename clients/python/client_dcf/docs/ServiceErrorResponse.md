...
| ------------ | --------------------------------------------------------------------------------- | ------------------------------------------------------------------- | ---------- |
| **debug_id** | **str**                                                                           | An unique id for correlating this specific error to logs.           |
| **name**     | **str**                                                                           | The name of the error.                                              |
| **code**     | **str**                                                                           | The backwards compatible Affinidi error code.                       |
| **details**  | [**List[ServiceErrorResponseDetailsInner]**](ServiceErrorResponseDetailsInner.md) | An optional list of explanatatory details about the occured errors. | [optional] |
