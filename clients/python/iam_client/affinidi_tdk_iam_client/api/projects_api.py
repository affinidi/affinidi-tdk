...
class ProjectsApi:
    ...
    @validate_arguments
    def get_project(self, project_id : Annotated[StrictStr, Field(..., description="projectId")], **kwargs) -> ProjectDto:  # noqa: E501
    ...
    @validate_arguments
    def get_project_with_http_info(self, project_id : Annotated[StrictStr, Field(..., description="projectId")], **kwargs) -> ApiResponse:  # noqa: E501
        """get_project  # noqa: E501
