...
import affinidi_tdk_iam_client.models
from affinidi_tdk_iam_client import rest
from affinidi_tdk_iam_client.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(affinidi_tdk_iam_client.models, klass)
