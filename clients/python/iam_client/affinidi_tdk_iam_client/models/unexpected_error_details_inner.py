...
class UnexpectedErrorDetailsInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UnexpectedErrorDetailsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UnexpectedErrorDetailsInner:
        """Create an instance of UnexpectedErrorDetailsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UnexpectedErrorDetailsInner.parse_obj(obj)

        _obj = UnexpectedErrorDetailsInner.parse_obj({
            "issue": obj.get("issue"),
            "field": obj.get("field"),
            "value": obj.get("value"),
