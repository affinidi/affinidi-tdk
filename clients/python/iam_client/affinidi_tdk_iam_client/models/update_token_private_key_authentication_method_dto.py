...
class UpdateTokenPrivateKeyAuthenticationMethodDto(BaseModel):
    ...
    signing_algorithm: Optional[StrictStr] = Field(None, alias="signingAlgorithm")
    public_key_info: Optional[TokenPrivateKeyAuthenticationMethodDtoPublicKeyInfo] = Field(None, alias="publicKeyInfo")
