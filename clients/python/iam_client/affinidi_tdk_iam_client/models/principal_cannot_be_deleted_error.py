...
class PrincipalCannotBeDeletedError(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrincipalCannotBeDeletedError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrincipalCannotBeDeletedError:
        """Create an instance of PrincipalCannotBeDeletedError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrincipalCannotBeDeletedError.parse_obj(obj)

        _obj = PrincipalCannotBeDeletedError.parse_obj({
            "name": obj.get("name"),
