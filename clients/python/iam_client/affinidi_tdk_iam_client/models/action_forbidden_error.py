...
class ActionForbiddenError(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActionForbiddenError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActionForbiddenError:
        """Create an instance of ActionForbiddenError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActionForbiddenError.parse_obj(obj)

        _obj = ActionForbiddenError.parse_obj({
            "name": obj.get("name"),
