...
class ProjectDto(BaseModel):
    ...
    created_at: Optional[StrictStr] = Field(None, alias="createdAt", description="creation date and time in ISO-8601 format, e.g. 2023-09-20T07:12:13")
    updated_at: Optional[StrictStr] = Field(None, alias="updatedAt", description="last update date and time in ISO-8601 format, e.g. 2023-09-20T07:12:13")
