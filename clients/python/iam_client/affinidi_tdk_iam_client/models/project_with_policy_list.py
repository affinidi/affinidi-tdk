...
class ProjectWithPolicyList(BaseModel):
    """
    ProjectWithPolicyList
    """
    projects: conlist(ProjectWithPolicyDto) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProjectWithPolicyList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProjectWithPolicyList:
        """Create an instance of ProjectWithPolicyList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProjectWithPolicyList.parse_obj(obj)

        _obj = ProjectWithPolicyList.parse_obj({
            "projects": [ProjectWithPolicyDto.from_dict(_item) for _item in obj.get("projects")] if obj.get("projects") is not None else None,
