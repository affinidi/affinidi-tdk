...
class TokenPrivateKeyAuthenticationMethodDto(BaseModel):
    """
    Private Key JWT Authentication of Client with `private_key_jwt` oAuth Method  # noqa: E501
    """
    type: StrictStr = Field(...)
    signing_algorithm: StrictStr = Field(default=..., alias="signingAlgorithm")
    public_key_info: TokenPrivateKeyAuthenticationMethodDtoPublicKeyInfo = Field(default=..., alias="publicKeyInfo")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TokenPrivateKeyAuthenticationMethodDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TokenPrivateKeyAuthenticationMethodDto:
        """Create an instance of TokenPrivateKeyAuthenticationMethodDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TokenPrivateKeyAuthenticationMethodDto.parse_obj(obj)

        _obj = TokenPrivateKeyAuthenticationMethodDto.parse_obj({
            "type": obj.get("type"),
