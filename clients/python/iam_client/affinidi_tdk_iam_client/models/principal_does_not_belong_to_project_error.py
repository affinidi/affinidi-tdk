...
class PrincipalDoesNotBelongToProjectError(BaseModel):
    """
    ...
    details: Optional[conlist(UnexpectedErrorDetailsInner)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrincipalDoesNotBelongToProjectError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrincipalDoesNotBelongToProjectError:
        """Create an instance of PrincipalDoesNotBelongToProjectError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrincipalDoesNotBelongToProjectError.parse_obj(obj)

        _obj = PrincipalDoesNotBelongToProjectError.parse_obj({
            "name": obj.get("name"),
            "message": obj.get("message"),
            "http_status_code": obj.get("httpStatusCode"),
            "trace_id": obj.get("traceId"),
            "details": [UnexpectedErrorDetailsInner.from_dict(_item) for _item in obj.get("details")] if obj.get("details") is not None else None
        })
        return _obj
