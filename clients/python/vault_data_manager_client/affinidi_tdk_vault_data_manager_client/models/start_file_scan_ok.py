...
class StartFileScanOK(BaseModel):
    """
    StartFileScanOK
    """
    job_id: StrictStr = Field(default=..., alias="jobId")
    status: StrictStr = Field(...)
    __properties = ["jobId", "status"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StartFileScanOK:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StartFileScanOK:
        """Create an instance of StartFileScanOK from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StartFileScanOK.parse_obj(obj)

        _obj = StartFileScanOK.parse_obj({
