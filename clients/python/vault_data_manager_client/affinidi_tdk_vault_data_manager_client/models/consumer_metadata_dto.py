...
class ConsumerMetadataDto(BaseModel):
    ...
    created_by: StrictStr = Field(default=..., alias="createdBy", description="[GEN] Identifier of the user who created the entity")
    modified_by: StrictStr = Field(default=..., alias="modifiedBy", description="[GEN] Identifier of the user who last updated the entity")
