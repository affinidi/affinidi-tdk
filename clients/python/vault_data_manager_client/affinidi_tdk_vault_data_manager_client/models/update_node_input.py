...
class UpdateNodeInput(BaseModel):
    ...
    UpdateNodeInput
    """
    name: Optional[constr(strict=True, max_length=128)] = Field(default=None, description="Name of the node")
    ...
    __properties = ["name", "description", "metadata"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateNodeInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateNodeInput:
        """Create an instance of UpdateNodeInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateNodeInput.parse_obj(obj)

        _obj = UpdateNodeInput.parse_obj({
            "name": obj.get("name"),
