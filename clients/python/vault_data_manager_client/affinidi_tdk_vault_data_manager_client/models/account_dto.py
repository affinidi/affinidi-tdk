...
class AccountDto(BaseModel):
    ...
    AccountDto
    """
    account_number: Optional[StrictStr] = Field(default=None, alias="accountNumber", description="Account number")
    did: Optional[constr(strict=True)] = Field(default=None, description="Profile DID")
    __properties = ["accountNumber", "did"]
