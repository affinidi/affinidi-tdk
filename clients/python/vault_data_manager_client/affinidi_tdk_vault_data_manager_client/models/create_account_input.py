...
class CreateAccountInput(BaseModel):
    ...
    CreateAccountInput
    """
    account_number: StrictStr = Field(default=..., alias="accountNumber", description="number that is used for profile DID derivation")
    ...
    __properties = ["accountNumber", "profileDid", "didProof"]
