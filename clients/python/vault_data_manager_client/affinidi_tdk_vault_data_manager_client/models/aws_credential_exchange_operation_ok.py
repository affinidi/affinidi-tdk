...
class AwsCredentialExchangeOperationOK(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AwsCredentialExchangeOperationOK:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AwsCredentialExchangeOperationOK:
        """Create an instance of AwsCredentialExchangeOperationOK from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AwsCredentialExchangeOperationOK.parse_obj(obj)

        _obj = AwsCredentialExchangeOperationOK.parse_obj({
            "token": obj.get("token"),
