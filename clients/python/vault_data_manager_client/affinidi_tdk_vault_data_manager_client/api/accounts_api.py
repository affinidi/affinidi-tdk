...
class AccountsApi:
    ...
    @validate_arguments
    def list_profiles(self, **kwargs) -> ListProfilesOK:  # noqa: E501
        """list_profiles  # noqa: E501

        lists children of the root node with accounts  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_profiles(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ListProfilesOK
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_profiles_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_profiles_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def list_profiles_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """list_profiles  # noqa: E501
        ...
        >>> thread = api.list_profiles_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ListProfilesOK, status_code(int), headers(HTTPHeaderDict))
        """
