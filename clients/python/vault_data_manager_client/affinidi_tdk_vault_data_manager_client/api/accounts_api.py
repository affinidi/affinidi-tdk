...
class AccountsApi:
    ...
    @validate_arguments
    def delete_account(self, account_number : constr(strict=True), **kwargs) -> DeleteAccountDto:  # noqa: E501
        ...
        >>> thread = api.delete_account(account_number, async_req=True)
        >>> result = thread.get()
        ...
        return self.delete_account_with_http_info(account_number, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_account_with_http_info(self, account_number : constr(strict=True), **kwargs) -> ApiResponse:  # noqa: E501
        """delete_account  # noqa: E501
        ...
        >>> thread = api.delete_account_with_http_info(account_number, async_req=True)
        >>> result = thread.get()
        ...
        _path_params = {}
        if _params['account_number'] is not None:
        ...
        return self.api_client.call_api(
            '/v1/accounts/{accountNumber}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def list_accounts(self, **kwargs) -> ListAccountsDto:  # noqa: E501
