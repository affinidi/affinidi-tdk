...
class NodesApi:
    ...
    @validate_arguments
    def grant_access(self, grant_access_input : Annotated[GrantAccessInput, Field(..., description="CreateNode")], **kwargs) -> None:  # noqa: E501
        """grant_access  # noqa: E501

        grants access to another consumer to access nodes hierarchy  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.grant_access(grant_access_input, async_req=True)
        >>> result = thread.get()

        :param grant_access_input: CreateNode (required)
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the grant_access_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.grant_access_with_http_info(grant_access_input, **kwargs)  # noqa: E501

    @validate_arguments
    def grant_access_with_http_info(self, grant_access_input : Annotated[GrantAccessInput, Field(..., description="CreateNode")], **kwargs) -> ApiResponse:  # noqa: E501
        """grant_access  # noqa: E501
        ...
        >>> thread = api.grant_access_with_http_info(grant_access_input, async_req=True)
        >>> result = thread.get()
