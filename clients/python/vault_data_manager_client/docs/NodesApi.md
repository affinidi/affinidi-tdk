...
| [**grant_access**](NodesApi.md#grant_access)                             | **POST** /v1/nodes/grant-access                       |
...
> grant_access(grant_access_input)
...
with affinidi_tdk_vault_data_manager_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = affinidi_tdk_vault_data_manager_client.NodesApi(api_client)
    grant_access_input = affinidi_tdk_vault_data_manager_client.GrantAccessInput() # GrantAccessInput | CreateNode

    try:
        api_instance.grant_access(grant_access_input)
    except Exception as e:
        print("Exception when calling NodesApi->grant_access: %s\n" % e)
```
...
| Name                   | Type                                        | Description | Notes |
| ---------------------- | ------------------------------------------- | ----------- | ----- |
| **grant_access_input** | [**GrantAccessInput**](GrantAccessInput.md) | CreateNode  |
