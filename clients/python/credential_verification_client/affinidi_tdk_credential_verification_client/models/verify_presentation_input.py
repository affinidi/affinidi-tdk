...
class VerifyPresentationInput(BaseModel):
    ...
    presentation_definition: Optional[Dict[str, Any]] = Field(None, alias="presentationDefinition")
    presentation_submission: Optional[Dict[str, Any]] = Field(None, alias="presentationSubmission")
