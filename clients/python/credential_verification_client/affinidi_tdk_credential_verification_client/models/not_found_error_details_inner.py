...
class NotFoundErrorDetailsInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NotFoundErrorDetailsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NotFoundErrorDetailsInner:
        """Create an instance of NotFoundErrorDetailsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NotFoundErrorDetailsInner.parse_obj(obj)

        _obj = NotFoundErrorDetailsInner.parse_obj({
            "issue": obj.get("issue"),
            "field": obj.get("field"),
            "value": obj.get("value"),
