...
class PresentationDefinition(BaseModel):
    ...
    """
    id: StrictStr = Field(..., description="Definition id")
    name: Optional[StrictStr] = Field(None, description="Definition name")
    purpose: Optional[StrictStr] = Field(None, description="Definition purpose")
