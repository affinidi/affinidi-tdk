...
class UnexpectedServiceError(BaseModel):
    """
    Unexpected service error.  # noqa: E501
    """
    ...
    def name_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('UnexpectedServiceError'):
            raise ValueError("must be one of enum values ('UnexpectedServiceError')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UnexpectedServiceError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UnexpectedServiceError:
        """Create an instance of UnexpectedServiceError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UnexpectedServiceError.parse_obj(obj)

        _obj = UnexpectedServiceError.parse_obj({
            "name": obj.get("name"),
