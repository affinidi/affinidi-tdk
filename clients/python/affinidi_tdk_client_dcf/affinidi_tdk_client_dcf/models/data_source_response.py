...
class DataSourceResponse(BaseModel):
    """
    List of all data source configurations.   # noqa: E501
    """
    data_sources: Optional[conlist(DataSourceResponseDto)] = Field(None, alias="dataSources", description="A list of data source configurations. ")
    __properties = ["dataSources"]
    ...
    def from_dict(cls, obj: dict) -> DataSourceResponse:
        ...
        _obj = DataSourceResponse.parse_obj({
            "data_sources": [DataSourceResponseDto.from_dict(_item) for _item in obj.get("dataSources")] if obj.get("dataSources") is not None else None
        })
        return _obj
