...
class CreateTransformationTemplateRequest(BaseModel):
    """
    Request payload for creating of a transformation template for a given data source.   # noqa: E501
    """
    transformation_template: TransformationTemplateDto = Field(..., alias="transformationTemplate")
    __properties = ["transformationTemplate"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateTransformationTemplateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateTransformationTemplateRequest:
        """Create an instance of CreateTransformationTemplateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateTransformationTemplateRequest.parse_obj(obj)

        _obj = CreateTransformationTemplateRequest.parse_obj({
