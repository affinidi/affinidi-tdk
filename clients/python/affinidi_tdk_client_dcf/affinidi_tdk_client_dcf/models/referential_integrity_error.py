...
class ReferentialIntegrityError(BaseModel):
    ...
    def name_validate_enum(cls, value):
        ...
        if value not in ('ReferentialIntegrityError'):
            raise ValueError("must be one of enum values ('ReferentialIntegrityError')")
        return value
    ...
    def message_validate_enum(cls, value):
        ...
        if value not in ('Integrity constraint'):
            raise ValueError("must be one of enum values ('Integrity constraint')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReferentialIntegrityError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReferentialIntegrityError:
        """Create an instance of ReferentialIntegrityError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReferentialIntegrityError.parse_obj(obj)

        _obj = ReferentialIntegrityError.parse_obj({
            "name": obj.get("name"),
