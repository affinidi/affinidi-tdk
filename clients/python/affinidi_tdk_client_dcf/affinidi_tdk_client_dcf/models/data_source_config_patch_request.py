...
class DataSourceConfigPatchRequest(BaseModel):
    """
    Request payload for updating certain authentication information of a data source configuration.   # noqa: E501
    """
    auth_config_info: Optional[AuthConfigInfoPatchDto] = Field(None, alias="authConfigInfo")
    __properties = ["authConfigInfo"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataSourceConfigPatchRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DataSourceConfigPatchRequest:
        """Create an instance of DataSourceConfigPatchRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DataSourceConfigPatchRequest.parse_obj(obj)

        _obj = DataSourceConfigPatchRequest.parse_obj({
            "auth_config_info": AuthConfigInfoPatchDto.from_dict(obj.get("authConfigInfo")) if obj.get("authConfigInfo") is not None else None
        })
        return _obj
