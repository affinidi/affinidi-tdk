...
class AuthConfigInfoDtoRefreshTokenTemplateOperationsInner(BaseModel):
    """
    ...
    functions: AuthConfigInfoDtoRefreshTokenTemplateOperationsInnerFunctions = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuthConfigInfoDtoRefreshTokenTemplateOperationsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuthConfigInfoDtoRefreshTokenTemplateOperationsInner:
        """Create an instance of AuthConfigInfoDtoRefreshTokenTemplateOperationsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuthConfigInfoDtoRefreshTokenTemplateOperationsInner.parse_obj(obj)

        _obj = AuthConfigInfoDtoRefreshTokenTemplateOperationsInner.parse_obj({
            "template": obj.get("template"),
            "functions": AuthConfigInfoDtoRefreshTokenTemplateOperationsInnerFunctions.from_dict(obj.get("functions")) if obj.get("functions") is not None else None
        })
        return _obj
