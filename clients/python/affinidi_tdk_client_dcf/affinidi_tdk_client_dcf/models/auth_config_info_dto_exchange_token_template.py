...
class AuthConfigInfoDtoExchangeTokenTemplate(BaseModel):
    """
    ...
    operations: conlist(AuthConfigInfoDtoExchangeTokenTemplateOperationsInner) = Field(..., description="A list of REST operations to exchange authentication token with the data source. ")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuthConfigInfoDtoExchangeTokenTemplate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuthConfigInfoDtoExchangeTokenTemplate:
        """Create an instance of AuthConfigInfoDtoExchangeTokenTemplate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuthConfigInfoDtoExchangeTokenTemplate.parse_obj(obj)

        _obj = AuthConfigInfoDtoExchangeTokenTemplate.parse_obj({
            "options": obj.get("options"),
            "operations": [AuthConfigInfoDtoExchangeTokenTemplateOperationsInner.from_dict(_item) for _item in obj.get("operations")] if obj.get("operations") is not None else None
        })
        return _obj
