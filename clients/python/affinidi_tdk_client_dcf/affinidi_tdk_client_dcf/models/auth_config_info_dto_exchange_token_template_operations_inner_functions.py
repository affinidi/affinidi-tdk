...
class AuthConfigInfoDtoExchangeTokenTemplateOperationsInnerFunctions(BaseModel):
    """
    An object defining functions which process the received authentication data from the operation.   # noqa: E501
    """
    get_data: conlist(StrictStr) = Field(..., alias="getData", description="Should always be an empty array. ")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuthConfigInfoDtoExchangeTokenTemplateOperationsInnerFunctions:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuthConfigInfoDtoExchangeTokenTemplateOperationsInnerFunctions:
        """Create an instance of AuthConfigInfoDtoExchangeTokenTemplateOperationsInnerFunctions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuthConfigInfoDtoExchangeTokenTemplateOperationsInnerFunctions.parse_obj(obj)

        _obj = AuthConfigInfoDtoExchangeTokenTemplateOperationsInnerFunctions.parse_obj({
