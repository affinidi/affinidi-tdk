...
class InvalidParametersError(BaseModel):
    """
    InvalidParametersError
    """
    name: Optional[StrictStr] = None
    message: Optional[StrictStr] = None
    http_status_code: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="httpStatusCode")
    __properties = ["name", "message", "httpStatusCode"]
    ...
    def name_validate_enum(cls, value):
        ...
        if value not in ('InvalidParametersError'):
            raise ValueError("must be one of enum values ('InvalidParametersError')")
        return value
    ...
    def message_validate_enum(cls, value):
        ...
        if value not in ('${className} invalid parameters.'):
            raise ValueError("must be one of enum values ('${className} invalid parameters.')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InvalidParametersError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InvalidParametersError:
        """Create an instance of InvalidParametersError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InvalidParametersError.parse_obj(obj)

        _obj = InvalidParametersError.parse_obj({
            "name": obj.get("name"),
