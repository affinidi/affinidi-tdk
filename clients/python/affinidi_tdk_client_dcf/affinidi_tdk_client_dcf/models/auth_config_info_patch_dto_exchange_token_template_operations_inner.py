...
class AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInner(BaseModel):
    """
    ...
    functions: Optional[AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInnerFunctions] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInner:
        """Create an instance of AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInner.parse_obj(obj)

        _obj = AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInner.parse_obj({
            "template": obj.get("template"),
            "functions": AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInnerFunctions.from_dict(obj.get("functions")) if obj.get("functions") is not None else None
        })
        return _obj
