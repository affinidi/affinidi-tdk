...
class DataSourceValidationResult(BaseModel):
    ...
    """
    validation_result: Optional[DataSourceValidationResultValidationResult] = Field(None, alias="validationResult")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataSourceValidationResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DataSourceValidationResult:
        """Create an instance of DataSourceValidationResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DataSourceValidationResult.parse_obj(obj)

        _obj = DataSourceValidationResult.parse_obj({
            "validation_result": DataSourceValidationResultValidationResult.from_dict(obj.get("validationResult")) if obj.get("validationResult") is not None else None
        })
        return _obj
