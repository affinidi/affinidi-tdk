...
from affinidi_tdk_client_dcf.models.null<config_template_dto_inner> import null<ConfigTemplateDtoInner>

class ConfigTemplateDto(null<ConfigTemplateDtoInner>):
    """
    A list to define templates fields which need to have specific names for the Connector. For example `clientSecret` needs to be named `secret` for the Deezer connector.   # noqa: E501
    """
    __properties = []
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigTemplateDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigTemplateDto:
        """Create an instance of ConfigTemplateDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigTemplateDto.parse_obj(obj)

        _obj = ConfigTemplateDto.parse_obj({
        })
        return _obj
