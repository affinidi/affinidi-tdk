...
class DataSourcePatchStatusRequest(BaseModel):
    """
    Updates a data source status.   # noqa: E501
    """
    status: StrictStr = Field(..., description="The status of the data source. ")
    config: Optional[ConnectorAuthConfig] = None
    __properties = ["status", "config"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataSourcePatchStatusRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DataSourcePatchStatusRequest:
        """Create an instance of DataSourcePatchStatusRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DataSourcePatchStatusRequest.parse_obj(obj)

        _obj = DataSourcePatchStatusRequest.parse_obj({
