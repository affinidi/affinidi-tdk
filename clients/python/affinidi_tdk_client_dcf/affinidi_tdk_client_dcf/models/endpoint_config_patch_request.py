...
class EndpointConfigPatchRequest(BaseModel):
    """
    ...
    operations: Optional[conlist(EndpointConfigPatchRequestOperationsInner)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EndpointConfigPatchRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EndpointConfigPatchRequest:
        """Create an instance of EndpointConfigPatchRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EndpointConfigPatchRequest.parse_obj(obj)

        _obj = EndpointConfigPatchRequest.parse_obj({
            "options": obj.get("options"),
            "operations": [EndpointConfigPatchRequestOperationsInner.from_dict(_item) for _item in obj.get("operations")] if obj.get("operations") is not None else None
        })
        return _obj
