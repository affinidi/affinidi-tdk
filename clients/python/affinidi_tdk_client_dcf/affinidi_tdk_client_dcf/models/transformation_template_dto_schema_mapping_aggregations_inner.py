...
class TransformationTemplateDtoSchemaMappingAggregationsInner(BaseModel):
    """
    ...
    def name_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^(count|sum|mean|min|max|concat)$", value):
            raise ValueError(r"must validate the regular expression /^(count|sum|mean|min|max|concat)$/")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransformationTemplateDtoSchemaMappingAggregationsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransformationTemplateDtoSchemaMappingAggregationsInner:
        """Create an instance of TransformationTemplateDtoSchemaMappingAggregationsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransformationTemplateDtoSchemaMappingAggregationsInner.parse_obj(obj)

        _obj = TransformationTemplateDtoSchemaMappingAggregationsInner.parse_obj({
            "name": obj.get("name"),
