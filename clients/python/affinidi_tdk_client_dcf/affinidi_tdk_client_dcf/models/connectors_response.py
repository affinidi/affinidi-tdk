...
class ConnectorsResponse(BaseModel):
    """
    List of all configured connectors.   # noqa: E501
    """
    connectors: conlist(ConnectorDTO) = Field(..., description="A list of available connectors. ")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConnectorsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConnectorsResponse:
        """Create an instance of ConnectorsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConnectorsResponse.parse_obj(obj)

        _obj = ConnectorsResponse.parse_obj({
