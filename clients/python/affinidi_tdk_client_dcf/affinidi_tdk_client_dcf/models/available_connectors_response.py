...
class AvailableConnectorsResponse(BaseModel):
    """
    List of all available connectors.   # noqa: E501
    """
    connectors: conlist(AvailableConnectorDTO) = Field(..., description="A list of available connectors. ")
    __properties = ["connectors"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AvailableConnectorsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AvailableConnectorsResponse:
        """Create an instance of AvailableConnectorsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AvailableConnectorsResponse.parse_obj(obj)

        _obj = AvailableConnectorsResponse.parse_obj({
            "connectors": [AvailableConnectorDTO.from_dict(_item) for _item in obj.get("connectors")] if obj.get("connectors") is not None else None
        })
        return _obj
