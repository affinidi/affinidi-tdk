...
class AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInnerFunctions(BaseModel):
    """
    An object defining functions which process the received refresh token data from the operation.   # noqa: E501
    """
    get_data: Optional[conlist(StrictStr)] = Field(None, alias="getData", description="Should always be an empty array. ")
    __properties = ["getData"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInnerFunctions:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInnerFunctions:
        """Create an instance of AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInnerFunctions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInnerFunctions.parse_obj(obj)

        _obj = AuthConfigInfoPatchDtoRefreshTokenTemplateOperationsInnerFunctions.parse_obj({
            "get_data": obj.get("getData")
        })
        return _obj
