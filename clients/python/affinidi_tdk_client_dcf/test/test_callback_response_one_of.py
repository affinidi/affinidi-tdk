...
from affinidi_tdk_client_dcf.models.callback_response_one_of import CallbackResponseOneOf  # noqa: E501

class TestCallbackResponseOneOf(unittest.TestCase):
    """CallbackResponseOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CallbackResponseOneOf:
        """Test CallbackResponseOneOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CallbackResponseOneOf`
        """
        model = CallbackResponseOneOf()  # noqa: E501
        if include_optional:
            return CallbackResponseOneOf(
                connection_id = '',
                data_source = ''
            )
        else:
    ...
    def testCallbackResponseOneOf(self):
        """Test CallbackResponseOneOf"""
