...
from affinidi_tdk_client_dcf.models.auth_config_info_patch_dto_refresh_token_template import AuthConfigInfoPatchDtoRefreshTokenTemplate  # noqa: E501

class TestAuthConfigInfoPatchDtoRefreshTokenTemplate(unittest.TestCase):
    """AuthConfigInfoPatchDtoRefreshTokenTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthConfigInfoPatchDtoRefreshTokenTemplate:
        """Test AuthConfigInfoPatchDtoRefreshTokenTemplate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthConfigInfoPatchDtoRefreshTokenTemplate`
        """
        model = AuthConfigInfoPatchDtoRefreshTokenTemplate()  # noqa: E501
        if include_optional:
            return AuthConfigInfoPatchDtoRefreshTokenTemplate(
    ...
    def testAuthConfigInfoPatchDtoRefreshTokenTemplate(self):
        """Test AuthConfigInfoPatchDtoRefreshTokenTemplate"""
