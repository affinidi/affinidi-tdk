...
from affinidi_tdk_client_dcf.models.patch_connector_request import PatchConnectorRequest  # noqa: E501

class TestPatchConnectorRequest(unittest.TestCase):
    """PatchConnectorRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchConnectorRequest:
        """Test PatchConnectorRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchConnectorRequest`
        """
        model = PatchConnectorRequest()  # noqa: E501
        if include_optional:
    ...
    def testPatchConnectorRequest(self):
        """Test PatchConnectorRequest"""
