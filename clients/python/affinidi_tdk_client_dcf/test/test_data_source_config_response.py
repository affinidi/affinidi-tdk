...
from affinidi_tdk_client_dcf.models.data_source_config_response import DataSourceConfigResponse  # noqa: E501

class TestDataSourceConfigResponse(unittest.TestCase):
    """DataSourceConfigResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataSourceConfigResponse:
        """Test DataSourceConfigResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataSourceConfigResponse`
        """
        model = DataSourceConfigResponse()  # noqa: E501
        if include_optional:
            return DataSourceConfigResponse(
                data_source_configs = [
                    affinidi_tdk_client_dcf.models.auth_config.AuthConfig(
                        id = '', 
    ...
    def testDataSourceConfigResponse(self):
        """Test DataSourceConfigResponse"""
