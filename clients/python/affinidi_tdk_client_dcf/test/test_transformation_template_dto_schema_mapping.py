...
from affinidi_tdk_client_dcf.models.transformation_template_dto_schema_mapping import TransformationTemplateDtoSchemaMapping  # noqa: E501

class TestTransformationTemplateDtoSchemaMapping(unittest.TestCase):
    """TransformationTemplateDtoSchemaMapping unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransformationTemplateDtoSchemaMapping:
        """Test TransformationTemplateDtoSchemaMapping
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransformationTemplateDtoSchemaMapping`
        """
        model = TransformationTemplateDtoSchemaMapping()  # noqa: E501
        if include_optional:
            return TransformationTemplateDtoSchemaMapping(
                transformations = [
                    { }
                    ],
                aggregations = [
    ...
    def testTransformationTemplateDtoSchemaMapping(self):
        """Test TransformationTemplateDtoSchemaMapping"""
