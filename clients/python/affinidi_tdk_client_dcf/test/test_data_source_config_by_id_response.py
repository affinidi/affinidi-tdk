...
from affinidi_tdk_client_dcf.models.data_source_config_by_id_response import DataSourceConfigByIdResponse  # noqa: E501

class TestDataSourceConfigByIdResponse(unittest.TestCase):
    """DataSourceConfigByIdResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataSourceConfigByIdResponse:
        """Test DataSourceConfigByIdResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataSourceConfigByIdResponse`
        """
        model = DataSourceConfigByIdResponse()  # noqa: E501
        if include_optional:
            return DataSourceConfigByIdResponse(
                data_source_config = affinidi_tdk_client_dcf.models.auth_config_dto.AuthConfigDto(
                    id = '', 
                    data_source_config_name = '', 
                    status = 'DRAFT', 
                ...
                validation_result = affinidi_tdk_client_dcf.models.data_source_config_validation_result_validation_result.DataSourceConfigValidationResult_validationResult(
                    is_successful = True, 
                    connection_id = '', 
                    response = { }, )
            )
    ...
    def testDataSourceConfigByIdResponse(self):
        """Test DataSourceConfigByIdResponse"""
