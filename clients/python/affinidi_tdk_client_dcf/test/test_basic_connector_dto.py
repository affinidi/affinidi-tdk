...
from affinidi_tdk_client_dcf.models.basic_connector_dto import BasicConnectorDTO  # noqa: E501

class TestBasicConnectorDTO(unittest.TestCase):
    """BasicConnectorDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BasicConnectorDTO:
        """Test BasicConnectorDTO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BasicConnectorDTO`
        """
        model = BasicConnectorDTO()  # noqa: E501
        if include_optional:
            return BasicConnectorDTO(
                name = '',
                website = '',
                icon = '',
                connector_id = ''
    ...
    def testBasicConnectorDTO(self):
        """Test BasicConnectorDTO"""
