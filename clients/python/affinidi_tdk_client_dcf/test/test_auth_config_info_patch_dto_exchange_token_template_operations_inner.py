...
from affinidi_tdk_client_dcf.models.auth_config_info_patch_dto_exchange_token_template_operations_inner import AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInner  # noqa: E501

class TestAuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInner(unittest.TestCase):
    """AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInner:
        """Test AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInner`
        """
        model = AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInner()  # noqa: E501
        if include_optional:
            return AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInner(
                template = { },
    ...
    def testAuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInner(self):
        """Test AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInner"""
