...
from affinidi_tdk_client_dcf.models.data_source_config_patch_request import DataSourceConfigPatchRequest  # noqa: E501

class TestDataSourceConfigPatchRequest(unittest.TestCase):
    """DataSourceConfigPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataSourceConfigPatchRequest:
        """Test DataSourceConfigPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataSourceConfigPatchRequest`
        """
        model = DataSourceConfigPatchRequest()  # noqa: E501
        if include_optional:
            return DataSourceConfigPatchRequest(
                auth_config_info = affinidi_tdk_client_dcf.models.auth_config_info_patch_dto.AuthConfigInfoPatchDto(
    ...
    def testDataSourceConfigPatchRequest(self):
        """Test DataSourceConfigPatchRequest"""
