...
from affinidi_tdk_client_dcf.models.config_template_dto_inner import ConfigTemplateDtoInner  # noqa: E501

class TestConfigTemplateDtoInner(unittest.TestCase):
    """ConfigTemplateDtoInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigTemplateDtoInner:
        """Test ConfigTemplateDtoInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigTemplateDtoInner`
        """
        model = ConfigTemplateDtoInner()  # noqa: E501
        if include_optional:
            return ConfigTemplateDtoInner(
                key = '',
                value = '',
                description = ''
            )
    ...
    def testConfigTemplateDtoInner(self):
        """Test ConfigTemplateDtoInner"""
