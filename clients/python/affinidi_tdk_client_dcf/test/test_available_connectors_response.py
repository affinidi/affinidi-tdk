...
from affinidi_tdk_client_dcf.models.available_connectors_response import AvailableConnectorsResponse  # noqa: E501
...
class TestAvailableConnectorsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AvailableConnectorsResponse:
        ...
        """
        model = AvailableConnectorsResponse()  # noqa: E501
        if include_optional:
            return AvailableConnectorsResponse(
                connectors = [
                    affinidi_tdk_client_dcf.models.available_connector_dto.AvailableConnectorDTO(
                        id = '', 
                        name = '', 
                        icon = 'YQ==', 
                        website_uri = '', )
