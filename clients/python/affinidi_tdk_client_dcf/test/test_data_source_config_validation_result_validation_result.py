...
from affinidi_tdk_client_dcf.models.data_source_config_validation_result_validation_result import DataSourceConfigValidationResultValidationResult  # noqa: E501

class TestDataSourceConfigValidationResultValidationResult(unittest.TestCase):
    """DataSourceConfigValidationResultValidationResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataSourceConfigValidationResultValidationResult:
        """Test DataSourceConfigValidationResultValidationResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataSourceConfigValidationResultValidationResult`
        """
        model = DataSourceConfigValidationResultValidationResult()  # noqa: E501
        if include_optional:
            return DataSourceConfigValidationResultValidationResult(
                is_successful = True,
                connection_id = '',
                response = { }
            )
    ...
    def testDataSourceConfigValidationResultValidationResult(self):
        """Test DataSourceConfigValidationResultValidationResult"""
