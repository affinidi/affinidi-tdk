...
from affinidi_tdk_client_dcf.models.mappings_response import MappingsResponse  # noqa: E501

class TestMappingsResponse(unittest.TestCase):
    """MappingsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MappingsResponse:
        """Test MappingsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MappingsResponse`
        """
        model = MappingsResponse()  # noqa: E501
        if include_optional:
            return MappingsResponse(
                mappings = {
                    'key' : [
                        affinidi_tdk_client_dcf.models.basic_connector_dto.BasicConnectorDTO(
                            name = '', 
                            website = '', 
                            icon = '', 
                            connector_id = '', )
