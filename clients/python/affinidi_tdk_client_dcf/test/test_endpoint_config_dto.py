...
from affinidi_tdk_client_dcf.models.endpoint_config_dto import EndpointConfigDto  # noqa: E501

class TestEndpointConfigDto(unittest.TestCase):
    """EndpointConfigDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointConfigDto:
        """Test EndpointConfigDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointConfigDto`
        """
        model = EndpointConfigDto()  # noqa: E501
        if include_optional:
    ...
    def testEndpointConfigDto(self):
        """Test EndpointConfigDto"""
