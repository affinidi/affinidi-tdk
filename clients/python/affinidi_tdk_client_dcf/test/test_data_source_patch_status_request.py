...
from affinidi_tdk_client_dcf.models.data_source_patch_status_request import DataSourcePatchStatusRequest  # noqa: E501

class TestDataSourcePatchStatusRequest(unittest.TestCase):
    """DataSourcePatchStatusRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataSourcePatchStatusRequest:
        """Test DataSourcePatchStatusRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataSourcePatchStatusRequest`
        """
        model = DataSourcePatchStatusRequest()  # noqa: E501
        if include_optional:
            return DataSourcePatchStatusRequest(
                status = 'DRAFT',
    ...
    def testDataSourcePatchStatusRequest(self):
        """Test DataSourcePatchStatusRequest"""
