...
from affinidi_tdk_client_dcf.models.endpoint_config_patch_request_operations_inner import EndpointConfigPatchRequestOperationsInner  # noqa: E501

class TestEndpointConfigPatchRequestOperationsInner(unittest.TestCase):
    """EndpointConfigPatchRequestOperationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointConfigPatchRequestOperationsInner:
        """Test EndpointConfigPatchRequestOperationsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointConfigPatchRequestOperationsInner`
        """
        model = EndpointConfigPatchRequestOperationsInner()  # noqa: E501
        if include_optional:
            return EndpointConfigPatchRequestOperationsInner(
                template = { },
                functions = { },
                pagination = { },
                source_schema = { }
    ...
    def testEndpointConfigPatchRequestOperationsInner(self):
        """Test EndpointConfigPatchRequestOperationsInner"""
