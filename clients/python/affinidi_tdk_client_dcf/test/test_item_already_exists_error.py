...
from affinidi_tdk_client_dcf.models.item_already_exists_error import ItemAlreadyExistsError  # noqa: E501

class TestItemAlreadyExistsError(unittest.TestCase):
    """ItemAlreadyExistsError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemAlreadyExistsError:
        """Test ItemAlreadyExistsError
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemAlreadyExistsError`
        """
        model = ItemAlreadyExistsError()  # noqa: E501
        if include_optional:
    ...
    def testItemAlreadyExistsError(self):
        """Test ItemAlreadyExistsError"""
