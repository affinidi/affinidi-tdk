...
from affinidi_tdk_client_dcf.models.data_source_config_patch_status_request import DataSourceConfigPatchStatusRequest  # noqa: E501

class TestDataSourceConfigPatchStatusRequest(unittest.TestCase):
    """DataSourceConfigPatchStatusRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataSourceConfigPatchStatusRequest:
        """Test DataSourceConfigPatchStatusRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataSourceConfigPatchStatusRequest`
        """
        model = DataSourceConfigPatchStatusRequest()  # noqa: E501
        if include_optional:
            return DataSourceConfigPatchStatusRequest(
                status = 'DRAFT',
                scope = '',
    ...
    def testDataSourceConfigPatchStatusRequest(self):
        """Test DataSourceConfigPatchStatusRequest"""
