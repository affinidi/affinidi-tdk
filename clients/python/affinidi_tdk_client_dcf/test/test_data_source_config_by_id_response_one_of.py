...
from affinidi_tdk_client_dcf.models.data_source_config_by_id_response_one_of import DataSourceConfigByIdResponseOneOf  # noqa: E501

class TestDataSourceConfigByIdResponseOneOf(unittest.TestCase):
    """DataSourceConfigByIdResponseOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataSourceConfigByIdResponseOneOf:
        """Test DataSourceConfigByIdResponseOneOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataSourceConfigByIdResponseOneOf`
        """
        model = DataSourceConfigByIdResponseOneOf()  # noqa: E501
        if include_optional:
            return DataSourceConfigByIdResponseOneOf(
    ...
    def testDataSourceConfigByIdResponseOneOf(self):
        """Test DataSourceConfigByIdResponseOneOf"""
