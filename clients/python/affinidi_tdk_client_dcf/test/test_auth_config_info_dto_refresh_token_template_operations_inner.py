...
from affinidi_tdk_client_dcf.models.auth_config_info_dto_refresh_token_template_operations_inner import AuthConfigInfoDtoRefreshTokenTemplateOperationsInner  # noqa: E501

class TestAuthConfigInfoDtoRefreshTokenTemplateOperationsInner(unittest.TestCase):
    """AuthConfigInfoDtoRefreshTokenTemplateOperationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthConfigInfoDtoRefreshTokenTemplateOperationsInner:
        """Test AuthConfigInfoDtoRefreshTokenTemplateOperationsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthConfigInfoDtoRefreshTokenTemplateOperationsInner`
        """
        model = AuthConfigInfoDtoRefreshTokenTemplateOperationsInner()  # noqa: E501
        if include_optional:
            return AuthConfigInfoDtoRefreshTokenTemplateOperationsInner(
                template = { },
    ...
    def testAuthConfigInfoDtoRefreshTokenTemplateOperationsInner(self):
        """Test AuthConfigInfoDtoRefreshTokenTemplateOperationsInner"""
