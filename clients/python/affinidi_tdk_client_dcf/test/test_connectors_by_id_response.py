...
from affinidi_tdk_client_dcf.models.connectors_by_id_response import ConnectorsByIdResponse  # noqa: E501

class TestConnectorsByIdResponse(unittest.TestCase):
    """ConnectorsByIdResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectorsByIdResponse:
        """Test ConnectorsByIdResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectorsByIdResponse`
        """
        model = ConnectorsByIdResponse()  # noqa: E501
        if include_optional:
            return ConnectorsByIdResponse(
                connector = affinidi_tdk_client_dcf.models.connector_dto.ConnectorDTO(
                    id = '', 
                    name = '', 
    ...
    def testConnectorsByIdResponse(self):
        """Test ConnectorsByIdResponse"""
