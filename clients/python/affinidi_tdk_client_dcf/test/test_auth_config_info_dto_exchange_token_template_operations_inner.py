...
from affinidi_tdk_client_dcf.models.auth_config_info_dto_exchange_token_template_operations_inner import AuthConfigInfoDtoExchangeTokenTemplateOperationsInner  # noqa: E501

class TestAuthConfigInfoDtoExchangeTokenTemplateOperationsInner(unittest.TestCase):
    """AuthConfigInfoDtoExchangeTokenTemplateOperationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthConfigInfoDtoExchangeTokenTemplateOperationsInner:
        """Test AuthConfigInfoDtoExchangeTokenTemplateOperationsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthConfigInfoDtoExchangeTokenTemplateOperationsInner`
        """
        model = AuthConfigInfoDtoExchangeTokenTemplateOperationsInner()  # noqa: E501
        if include_optional:
            return AuthConfigInfoDtoExchangeTokenTemplateOperationsInner(
                template = { },
    ...
    def testAuthConfigInfoDtoExchangeTokenTemplateOperationsInner(self):
        """Test AuthConfigInfoDtoExchangeTokenTemplateOperationsInner"""
