...
from affinidi_tdk_client_dcf.models.data_source_validation_result_validation_result import DataSourceValidationResultValidationResult  # noqa: E501

class TestDataSourceValidationResultValidationResult(unittest.TestCase):
    """DataSourceValidationResultValidationResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataSourceValidationResultValidationResult:
        """Test DataSourceValidationResultValidationResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataSourceValidationResultValidationResult`
        """
        model = DataSourceValidationResultValidationResult()  # noqa: E501
        if include_optional:
            return DataSourceValidationResultValidationResult(
                is_successful = True,
                connection_id = '',
                response = [
                    ''
    ...
    def testDataSourceValidationResultValidationResult(self):
        """Test DataSourceValidationResultValidationResult"""
