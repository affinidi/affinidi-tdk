...
from affinidi_tdk_client_dcf.models.auth_config_info_patch_dto_exchange_token_template_operations_inner_functions import AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInnerFunctions  # noqa: E501

class TestAuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInnerFunctions(unittest.TestCase):
    """AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInnerFunctions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInnerFunctions:
        """Test AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInnerFunctions
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInnerFunctions`
        """
        model = AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInnerFunctions()  # noqa: E501
        if include_optional:
            return AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInnerFunctions(
                get_data = [
                    ''
                    ]
            )
    ...
    def testAuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInnerFunctions(self):
        """Test AuthConfigInfoPatchDtoExchangeTokenTemplateOperationsInnerFunctions"""
