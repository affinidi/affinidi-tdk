...
class UpdateConfigurationByIdInputClientMetadata(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateConfigurationByIdInputClientMetadata:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateConfigurationByIdInputClientMetadata:
        """Create an instance of UpdateConfigurationByIdInputClientMetadata from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateConfigurationByIdInputClientMetadata.parse_obj(obj)

        _obj = UpdateConfigurationByIdInputClientMetadata.parse_obj({
            "name": obj.get("name"),
