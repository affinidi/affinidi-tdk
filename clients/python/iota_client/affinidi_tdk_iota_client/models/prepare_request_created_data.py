...
class PrepareRequestCreatedData(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareRequestCreatedData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareRequestCreatedData:
        """Create an instance of PrepareRequestCreatedData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareRequestCreatedData.parse_obj(obj)

        _obj = PrepareRequestCreatedData.parse_obj({
            "jwt": obj.get("jwt"),
