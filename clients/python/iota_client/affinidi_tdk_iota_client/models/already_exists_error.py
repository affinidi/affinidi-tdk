...
class AlreadyExistsError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AlreadyExistsError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AlreadyExistsError:
        """Create an instance of AlreadyExistsError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AlreadyExistsError.parse_obj(obj)

        _obj = AlreadyExistsError.parse_obj({
            "name": obj.get("name"),
