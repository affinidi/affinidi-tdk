...
class GetIotaConfigurationMetaDataOK(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetIotaConfigurationMetaDataOK:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetIotaConfigurationMetaDataOK:
        """Create an instance of GetIotaConfigurationMetaDataOK from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetIotaConfigurationMetaDataOK.parse_obj(obj)

        _obj = GetIotaConfigurationMetaDataOK.parse_obj({
            "name": obj.get("name"),
