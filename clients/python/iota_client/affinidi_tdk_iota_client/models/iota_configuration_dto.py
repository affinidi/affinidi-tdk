...
class IotaConfigurationDto(BaseModel):
    ...
    """
    ari: StrictStr = Field(..., description="The ARI of the config")
    ...
    token_max_age: Union[StrictFloat, StrictInt] = Field(..., alias="tokenMaxAge", description="token time to live in seconds")
