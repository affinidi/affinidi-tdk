...
class ResourceLimitExceededError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceLimitExceededError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceLimitExceededError:
        """Create an instance of ResourceLimitExceededError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceLimitExceededError.parse_obj(obj)

        _obj = ResourceLimitExceededError.parse_obj({
            "name": obj.get("name"),
