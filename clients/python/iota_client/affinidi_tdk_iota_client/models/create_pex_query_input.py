...
class CreatePexQueryInput(BaseModel):
    """
    CreatePexQueryInput
    """
    name: StrictStr = Field(...)
    vp_definition: StrictStr = Field(..., alias="vpDefinition", description="VP definition in JSON stringify format")
    description: Optional[StrictStr] = Field(None, description="Description of query")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreatePexQueryInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreatePexQueryInput:
        """Create an instance of CreatePexQueryInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreatePexQueryInput.parse_obj(obj)

        _obj = CreatePexQueryInput.parse_obj({
            "name": obj.get("name"),
