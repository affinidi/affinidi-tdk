...
class PexQueryApi:
    ...
    @validate_arguments
    def list_pex_queries(self, configuration_id : Annotated[StrictStr, Field(..., description="iotaConfiguration Id")], **kwargs) -> ListPexQueriesOK:  # noqa: E501
        """list_pex_queries  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_pex_queries(configuration_id, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.list_pex_queries_with_http_info(configuration_id, **kwargs)  # noqa: E501

    @validate_arguments
    def list_pex_queries_with_http_info(self, configuration_id : Annotated[StrictStr, Field(..., description="iotaConfiguration Id")], **kwargs) -> ApiResponse:  # noqa: E501
        """list_pex_queries  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_pex_queries_with_http_info(configuration_id, async_req=True)
        >>> result = thread.get()
