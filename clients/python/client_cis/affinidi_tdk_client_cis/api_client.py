...
import affinidi_tdk_client_cis.models
from affinidi_tdk_client_cis import rest
from affinidi_tdk_client_cis.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(affinidi_tdk_client_cis.models, klass)
