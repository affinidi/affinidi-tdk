...
class OfferApi:
    ...
    def get_credential_offer_with_http_info(self, issuance_id : Annotated[StrictStr, Field(..., description="issuanceId from credential_offer_uri")], **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CredentialOfferResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_credential_offer" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "CredentialOfferResponse",
        }

        return self.api_client.call_api(
            '/v1/{projectId}/offer/{issuanceId}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
