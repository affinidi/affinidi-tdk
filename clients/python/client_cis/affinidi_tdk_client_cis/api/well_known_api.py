...
class WellKnownApi:
    ...
    def get_well_known_open_id_credential_issuer(self, **kwargs) -> WellKnownOpenIdCredentialIssuerResponse:  # noqa: E501
        ...
        :rtype: WellKnownOpenIdCredentialIssuerResponse
        """
    ...
    def get_well_known_open_id_credential_issuer_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(WellKnownOpenIdCredentialIssuerResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_well_known_open_id_credential_issuer" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "WellKnownOpenIdCredentialIssuerResponse",
        }

        return self.api_client.call_api(
            '/v1/{projectId}/.well-known/openid-credential-issuer', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
