...
class StartIssuanceInput(BaseModel):
    ...
    data: StartIssuanceInputData = Field(...)
    __properties = ["holderDid", "issuanceId", "data"]
    ...
    def from_dict(cls, obj: dict) -> StartIssuanceInput:
        ...
        _obj = StartIssuanceInput.parse_obj({
            ...
            "data": StartIssuanceInputData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
