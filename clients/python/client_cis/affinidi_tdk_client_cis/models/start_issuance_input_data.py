...
class StartIssuanceInputData(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StartIssuanceInputData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StartIssuanceInputData:
        """Create an instance of StartIssuanceInputData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StartIssuanceInputData.parse_obj(obj)

        _obj = StartIssuanceInputData.parse_obj({
