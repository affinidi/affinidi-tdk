...
class ListIssuanceResponse(BaseModel):
    ...
    """
    issuance_ids: conlist(StrictStr) = Field(..., alias="issuanceIds", description="The list of all issuances for the Project")
    __properties = ["issuanceIds"]
    ...
    def from_dict(cls, obj: dict) -> ListIssuanceResponse:
        ...
        _obj = ListIssuanceResponse.parse_obj({
            "issuance_ids": obj.get("issuanceIds")
        })
        return _obj
