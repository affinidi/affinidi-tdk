...
import affinidi_tdk_client_cwe.models
from affinidi_tdk_client_cwe import rest
from affinidi_tdk_client_cwe.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(affinidi_tdk_client_cwe.models, klass)
