# affinidi_tdk_client_cwe.WalletApi
...
with affinidi_tdk_client_cwe.ApiClient(configuration) as api_client:
    ...
    api_instance = affinidi_tdk_client_cwe.WalletApi(api_client)
    create_wallet_input = affinidi_tdk_client_cwe.CreateWalletInput() # CreateWalletInput | CreateWallet (optional)
...
with affinidi_tdk_client_cwe.ApiClient(configuration) as api_client:
    ...
    api_instance = affinidi_tdk_client_cwe.WalletApi(api_client)
    wallet_id = 'wallet_id_example' # str | id of the wallet
    sign_credential_input_dto = affinidi_tdk_client_cwe.SignCredentialInputDto() # SignCredentialInputDto | SignCredential
