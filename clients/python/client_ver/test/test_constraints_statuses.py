...
from affinidi_tdk_client_ver.models.constraints_statuses import ConstraintsStatuses  # noqa: E501
        ...
        if include_optional:
            return ConstraintsStatuses(
                ...
                suspended = affinidi_tdk_client_ver.models.pd_status.PdStatus(
                    directive = 'required', ),
                revoked = affinidi_tdk_client_ver.models.pd_status.PdStatus(
                    directive = 'required', )
            )
        else:
            return ConstraintsStatuses(
