...
from affinidi_tdk_client_ver.models.format import Format  # noqa: E501
    ...
    def make_instance(self, include_optional) -> Format:
        ...
        if include_optional:
            return Format(
                ...
                jwt_vp = affinidi_tdk_client_ver.models.jwt_object.JwtObject(
                    alg = [
                        ''
                        ], ),
                ...
                ldp_vp = affinidi_tdk_client_ver.models.ldp_object.LdpObject(
                    proof_type = [
                        ''
                        ], )
            )
