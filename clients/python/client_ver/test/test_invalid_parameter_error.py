...
from affinidi_tdk_client_ver.models.invalid_parameter_error import InvalidParameterError  # noqa: E501
    ...
    def make_instance(self, include_optional) -> InvalidParameterError:
        ...
        if include_optional:
            return InvalidParameterError(
                ...
                trace_id = '',
                details = [
                    affinidi_tdk_client_ver.models.not_found_error_details_inner.NotFoundError_details_inner(
                        issue = '', 
                        field = '', 
                        value = '', 
                        location = '', )
