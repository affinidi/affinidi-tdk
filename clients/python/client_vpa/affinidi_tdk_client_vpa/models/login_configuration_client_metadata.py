...
class LoginConfigurationClientMetadata(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoginConfigurationClientMetadata:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoginConfigurationClientMetadata:
        """Create an instance of LoginConfigurationClientMetadata from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoginConfigurationClientMetadata.parse_obj(obj)

        _obj = LoginConfigurationClientMetadata.parse_obj({
            "name": obj.get("name"),
