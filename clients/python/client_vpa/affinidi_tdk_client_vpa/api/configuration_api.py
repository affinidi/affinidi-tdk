...
class ConfigurationApi:
    ...
    @validate_arguments
    def get_client_metadata_by_client_id(self, client_id : Annotated[StrictStr, Field(..., description="OAuth 2.0 Client ID")], **kwargs) -> LoginConfigurationClientMetadata:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: LoginConfigurationClientMetadata
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
    ...
    def get_client_metadata_by_client_id_with_http_info(self, client_id : Annotated[StrictStr, Field(..., description="OAuth 2.0 Client ID")], **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(LoginConfigurationClientMetadata, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        _response_types_map = {
            '200': "LoginConfigurationClientMetadata",
            '400': "InvalidParameterError",
            '404': "NotFoundError",
        }
