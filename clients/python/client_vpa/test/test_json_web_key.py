...
from affinidi_tdk_client_vpa.models.json_web_key import JsonWebKey  # noqa: E501
...
class TestJsonWebKey(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> JsonWebKey:
        ...
        if include_optional:
            return JsonWebKey(
                keys = [
                    affinidi_tdk_client_vpa.models.json_web_key_keys_inner.JsonWebKey_keys_inner(
                        alg = '', 
                        crv = '', 
                        d = '', 
                        dp = '', 
