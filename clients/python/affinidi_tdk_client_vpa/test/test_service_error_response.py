...
from affinidi_tdk_client_vpa.models.service_error_response import ServiceErrorResponse  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ServiceErrorResponse:
        ...
        if include_optional:
            return ServiceErrorResponse(
                ...
                code = '',
                details = [
                    affinidi_tdk_client_vpa.models.service_error_response_details_inner.ServiceErrorResponse_details_inner(
                        issue = '', 
                        field = '', 
                        value = '', 
                        location = '', )
