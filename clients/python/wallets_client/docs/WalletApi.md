...
> SignJwtV2ResultDto sign_jwt_v2(wallet_id, sign_jwt_v2_input_dto)
...
with affinidi_tdk_wallets_client.ApiClient(configuration) as api_client:
    ...
    api_instance = affinidi_tdk_wallets_client.WalletApi(api_client)
    wallet_id = 'wallet_id_example' # str | id of the wallet
    sign_jwt_v2_input_dto = affinidi_tdk_wallets_client.SignJwtV2InputDto() # SignJwtV2InputDto | SignJwtV2

    try:
        # Sign JWT.
        api_response = api_instance.sign_jwt_v2(wallet_id, sign_jwt_v2_input_dto)
...
| ------------------------- | --------------------------------------------- | ---------------- | ----- |
| **wallet_id**             | **str**                                       | id of the wallet |
| **sign_jwt_v2_input_dto** | [**SignJwtV2InputDto**](SignJwtV2InputDto.md) | SignJwtV2        |
