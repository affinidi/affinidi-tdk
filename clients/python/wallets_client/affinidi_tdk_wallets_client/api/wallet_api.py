...
class WalletApi:
    ...
    def create_wallet_v2_with_http_info(self, create_wallet_v2_input : Annotated[Optional[CreateWalletV2Input], Field(description="CreateWallet")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CreateWalletV2Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_wallet_v2" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def sign_jwt_v2(self, wallet_id : Annotated[StrictStr, Field(..., description="id of the wallet")], sign_jwt_v2_input_dto : Annotated[SignJwtV2InputDto, Field(..., description="SignJwtV2")], **kwargs) -> SignJwtV2ResultDto:  # noqa: E501
        """Sign JWT.  # noqa: E501
        ...
        >>> thread = api.sign_jwt_v2(wallet_id, sign_jwt_v2_input_dto, async_req=True)
        >>> result = thread.get()

        :param wallet_id: id of the wallet (required)
        :type wallet_id: str
        :param sign_jwt_v2_input_dto: SignJwtV2 (required)
        :type sign_jwt_v2_input_dto: SignJwtV2InputDto
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.sign_jwt_v2_with_http_info(wallet_id, sign_jwt_v2_input_dto, **kwargs)  # noqa: E501

    @validate_arguments
    def sign_jwt_v2_with_http_info(self, wallet_id : Annotated[StrictStr, Field(..., description="id of the wallet")], sign_jwt_v2_input_dto : Annotated[SignJwtV2InputDto, Field(..., description="SignJwtV2")], **kwargs) -> ApiResponse:  # noqa: E501
        """Sign JWT.  # noqa: E501
        ...
        >>> thread = api.sign_jwt_v2_with_http_info(wallet_id, sign_jwt_v2_input_dto, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(SignJwtV2ResultDto, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        # process the body parameter
        _body_params = None
        if _params['sign_jwt_v2_input_dto'] is not None:
            _body_params = _params['sign_jwt_v2_input_dto']
