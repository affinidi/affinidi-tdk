...
class RevocationApi:
    ...
    @validate_arguments
    def revoke_credentials(self, wallet_id : Annotated[StrictStr, Field(..., description="id of the wallet")], revoke_credentials_input : Annotated[RevokeCredentialsInput, Field(..., description="RevokeCredentials")], **kwargs) -> None:  # noqa: E501
        """Revoke Credentials.  # noqa: E501

        Update index/credential at appropriate revocation list (set revoked is true).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.revoke_credentials(wallet_id, revoke_credentials_input, async_req=True)
        >>> result = thread.get()

        :param wallet_id: id of the wallet (required)
        :type wallet_id: str
        :param revoke_credentials_input: RevokeCredentials (required)
        :type revoke_credentials_input: RevokeCredentialsInput
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.revoke_credentials_with_http_info(wallet_id, revoke_credentials_input, **kwargs)  # noqa: E501

    @validate_arguments
    def revoke_credentials_with_http_info(self, wallet_id : Annotated[StrictStr, Field(..., description="id of the wallet")], revoke_credentials_input : Annotated[RevokeCredentialsInput, Field(..., description="RevokeCredentials")], **kwargs) -> ApiResponse:  # noqa: E501
        """Revoke Credentials.  # noqa: E501
        ...
        >>> thread = api.revoke_credentials_with_http_info(wallet_id, revoke_credentials_input, async_req=True)
        >>> result = thread.get()
        ...
        # process the body parameter
        _body_params = None
        if _params['revoke_credentials_input'] is not None:
            _body_params = _params['revoke_credentials_input']
        ...
        return self.api_client.call_api(
            '/v2/wallets/{walletId}/credentials/revoke', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
