...
class RevokeCredentialsInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RevokeCredentialsInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RevokeCredentialsInput:
        """Create an instance of RevokeCredentialsInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RevokeCredentialsInput.parse_obj(obj)

        _obj = RevokeCredentialsInput.parse_obj({
