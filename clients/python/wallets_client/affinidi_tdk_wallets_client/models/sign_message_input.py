...
class SignMessageInput(BaseModel):
    """
    DTO contains params to sign plain text DIDComm message  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SignMessageInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SignMessageInput:
        """Create an instance of SignMessageInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SignMessageInput.parse_obj(obj)

        _obj = SignMessageInput.parse_obj({
