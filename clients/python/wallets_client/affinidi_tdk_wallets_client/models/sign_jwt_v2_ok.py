...
class SignJwtV2OK(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SignJwtV2OK:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SignJwtV2OK:
        """Create an instance of SignJwtV2OK from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SignJwtV2OK.parse_obj(obj)

        _obj = SignJwtV2OK.parse_obj({
