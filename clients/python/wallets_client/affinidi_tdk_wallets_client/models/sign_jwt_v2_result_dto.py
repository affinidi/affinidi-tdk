...
class SignJwtV2ResultDto(BaseModel):
    """
    SignJwtV2ResultDto
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SignJwtV2ResultDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SignJwtV2ResultDto:
        """Create an instance of SignJwtV2ResultDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SignJwtV2ResultDto.parse_obj(obj)

        _obj = SignJwtV2ResultDto.parse_obj({
