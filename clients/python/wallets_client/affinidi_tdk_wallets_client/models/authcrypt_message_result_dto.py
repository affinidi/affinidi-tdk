...
class AuthcryptMessageResultDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuthcryptMessageResultDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuthcryptMessageResultDto:
        """Create an instance of AuthcryptMessageResultDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuthcryptMessageResultDto.parse_obj(obj)

        _obj = AuthcryptMessageResultDto.parse_obj({
            "authcrypted_message": obj.get("authcryptedMessage")
        })
        return _obj
