...
from affinidi_tdk_wallets_client.models.sign_credential_input_dto import SignCredentialInputDto  # noqa: E501
    ...
    def make_instance(self, include_optional) -> SignCredentialInputDto:
        ...
        if include_optional:
            return SignCredentialInputDto(
                ...
                revocable = True,
                unsigned_credential_params = affinidi_tdk_wallets_client.models.sign_credential_input_dto_unsigned_credential_params.SignCredentialInputDto_unsignedCredentialParams(
                    json_ld_context_url = '', 
                    json_schema_url = '', 
                    type_name = '', 
                    credential_subject = { }, 
