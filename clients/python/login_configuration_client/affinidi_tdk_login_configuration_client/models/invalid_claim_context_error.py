...
class InvalidClaimContextError(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InvalidClaimContextError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InvalidClaimContextError:
        """Create an instance of InvalidClaimContextError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InvalidClaimContextError.parse_obj(obj)

        _obj = InvalidClaimContextError.parse_obj({
            "name": obj.get("name"),
