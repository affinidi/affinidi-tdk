...
class LoginConfigurationClientMetadataOutput(BaseModel):
    ...
    domain_verified: Optional[StrictBool] = Field(None, alias="domainVerified", description="indicates if the developer's ownership of the domain has been verified")
