...
class CreateProjectNetworkError(BaseModel):
    """
    ...
    def name_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('CreateProjectNetworkError'):
            raise ValueError("must be one of enum values ('CreateProjectNetworkError')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateProjectNetworkError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateProjectNetworkError:
        """Create an instance of CreateProjectNetworkError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateProjectNetworkError.parse_obj(obj)

        _obj = CreateProjectNetworkError.parse_obj({
            "name": obj.get("name"),
