...
class CreateLoginConfigurationOutputAuth(BaseModel):
    ...
    client_secret: Optional[StrictStr] = Field(None, alias="clientSecret", description="OAuth 2.0 Client Secret")
    scope: Optional[StrictStr] = Field(None, description="OAuth 2.0 Client Scope")
    issuer: Optional[StrictStr] = Field(None, description="Issuer URL")
