...
class CreateHydraNetworkError(BaseModel):
    """
    ...
    def name_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('CreateHydraNetworkError'):
            raise ValueError("must be one of enum values ('CreateHydraNetworkError')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateHydraNetworkError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateHydraNetworkError:
        """Create an instance of CreateHydraNetworkError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateHydraNetworkError.parse_obj(obj)

        _obj = CreateHydraNetworkError.parse_obj({
            "name": obj.get("name"),
