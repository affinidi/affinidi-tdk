...
class LoginConfigurationReadInvalidClientIdError(BaseModel):
    """
    ...
    def name_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('LoginConfigurationReadInvalidClientIdError'):
            raise ValueError("must be one of enum values ('LoginConfigurationReadInvalidClientIdError')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoginConfigurationReadInvalidClientIdError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoginConfigurationReadInvalidClientIdError:
        """Create an instance of LoginConfigurationReadInvalidClientIdError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoginConfigurationReadInvalidClientIdError.parse_obj(obj)

        _obj = LoginConfigurationReadInvalidClientIdError.parse_obj({
            "name": obj.get("name"),
