...
class LoginSessionForIDPInput(BaseModel):
    ...
    """
    login_challenge: StrictStr = Field(..., alias="loginChallenge", description="IDP Login Challenge to Associate the Session with")
    client_id: StrictStr = Field(..., alias="clientId", description="IDP client id to Associate the Session with")
