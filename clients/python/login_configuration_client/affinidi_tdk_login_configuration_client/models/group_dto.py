...
class GroupDto(BaseModel):
    ...
    GroupDto
    """
    ari: StrictStr = Field(..., description="Group ari")
    project_id: StrictStr = Field(..., alias="projectId", description="Project id")
    group_name: StrictStr = Field(..., alias="groupName", description="name of the group, identifier within a project")
    creation_date: StrictStr = Field(..., alias="creationDate", description="Group creation date")
