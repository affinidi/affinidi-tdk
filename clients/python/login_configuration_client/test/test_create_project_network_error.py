...
from affinidi_tdk_login_configuration_client.models.create_project_network_error import CreateProjectNetworkError  # noqa: E501

class TestCreateProjectNetworkError(unittest.TestCase):
    """CreateProjectNetworkError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateProjectNetworkError:
        """Test CreateProjectNetworkError
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateProjectNetworkError`
        """
        model = CreateProjectNetworkError()  # noqa: E501
        if include_optional:
    ...
    def testCreateProjectNetworkError(self):
        """Test CreateProjectNetworkError"""
