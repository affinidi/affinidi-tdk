...
from affinidi_tdk_login_configuration_client.models.invalid_groups_error import InvalidGroupsError  # noqa: E501

class TestInvalidGroupsError(unittest.TestCase):
    """InvalidGroupsError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvalidGroupsError:
        """Test InvalidGroupsError
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvalidGroupsError`
        """
        model = InvalidGroupsError()  # noqa: E501
        if include_optional:
    ...
    def testInvalidGroupsError(self):
        """Test InvalidGroupsError"""
