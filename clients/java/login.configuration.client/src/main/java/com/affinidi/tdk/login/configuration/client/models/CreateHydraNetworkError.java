 ...
 */
@JsonPropertyOrder({
  CreateHydraNetworkError.JSON_PROPERTY_NAME,
  CreateHydraNetworkError.JSON_PROPERTY_MESSAGE,
  CreateHydraNetworkError.JSON_PROPERTY_HTTP_STATUS_CODE,
  CreateHydraNetworkError.JSON_PROPERTY_TRACE_ID,
  CreateHydraNetworkError.JSON_PROPERTY_DETAILS
})
...
public class CreateHydraNetworkError {
  ...
  public enum NameEnum {
    CREATE_HYDRA_NETWORK_ERROR(String.valueOf("CreateHydraNetworkError"));
  ...
  public CreateHydraNetworkError name(@javax.annotation.Nonnull NameEnum name) {
  ...
  public CreateHydraNetworkError message(@javax.annotation.Nonnull MessageEnum message) {
  ...
  public CreateHydraNetworkError httpStatusCode(@javax.annotation.Nonnull HttpStatusCodeEnum httpStatusCode) {
  ...
  public CreateHydraNetworkError traceId(@javax.annotation.Nonnull String traceId) {
  ...
  public CreateHydraNetworkError details(@javax.annotation.Nullable List<InvalidParameterErrorDetailsInner> details) {
