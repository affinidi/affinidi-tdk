...
import com.affinidi.tdk.login.configuration.client.auth.Authentication;
import com.affinidi.tdk.login.configuration.client.auth.HttpBasicAuth;
import com.affinidi.tdk.login.configuration.client.auth.HttpBearerAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://apse1.api.affinidi.io/vpa";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://apse1.api.affinidi.io/vpa
     ...
     * @return a {@link com.affinidi.tdk.login.configuration.client.ApiClient} object
     */
    ...
    */
     ...
     * @throws com.affinidi.tdk.login.configuration.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.affinidi.tdk.login.configuration.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.affinidi.tdk.login.configuration.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.affinidi.tdk.login.configuration.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.affinidi.tdk.login.configuration.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.affinidi.tdk.login.configuration.client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.affinidi.tdk.login.configuration.client.ApiException If fails to update the parameters
     */
     ...
     * @throws com.affinidi.tdk.login.configuration.client.ApiException If fail to serialize the request body object into a string
     */
