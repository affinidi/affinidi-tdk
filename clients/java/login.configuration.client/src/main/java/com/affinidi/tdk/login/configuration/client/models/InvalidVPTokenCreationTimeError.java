 ...
 */
@JsonPropertyOrder({
  InvalidVPTokenCreationTimeError.JSON_PROPERTY_NAME,
  InvalidVPTokenCreationTimeError.JSON_PROPERTY_MESSAGE,
  InvalidVPTokenCreationTimeError.JSON_PROPERTY_HTTP_STATUS_CODE,
...
public class InvalidVPTokenCreationTimeError {
  ...
  public enum NameEnum {
    INVALID_VP_TOKEN_CREATION_TIME_ERROR(String.valueOf("InvalidVPTokenCreationTimeError"));
  ...
  public enum MessageEnum {
    VP_TOKEN_HAS_EXPIRED(String.valueOf("VP token has expired"));
  ...
  public InvalidVPTokenCreationTimeError name(@javax.annotation.Nonnull NameEnum name) {
  ...
  public InvalidVPTokenCreationTimeError message(@javax.annotation.Nonnull MessageEnum message) {
  ...
  public InvalidVPTokenCreationTimeError httpStatusCode(@javax.annotation.Nonnull HttpStatusCodeEnum httpStatusCode) {
  ...
  public InvalidVPTokenCreationTimeError traceId(@javax.annotation.Nonnull String traceId) {
  ...
  public InvalidVPTokenCreationTimeError details(@javax.annotation.Nullable List<InvalidParameterErrorDetailsInner> details) {
