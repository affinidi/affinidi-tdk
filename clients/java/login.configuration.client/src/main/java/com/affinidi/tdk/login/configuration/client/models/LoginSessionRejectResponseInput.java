 ...
 */
@JsonPropertyOrder({ LoginSessionRejectResponseInput.JSON_PROPERTY_ERROR,
...
public class LoginSessionRejectResponseInput extends HashMap<String, Object> {
    ...
    /**
     * The error should follow the OAuth2 error format (e.g. invalid_request, login_required). Defaults to
     * request_denied
     *
     * @return error
     */
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.error, loginSessionRejectResponseInput.error)
                ...
                && Objects.equals(this.state, loginSessionRejectResponseInput.state) && super.equals(o);
    }
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getErrorDescription() != null) {
            try {
                joiner.add(String.format("%serrorDescription%s=%s", prefix, suffix,
