 ...
 * GetUserInfo
 */
@JsonPropertyOrder({ GetUserInfo.JSON_PROPERTY_BIRTHDATE, GetUserInfo.JSON_PROPERTY_EMAIL,
        GetUserInfo.JSON_PROPERTY_EMAIL_VERIFIED, GetUserInfo.JSON_PROPERTY_FAMILY_NAME,
        GetUserInfo.JSON_PROPERTY_GENDER, GetUserInfo.JSON_PROPERTY_GIVEN_NAME, GetUserInfo.JSON_PROPERTY_LOCALE,
        GetUserInfo.JSON_PROPERTY_MIDDLE_NAME, GetUserInfo.JSON_PROPERTY_NAME, GetUserInfo.JSON_PROPERTY_NICKNAME,
        GetUserInfo.JSON_PROPERTY_PHONE_NUMBER, GetUserInfo.JSON_PROPERTY_PHONE_NUMBER_VERIFIED,
        GetUserInfo.JSON_PROPERTY_PICTURE, GetUserInfo.JSON_PROPERTY_PREFERRED_USERNAME,
        GetUserInfo.JSON_PROPERTY_PROFILE, GetUserInfo.JSON_PROPERTY_SUB, GetUserInfo.JSON_PROPERTY_UPDATED_AT,
        GetUserInfo.JSON_PROPERTY_WEBSITE, GetUserInfo.JSON_PROPERTY_ZONEINFO })
...
public class GetUserInfo {
     ...
     * RP MUST NOT rely upon this value being unique, as discussed in Section 5.7.
     *
     * @return email
     */
    @javax.annotation.Nullable
     ...
     * extension be represented using the RFC 3966 [RFC3966] extension syntax, for example, +1 (604)
     * 555-1234;ext&#x3D;5678.
     *
     * @return phoneNumber
     */
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.birthdate, getUserInfo.birthdate) && Objects.equals(this.email, getUserInfo.email)
                ...
                && Objects.equals(this.name, getUserInfo.name) && Objects.equals(this.nickname, getUserInfo.nickname)
                ...
                && Objects.equals(this.profile, getUserInfo.profile) && Objects.equals(this.sub, getUserInfo.sub)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(birthdate, email, emailVerified, familyName, gender, givenName, locale, middleName, name,
                nickname, phoneNumber, phoneNumberVerified, picture, preferredUsername, profile, sub, updatedAt,
                website, zoneinfo);
    }
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getBirthdate() != null) {
            try {
                joiner.add(String.format("%sbirthdate%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getBirthdate()), "UTF-8").replaceAll("\\+", "%20")));
        ...
        if (getEmail() != null) {
            try {
                joiner.add(String.format("%semail%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getEmail()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getEmailVerified() != null) {
            try {
                joiner.add(String.format("%semail_verified%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getEmailVerified()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getFamilyName() != null) {
            try {
                joiner.add(String.format("%sfamily_name%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getFamilyName()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getGivenName() != null) {
            try {
                joiner.add(String.format("%sgiven_name%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getGivenName()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getMiddleName() != null) {
            try {
                joiner.add(String.format("%smiddle_name%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getMiddleName()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getNickname() != null) {
            try {
                joiner.add(String.format("%snickname%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getNickname()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getPhoneNumber() != null) {
            try {
                joiner.add(String.format("%sphone_number%s=%s", prefix, suffix,
        ...
        if (getPhoneNumberVerified() != null) {
            try {
                joiner.add(String.format("%sphone_number_verified%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getPhoneNumberVerified()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getPicture() != null) {
            try {
                joiner.add(String.format("%spicture%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getPicture()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getPreferredUsername() != null) {
            try {
                joiner.add(String.format("%spreferred_username%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getPreferredUsername()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getProfile() != null) {
            try {
                joiner.add(String.format("%sprofile%s=%s", prefix, suffix,
        ...
        if (getSub() != null) {
            try {
                joiner.add(String.format("%ssub%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getSub()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getUpdatedAt() != null) {
            try {
                joiner.add(String.format("%supdated_at%s=%s", prefix, suffix,
        ...
        if (getWebsite() != null) {
            try {
                joiner.add(String.format("%swebsite%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getWebsite()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getZoneinfo() != null) {
            try {
                joiner.add(String.format("%szoneinfo%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getZoneinfo()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
