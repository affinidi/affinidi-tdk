 ...
 * IdTokenMappingItem
 */
@JsonPropertyOrder({ IdTokenMappingItem.JSON_PROPERTY_SOURCE_FIELD, IdTokenMappingItem.JSON_PROPERTY_ID_TOKEN_CLAIM,
...
public class IdTokenMappingItem {
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getSourceField() != null) {
            try {
                joiner.add(String.format("%ssourceField%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getSourceField()), "UTF-8").replaceAll("\\+", "%20")));
        ...
        if (getIdTokenClaim() != null) {
            try {
                joiner.add(String.format("%sidTokenClaim%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getIdTokenClaim()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getInputDescriptorId() != null) {
            try {
                joiner.add(String.format("%sinputDescriptorId%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getInputDescriptorId()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
