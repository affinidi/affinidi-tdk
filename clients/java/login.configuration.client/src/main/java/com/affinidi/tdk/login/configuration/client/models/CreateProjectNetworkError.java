 ...
 */
@JsonPropertyOrder({
  CreateProjectNetworkError.JSON_PROPERTY_NAME,
  CreateProjectNetworkError.JSON_PROPERTY_MESSAGE,
  CreateProjectNetworkError.JSON_PROPERTY_HTTP_STATUS_CODE,
  CreateProjectNetworkError.JSON_PROPERTY_TRACE_ID,
  CreateProjectNetworkError.JSON_PROPERTY_DETAILS
})
...
public class CreateProjectNetworkError {
  ...
  public CreateProjectNetworkError name(@javax.annotation.Nonnull NameEnum name) {
  ...
  public CreateProjectNetworkError message(@javax.annotation.Nonnull MessageEnum message) {
  ...
  public CreateProjectNetworkError httpStatusCode(@javax.annotation.Nonnull HttpStatusCodeEnum httpStatusCode) {
  ...
  public CreateProjectNetworkError traceId(@javax.annotation.Nonnull String traceId) {
  ...
  public CreateProjectNetworkError details(@javax.annotation.Nullable List<InvalidParameterErrorDetailsInner> details) {
