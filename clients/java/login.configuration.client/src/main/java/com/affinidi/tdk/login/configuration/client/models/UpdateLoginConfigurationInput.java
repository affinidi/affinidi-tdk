 ...
 */
@JsonPropertyOrder({ UpdateLoginConfigurationInput.JSON_PROPERTY_NAME,
...
public class UpdateLoginConfigurationInput {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name, redirectUris, postLogoutRedirectUris, clientSecret, vpDefinition,
                presentationDefinition, idTokenMapping, clientMetadata, tokenEndpointAuthMethod, failOnMappingConflict);
    }
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getClientSecret() != null) {
            try {
                joiner.add(String.format("%sclientSecret%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getClientSecret()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
