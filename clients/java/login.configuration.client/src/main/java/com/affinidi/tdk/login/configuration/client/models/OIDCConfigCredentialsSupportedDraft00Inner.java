 ...
 */
@JsonPropertyOrder({ OIDCConfigCredentialsSupportedDraft00Inner.JSON_PROPERTY_CRYPTOGRAPHIC_BINDING_METHODS_SUPPORTED,
...
public class OIDCConfigCredentialsSupportedDraft00Inner {
    ...
    public OIDCConfigCredentialsSupportedDraft00Inner cryptographicBindingMethodsSupported(
    ...
    public OIDCConfigCredentialsSupportedDraft00Inner addCryptographicBindingMethodsSupportedItem(
            String cryptographicBindingMethodsSupportedItem) {
    ...
    public OIDCConfigCredentialsSupportedDraft00Inner cryptographicSuitesSupported(
    ...
    public OIDCConfigCredentialsSupportedDraft00Inner addCryptographicSuitesSupportedItem(
            String cryptographicSuitesSupportedItem) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.cryptographicBindingMethodsSupported,
                oiDCConfigCredentialsSupportedDraft00Inner.cryptographicBindingMethodsSupported)
                && Objects.equals(this.cryptographicSuitesSupported,
                        oiDCConfigCredentialsSupportedDraft00Inner.cryptographicSuitesSupported)
    ...
    public String toString() {
        ...
        sb.append("    cryptographicBindingMethodsSupported: ")
                .append(toIndentedString(cryptographicBindingMethodsSupported)).append("\n");
        sb.append("    cryptographicSuitesSupported: ").append(toIndentedString(cryptographicSuitesSupported))
                .append("\n");
            ...
            for (int i = 0; i < getCryptographicBindingMethodsSupported().size(); i++) {
                try {
                    joiner.add(String.format("%scryptographic_binding_methods_supported%s%s=%s", prefix, suffix,
                            ...
                            URLEncoder.encode(String.valueOf(getCryptographicBindingMethodsSupported().get(i)), "UTF-8")
                                    .replaceAll("\\+", "%20")));
            ...
            for (int i = 0; i < getCryptographicSuitesSupported().size(); i++) {
                try {
                    joiner.add(String.format("%scryptographic_suites_supported%s%s=%s", prefix, suffix,
                            "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, i, containerSuffix),
                            URLEncoder.encode(String.valueOf(getCryptographicSuitesSupported().get(i)), "UTF-8")
                                    .replaceAll("\\+", "%20")));
                } catch (UnsupportedEncodingException e) {
                    // Should never happen, UTF-8 is always supported
                    throw new RuntimeException(e);
