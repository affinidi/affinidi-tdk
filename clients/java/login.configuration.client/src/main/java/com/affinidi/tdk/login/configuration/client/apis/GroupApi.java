...
public class GroupApi extends BaseApi {
     ...
     * @param groupName
     *            (required)
     * @param addUserToGroupInput
     *            AddUserToGroup (required)
     *
    ...
    public GroupUserMappingDto addUserToGroup(String groupName, AddUserToGroupInput addUserToGroupInput,
        ...
        if (addUserToGroupInput == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'addUserToGroupInput' when calling addUserToGroup");
        }

        // create path and map variables
        String localVarPath = "/v1/groups/{groupName}/users".replaceAll("\\{" + "groupName" + "\\}",
                apiClient.escapeString(apiClient.parameterToString(groupName)));
     ...
     *             if fails to make API call
     */
    public GroupDto createGroup(CreateGroupInput createGroupInput, Map<String, String> additionalHeaders)
            throws ApiException {
    ...
    public void deleteGroup(String groupName, Map<String, String> additionalHeaders) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v1/groups/{groupName}".replaceAll("\\{" + "groupName" + "\\}",
                apiClient.escapeString(apiClient.parameterToString(groupName)));
     ...
     * @param sortOrder
     *            sort response in specific order. By default it is in desc order (optional)
     *
     ...
     *             if fails to make API call
     */
    public GroupUserMappingsList listGroupUserMappings(String groupName, Integer limit, String exclusiveStartKey,
     ...
     */
    public GroupUserMappingsList listGroupUserMappings(String groupName, Integer limit, String exclusiveStartKey,
            String sortOrder, Map<String, String> additionalHeaders) throws ApiException {
        Object localVarPostBody = null;

        // verify the required parameter 'groupName' is set
        if (groupName == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'groupName' when calling listGroupUserMappings");
        }
     ...
     * @param groupName
     *            (required)
     * @param removeUserFromGroupInput
     *            Remove user from group (required)
     *
     * @throws ApiException
     *             if fails to make API call
     */
    ...
    public void removeUserFromGroup(String groupName, RemoveUserFromGroupInput removeUserFromGroupInput,
        ...
        if (removeUserFromGroupInput == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'removeUserFromGroupInput' when calling removeUserFromGroup");
        }
