 ...
 */
@JsonPropertyOrder({ LoginConfigurationObject.JSON_PROPERTY_ARI,
        LoginConfigurationObject.JSON_PROPERTY_CONFIGURATION_ID, LoginConfigurationObject.JSON_PROPERTY_PROJECT_ID,
        LoginConfigurationObject.JSON_PROPERTY_NAME, LoginConfigurationObject.JSON_PROPERTY_REDIRECT_URIS,
        LoginConfigurationObject.JSON_PROPERTY_POST_LOGOUT_REDIRECT_URIS, LoginConfigurationObject.JSON_PROPERTY_SCOPE,
        LoginConfigurationObject.JSON_PROPERTY_CLIENT_ID, LoginConfigurationObject.JSON_PROPERTY_CREATION_DATE,
        LoginConfigurationObject.JSON_PROPERTY_VP_DEFINITION,
        LoginConfigurationObject.JSON_PROPERTY_PRESENTATION_DEFINITION,
        LoginConfigurationObject.JSON_PROPERTY_ID_TOKEN_MAPPING, LoginConfigurationObject.JSON_PROPERTY_CLIENT_METADATA,
...
public class LoginConfigurationObject extends HashMap<String, Object> {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(ari, configurationId, projectId, name, redirectUris, postLogoutRedirectUris, scope,
                clientId, creationDate, vpDefinition, presentationDefinition, idTokenMapping, clientMetadata,
                tokenEndpointAuthMethod, super.hashCode());
    }
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getScope() != null) {
            try {
                joiner.add(String.format("%sscope%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getScope()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getIdTokenMapping() != null) {
            for (int i = 0; i < getIdTokenMapping().size(); i++) {
                if (getIdTokenMapping().get(i) != null) {
                    joiner.add(getIdTokenMapping().get(i).toUrlQueryString(String.format("%sidTokenMapping%s%s", prefix,
                            suffix,
                            "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, i, containerSuffix))));
                }
            }
        ...
        if (getTokenEndpointAuthMethod() != null) {
            try {
                joiner.add(String.format("%stokenEndpointAuthMethod%s=%s", prefix, suffix, URLEncoder
                        .encode(String.valueOf(getTokenEndpointAuthMethod()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
