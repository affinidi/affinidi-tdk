...
public class Example {
    public static void main(String[] args) {
        ...
        String subjectDID = "subjectDID_example"; // String |
        try {
            apiInstance.deleteAccessVfs(subjectDID);
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            UpdateAccessOutput result = apiInstance.updateAccessVfs(subjectDID, updateAccessInput);
            System.out.println(result);
        } catch (ApiException e) {
