 ...
 */
@JsonPropertyOrder({ ConsumerAuthTokenEndpointOutput.JSON_PROPERTY_ACCESS_TOKEN,
        ...
        ConsumerAuthTokenEndpointOutput.JSON_PROPERTY_SCOPE, ConsumerAuthTokenEndpointOutput.JSON_PROPERTY_TOKEN_TYPE })
...
public class ConsumerAuthTokenEndpointOutput {
    ...
    /**
     * The refresh token, which can be used to obtain new access tokens. To retrieve it add the scope
     * \&quot;offline\&quot; to your access token request.
     *
     * @return refreshToken
     */
    @javax.annotation.Nullable
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getAccessToken() != null) {
            try {
                joiner.add(String.format("%saccess_token%s=%s", prefix, suffix,
        ...
        if (getExpiresIn() != null) {
            try {
                joiner.add(String.format("%sexpires_in%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getExpiresIn()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getIdToken() != null) {
            try {
                joiner.add(String.format("%sid_token%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getIdToken()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getTokenType() != null) {
            try {
                joiner.add(String.format("%stoken_type%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getTokenType()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
