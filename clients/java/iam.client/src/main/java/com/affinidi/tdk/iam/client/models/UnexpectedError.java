...
public class UnexpectedError {
  ...
  public enum NameEnum {
    UNEXPECTED_ERROR(String.valueOf("UnexpectedError"));
  ...
  public enum MessageEnum {
    UNEXPECTED_ERROR_OCCURRED_(String.valueOf("Unexpected Error Occurred."));
  ...
  public UnexpectedError name(@javax.annotation.Nonnull NameEnum name) {
  ...
  public UnexpectedError message(@javax.annotation.Nonnull MessageEnum message) {
  ...
  public UnexpectedError httpStatusCode(@javax.annotation.Nonnull HttpStatusCodeEnum httpStatusCode) {
  ...
  public UnexpectedError traceId(@javax.annotation.Nonnull String traceId) {
  ...
  public UnexpectedError details(@javax.annotation.Nullable List<UnexpectedErrorDetailsInner> details) {
    
    this.details = details;
    return this;
  }

  public UnexpectedError addDetailsItem(UnexpectedErrorDetailsInner detailsItem) {
