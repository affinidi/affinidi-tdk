 ...
 */
@JsonPropertyOrder({
  InvalidParameterError.JSON_PROPERTY_NAME,
  InvalidParameterError.JSON_PROPERTY_MESSAGE,
  InvalidParameterError.JSON_PROPERTY_HTTP_STATUS_CODE,
...
public class InvalidParameterError {
  ...
  public InvalidParameterError details(@javax.annotation.Nullable List<UnexpectedErrorDetailsInner> details) {
    
    this.details = details;
    return this;
  }

  public InvalidParameterError addDetailsItem(UnexpectedErrorDetailsInner detailsItem) {
