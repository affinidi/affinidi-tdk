 ...
 * TokenDto
 */
@JsonPropertyOrder({ TokenDto.JSON_PROPERTY_ID, TokenDto.JSON_PROPERTY_ARI, TokenDto.JSON_PROPERTY_OWNER_ARI,
        TokenDto.JSON_PROPERTY_NAME, TokenDto.JSON_PROPERTY_AUTHENTICATION_METHOD, TokenDto.JSON_PROPERTY_SCOPES })
...
public class TokenDto {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, tokenDto.id) && Objects.equals(this.ari, tokenDto.ari)
                && Objects.equals(this.ownerAri, tokenDto.ownerAri) && Objects.equals(this.name, tokenDto.name)
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getOwnerAri() != null) {
            try {
                joiner.add(String.format("%sownerAri%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getOwnerAri()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
