...
- API version: 1.0.0
  - Build date: 2025-01-05T23:17:04.645187545Z[Etc/UTC]
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'iam.client' jar has been published to maven central.
    mavenLocal()       // Needed if the 'iam.client' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "com.affinidi.tdk:iam.client:1.0.0"
  }
```
