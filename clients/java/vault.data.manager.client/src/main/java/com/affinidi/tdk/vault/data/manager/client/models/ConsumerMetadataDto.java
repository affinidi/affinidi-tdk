 ...
 * ConsumerMetadataDto
 */
@JsonPropertyOrder({ ConsumerMetadataDto.JSON_PROPERTY_NODE_ID, ConsumerMetadataDto.JSON_PROPERTY_STATUS,
        ConsumerMetadataDto.JSON_PROPERTY_FILE_COUNT, ConsumerMetadataDto.JSON_PROPERTY_FOLDER_COUNT,
        ConsumerMetadataDto.JSON_PROPERTY_PROFILE_COUNT, ConsumerMetadataDto.JSON_PROPERTY_NAME,
        ConsumerMetadataDto.JSON_PROPERTY_CONSUMER_ID, ConsumerMetadataDto.JSON_PROPERTY_CREATED_AT,
        ConsumerMetadataDto.JSON_PROPERTY_MODIFIED_AT, ConsumerMetadataDto.JSON_PROPERTY_CREATED_BY,
        ConsumerMetadataDto.JSON_PROPERTY_MODIFIED_BY, ConsumerMetadataDto.JSON_PROPERTY_DESCRIPTION,
        ConsumerMetadataDto.JSON_PROPERTY_TYPE, ConsumerMetadataDto.JSON_PROPERTY_CONSUMED_FILE_STORAGE })
...
public class ConsumerMetadataDto {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(nodeId, status, fileCount, folderCount, profileCount, name, consumerId, createdAt,
                modifiedAt, createdBy, modifiedBy, description, type, consumedFileStorage);
    }
