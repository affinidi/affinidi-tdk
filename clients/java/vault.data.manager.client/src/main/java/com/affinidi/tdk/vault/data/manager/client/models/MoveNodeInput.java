 ...
 * MoveNodeInput
 */
@JsonPropertyOrder({ MoveNodeInput.JSON_PROPERTY_DESTINATION_NODE_ID,
...
public class MoveNodeInput {
    ...
    /**
     * automatically update the name of Node if target Node has children with the same name. If not provided, name
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.destinationNodeId, moveNodeInput.destinationNodeId) && Objects
                .equals(this.resolveNameConflictsAutomatically, moveNodeInput.resolveNameConflictsAutomatically);
    }
    ...
    public String toString() {
        ...
        sb.append("    resolveNameConflictsAutomatically: ").append(toIndentedString(resolveNameConflictsAutomatically))
                .append("\n");
        sb.append("}");
        return sb.toString();
    }
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getDestinationNodeId() != null) {
            try {
                joiner.add(String.format("%sdestinationNodeId%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getDestinationNodeId()), "UTF-8").replaceAll("\\+", "%20")));
        ...
        if (getResolveNameConflictsAutomatically() != null) {
            try {
                joiner.add(String.format("%sresolveNameConflictsAutomatically%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getResolveNameConflictsAutomatically()), "UTF-8")
                                .replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
