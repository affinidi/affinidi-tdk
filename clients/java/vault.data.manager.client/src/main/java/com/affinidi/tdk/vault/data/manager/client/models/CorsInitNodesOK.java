 ...
 * CorsInitNodesOK
 */
@JsonPropertyOrder({ CorsInitNodesOK.JSON_PROPERTY_CORS_INIT_NODES_OK })
...
public class CorsInitNodesOK {
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getCorsInitNodesOk() != null) {
            try {
                joiner.add(String.format("%scorsInitNodesOk%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getCorsInitNodesOk()), "UTF-8").replaceAll("\\+", "%20")));
