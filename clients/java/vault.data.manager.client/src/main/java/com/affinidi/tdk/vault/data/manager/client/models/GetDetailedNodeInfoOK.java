 ...
 */
@JsonPropertyOrder({ GetDetailedNodeInfoOK.JSON_PROPERTY_NODE_ID, GetDetailedNodeInfoOK.JSON_PROPERTY_STATUS,
        GetDetailedNodeInfoOK.JSON_PROPERTY_FILE_COUNT, GetDetailedNodeInfoOK.JSON_PROPERTY_PROFILE_COUNT,
        GetDetailedNodeInfoOK.JSON_PROPERTY_FOLDER_COUNT, GetDetailedNodeInfoOK.JSON_PROPERTY_VC_COUNT,
        GetDetailedNodeInfoOK.JSON_PROPERTY_NAME, GetDetailedNodeInfoOK.JSON_PROPERTY_CONSUMER_ID,
        GetDetailedNodeInfoOK.JSON_PROPERTY_PARENT_NODE_ID, GetDetailedNodeInfoOK.JSON_PROPERTY_PROFILE_ID,
        GetDetailedNodeInfoOK.JSON_PROPERTY_CREATED_AT, GetDetailedNodeInfoOK.JSON_PROPERTY_MODIFIED_AT,
        GetDetailedNodeInfoOK.JSON_PROPERTY_CREATED_BY, GetDetailedNodeInfoOK.JSON_PROPERTY_MODIFIED_BY,
        GetDetailedNodeInfoOK.JSON_PROPERTY_DESCRIPTION, GetDetailedNodeInfoOK.JSON_PROPERTY_TYPE,
        GetDetailedNodeInfoOK.JSON_PROPERTY_LINK, GetDetailedNodeInfoOK.JSON_PROPERTY_SCHEMA,
        GetDetailedNodeInfoOK.JSON_PROPERTY_CONSUMED_FILE_STORAGE, GetDetailedNodeInfoOK.JSON_PROPERTY_EDEK_INFO,
        GetDetailedNodeInfoOK.JSON_PROPERTY_METADATA, GetDetailedNodeInfoOK.JSON_PROPERTY_GET_URL })
...
public class GetDetailedNodeInfoOK {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(nodeId, status, fileCount, profileCount, folderCount, vcCount, name, consumerId,
                parentNodeId, profileId, createdAt, modifiedAt, createdBy, modifiedBy, description, type, link, schema,
                consumedFileStorage, edekInfo, metadata, getUrl);
    }
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getNodeId() != null) {
            try {
                joiner.add(String.format("%snodeId%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getNodeId()), "UTF-8").replaceAll("\\+", "%20")));
        ...
        if (getFileCount() != null) {
            try {
                joiner.add(String.format("%sfileCount%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getFileCount()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getProfileCount() != null) {
            try {
                joiner.add(String.format("%sprofileCount%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getProfileCount()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getFolderCount() != null) {
            try {
                joiner.add(String.format("%sfolderCount%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getFolderCount()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getVcCount() != null) {
            try {
                joiner.add(String.format("%svcCount%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getVcCount()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getConsumerId() != null) {
            try {
                joiner.add(String.format("%sconsumerId%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getConsumerId()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getParentNodeId() != null) {
            try {
                joiner.add(String.format("%sparentNodeId%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getParentNodeId()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getProfileId() != null) {
            try {
                joiner.add(String.format("%sprofileId%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getProfileId()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getLink() != null) {
            try {
                joiner.add(String.format("%slink%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getLink()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getSchema() != null) {
            try {
                joiner.add(String.format("%sschema%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getSchema()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getConsumedFileStorage() != null) {
            try {
                joiner.add(String.format("%sconsumedFileStorage%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getConsumedFileStorage()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getGetUrl() != null) {
            try {
                joiner.add(String.format("%sgetUrl%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getGetUrl()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
