 ...
 */
@JsonPropertyOrder({ GetScannedFileInfoOK.JSON_PROPERTY_DATA, GetScannedFileInfoOK.JSON_PROPERTY_JOB_ID,
        GetScannedFileInfoOK.JSON_PROPERTY_STATUS, GetScannedFileInfoOK.JSON_PROPERTY_PROFILE_ID,
        GetScannedFileInfoOK.JSON_PROPERTY_EXCLUSIVE_START_KEY, GetScannedFileInfoOK.JSON_PROPERTY_NODE_ID,
        GetScannedFileInfoOK.JSON_PROPERTY_CREATED_AT, GetScannedFileInfoOK.JSON_PROPERTY_NAME })
...
public class GetScannedFileInfoOK {
    ...
    /**
     * The base64url encoded key of the first item that this operation will evaluate (it is not returned). Use the value
     * that was returned in the previous operation.
     *
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getJobId() != null) {
            try {
                joiner.add(String.format("%sjobId%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getJobId()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getExclusiveStartKey() != null) {
            try {
                joiner.add(String.format("%sexclusiveStartKey%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getExclusiveStartKey()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
