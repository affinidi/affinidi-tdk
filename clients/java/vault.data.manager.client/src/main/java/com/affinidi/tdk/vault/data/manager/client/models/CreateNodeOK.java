 ...
 * CreateNodeOK
 */
@JsonPropertyOrder({ CreateNodeOK.JSON_PROPERTY_NODE_ID, CreateNodeOK.JSON_PROPERTY_URL,
        CreateNodeOK.JSON_PROPERTY_LINK, CreateNodeOK.JSON_PROPERTY_FIELDS })
...
public class CreateNodeOK {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.nodeId, createNodeOK.nodeId) && Objects.equals(this.url, createNodeOK.url)
                && Objects.equals(this.link, createNodeOK.link) && Objects.equals(this.fields, createNodeOK.fields);
    }
            ...
            for (String _key : getFields().keySet()) {
                try {
                    joiner.add(String.format("%sfields%s%s=%s", prefix, suffix,
                            ...
                            getFields().get(_key), URLEncoder.encode(String.valueOf(getFields().get(_key)), "UTF-8")
                                    .replaceAll("\\+", "%20")));
                } catch (UnsupportedEncodingException e) {
                    // Should never happen, UTF-8 is always supported
                    throw new RuntimeException(e);
