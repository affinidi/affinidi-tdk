 ...
 */
@JsonPropertyOrder({ CorsAwsCredentialExchangeOK.JSON_PROPERTY_CORS_AWS_CREDENTIAL_EXCHANGE_OK })
...
public class CorsAwsCredentialExchangeOK {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.corsAwsCredentialExchangeOk,
    ...
    public String toString() {
        ...
        sb.append("    corsAwsCredentialExchangeOk: ").append(toIndentedString(corsAwsCredentialExchangeOk))
                .append("\n");
        sb.append("}");
        return sb.toString();
    }
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getCorsAwsCredentialExchangeOk() != null) {
            try {
                joiner.add(String.format("%scorsAwsCredentialExchangeOk%s=%s", prefix, suffix, URLEncoder
                        .encode(String.valueOf(getCorsAwsCredentialExchangeOk()), "UTF-8").replaceAll("\\+", "%20")));
