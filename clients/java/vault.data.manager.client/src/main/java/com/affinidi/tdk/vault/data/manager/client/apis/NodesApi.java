...
public class NodesApi extends BaseApi {
     ...
     *             if fails to make API call
     */
    public CreateNodeOK createNode(CreateNodeInput createNodeInput, Map<String, String> additionalHeaders)
            throws ApiException {
    ...
    public DeleteNodeDto deleteNode(String nodeId, Map<String, String> additionalHeaders) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v1/nodes/{nodeId}".replaceAll("\\{" + "nodeId" + "\\}",
     ...
     *            (required)
     * @param dek
     *            A base64url encoded data encryption key, encrypted using VFS public key. getUrl will not be returned
     *            if dek is not provided (optional)
     *
     ...
     *             if fails to make API call
     */
    public GetDetailedNodeInfoOK getDetailedNodeInfo(String nodeId, String dek, Map<String, String> additionalHeaders)
            throws ApiException {
        Object localVarPostBody = null;
     ...
     *             if fails to make API call
     */
    public ListNodeChildrenOK listNodeChildren(String nodeId, Integer limit, String exclusiveStartKey)
            throws ApiException {
    ...
    public ListNodeChildrenOK listNodeChildren(String nodeId, Integer limit, String exclusiveStartKey,
        ...
        // create path and map variables
        String localVarPath = "/v1/nodes/{nodeId}/children".replaceAll("\\{" + "nodeId" + "\\}",
                apiClient.escapeString(apiClient.parameterToString(nodeId)));
     ...
     *             if fails to make API call
     */
    public MoveNodeDto moveNode(String nodeId, MoveNodeInput moveNodeInput, Map<String, String> additionalHeaders)
            throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v1/nodes/{nodeId}/move".replaceAll("\\{" + "nodeId" + "\\}",
                apiClient.escapeString(apiClient.parameterToString(nodeId)));
     ...
     *
     * @param nodeId
     *            nodeId of the TRASH_BIN (required)
     * @param nodeIdToRemove
     *            nodeId of the node to be deleted from TRASH_BIN (required)
     *
     * @throws ApiException
     *             if fails to make API call
     */
     ...
     *             if fails to make API call
     */
    public void permanentlyDeleteNode(String nodeId, String nodeIdToRemove, Map<String, String> additionalHeaders)
            throws ApiException {
        Object localVarPostBody = null;
        ...
        if (nodeIdToRemove == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'nodeIdToRemove' when calling permanentlyDeleteNode");
        }
        ...
        String localVarPath = "/v1/nodes/{nodeId}/remove/{nodeIdToRemove}"
                ...
                .replaceAll("\\{" + "nodeIdToRemove" + "\\}",
                        apiClient.escapeString(apiClient.parameterToString(nodeIdToRemove)));
     ...
     * @param nodeId
     *            nodeId of the TRASH_BIN (required)
     * @param nodeIdToRestore
     *            nodeId of the node to be restored from TRASH_BIN (required)
     * @param restoreNodeFromTrashbin
     *            RestoreNodeFromTrashbin (required)
     *
     * @return MoveNodeDto
     *
     * @throws ApiException
     *             if fails to make API call
     */
    public MoveNodeDto restoreNodeFromTrashbin(String nodeId, String nodeIdToRestore,
            RestoreNodeFromTrashbin restoreNodeFromTrashbin) throws ApiException {
     ...
     */
    public MoveNodeDto restoreNodeFromTrashbin(String nodeId, String nodeIdToRestore,
            RestoreNodeFromTrashbin restoreNodeFromTrashbin, Map<String, String> additionalHeaders)
            throws ApiException {
        ...
        if (nodeIdToRestore == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'nodeIdToRestore' when calling restoreNodeFromTrashbin");
        }

        // verify the required parameter 'restoreNodeFromTrashbin' is set
        if (restoreNodeFromTrashbin == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'restoreNodeFromTrashbin' when calling restoreNodeFromTrashbin");
        }

        // create path and map variables
        String localVarPath = "/v1/nodes/{nodeId}/restore/{nodeIdToRestore}"
                .replaceAll("\\{" + "nodeId" + "\\}", apiClient.escapeString(apiClient.parameterToString(nodeId)))
                .replaceAll("\\{" + "nodeIdToRestore" + "\\}",
                        apiClient.escapeString(apiClient.parameterToString(nodeIdToRestore)));
     ...
     * @param nodeId
     *            Description for nodeId. (required)
     * @param updateNodeInput
     *            UpdateNodeInput (required)
     *
     * @return NodeDto
     *
     * @throws ApiException
     ...
     *             if fails to make API call
     */
    public NodeDto updateNode(String nodeId, UpdateNodeInput updateNodeInput, Map<String, String> additionalHeaders)
            throws ApiException {
