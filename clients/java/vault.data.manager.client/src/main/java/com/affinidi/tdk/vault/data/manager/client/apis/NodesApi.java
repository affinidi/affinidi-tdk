...
public class NodesApi extends BaseApi {
   ...
   * @param grantAccessInput CreateNode (required)
   * @throws ApiException if fails to make API call
   */
  public void grantAccess(GrantAccessInput grantAccessInput) throws ApiException {
    this.grantAccess(grantAccessInput, Collections.emptyMap());
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public void grantAccess(GrantAccessInput grantAccessInput, Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = grantAccessInput;
    
    // verify the required parameter 'grantAccessInput' is set
    if (grantAccessInput == null) {
      throw new ApiException(400, "Missing the required parameter 'grantAccessInput' when calling grantAccess");
    }
    
    // create path and map variables
    String localVarPath = "/v1/nodes/grant-access";
