...
public class DefaultApi extends BaseApi {
    ...
    /**
     * Verifying VC Verifying Verifiable Credentials (signatures) &#x60;isValid&#x60; - true if all credentials verified
     * &#x60;errors&#x60; contains list of error messages for invalid credentials.
     *
     * @param verifyCredentialInput
     *            VerifyCredentials (required)
     *
    ...
    public VerifyCredentialOutput verifyCredentials(VerifyCredentialInput verifyCredentialInput,
        ...
        if (verifyCredentialInput == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'verifyCredentialInput' when calling verifyCredentials");
        }
    ...
    /**
     * Verifying VP Verifying Verifiable Presentation (signatures) &#x60;isValid&#x60; - true if presentation verified
     * &#x60;error&#x60; verificaction error.
     *
     * @param verifyPresentationInput
     *            VerifyPresentation (required)
     *
    ...
    public VerifyPresentationOutput verifyPresentation(VerifyPresentationInput verifyPresentationInput,
        ...
        if (verifyPresentationInput == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'verifyPresentationInput' when calling verifyPresentation");
        }
