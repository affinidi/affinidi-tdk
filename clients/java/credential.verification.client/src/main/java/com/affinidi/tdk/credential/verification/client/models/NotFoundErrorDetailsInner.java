 ...
 */
@JsonPropertyOrder({
  NotFoundErrorDetailsInner.JSON_PROPERTY_ISSUE,
  NotFoundErrorDetailsInner.JSON_PROPERTY_FIELD,
  NotFoundErrorDetailsInner.JSON_PROPERTY_VALUE,
...
public class NotFoundErrorDetailsInner {
  ...
  public NotFoundErrorDetailsInner issue(@javax.annotation.Nonnull String issue) {
  ...
  public NotFoundErrorDetailsInner field(@javax.annotation.Nullable String field) {
  ...
  public NotFoundErrorDetailsInner value(@javax.annotation.Nullable String value) {
  ...
  public NotFoundErrorDetailsInner location(@javax.annotation.Nullable String location) {
