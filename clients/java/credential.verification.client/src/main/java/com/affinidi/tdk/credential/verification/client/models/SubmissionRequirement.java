 ...
 */
@JsonPropertyOrder({ SubmissionRequirement.JSON_PROPERTY_NAME, SubmissionRequirement.JSON_PROPERTY_PURPOSE,
        SubmissionRequirement.JSON_PROPERTY_RULE, SubmissionRequirement.JSON_PROPERTY_COUNT,
        SubmissionRequirement.JSON_PROPERTY_MIN, SubmissionRequirement.JSON_PROPERTY_MAX,
        SubmissionRequirement.JSON_PROPERTY_FROM, SubmissionRequirement.JSON_PROPERTY_FROM_NESTED })
...
public class SubmissionRequirement {
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getRule() != null) {
            try {
                joiner.add(String.format("%srule%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getRule()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getCount() != null) {
            try {
                joiner.add(String.format("%scount%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getCount()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getMin() != null) {
            try {
                joiner.add(String.format("%smin%s=%s", prefix, suffix,
        ...
        if (getMax() != null) {
            try {
                joiner.add(String.format("%smax%s=%s", prefix, suffix,
        ...
        if (getFromNested() != null) {
            for (int i = 0; i < getFromNested().size(); i++) {
                if (getFromNested().get(i) != null) {
                    joiner.add(getFromNested().get(i).toUrlQueryString(String.format("%sfrom_nested%s%s", prefix,
                            suffix,
