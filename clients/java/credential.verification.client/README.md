...
- Build date: 2025-01-13T09:54:28.383763662Z[Etc/UTC]
...
```groovy
compile "com.affinidi.tdk:credential.verification.client:1.0.0"
```
...
import com.affinidi.tdk.credential.verification.client.*;
