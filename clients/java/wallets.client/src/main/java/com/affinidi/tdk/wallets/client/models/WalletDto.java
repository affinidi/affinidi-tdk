 ...
 * wallet dto
 */
@JsonPropertyOrder({ WalletDto.JSON_PROPERTY_ID, WalletDto.JSON_PROPERTY_DID, WalletDto.JSON_PROPERTY_NAME,
        WalletDto.JSON_PROPERTY_DESCRIPTION, WalletDto.JSON_PROPERTY_DID_DOCUMENT, WalletDto.JSON_PROPERTY_ARI,
        WalletDto.JSON_PROPERTY_KEYS, WalletDto.JSON_PROPERTY_CREATED_AT, WalletDto.JSON_PROPERTY_MODIFIED_AT })
...
public class WalletDto {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, walletDto.id) && Objects.equals(this.did, walletDto.did)
                && Objects.equals(this.name, walletDto.name) && Objects.equals(this.description, walletDto.description)
                && Objects.equals(this.didDocument, walletDto.didDocument) && Objects.equals(this.ari, walletDto.ari)
                && Objects.equals(this.keys, walletDto.keys) && Objects.equals(this.createdAt, walletDto.createdAt)
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getDid() != null) {
            try {
                joiner.add(String.format("%sdid%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getDid()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getDidDocument() != null) {
            try {
                joiner.add(String.format("%sdidDocument%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getDidDocument()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
