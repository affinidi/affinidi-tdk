...
public class ListWalletKeysOK {
  ...
  private List<WalletKeyDto> keys = new ArrayList<>();

  public ListWalletKeysOK() {
  }

  public ListWalletKeysOK keys(@javax.annotation.Nonnull List<WalletKeyDto> keys) {
    
    this.keys = keys;
    return this;
  }

  public ListWalletKeysOK addKeysItem(WalletKeyDto keysItem) {
    if (this.keys == null) {
  ...
  public boolean equals(Object o) {
    ...
    ListWalletKeysOK listWalletKeysOK = (ListWalletKeysOK) o;
    return Objects.equals(this.keys, listWalletKeysOK.keys);
  }
