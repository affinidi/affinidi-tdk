 ...
 */
@JsonPropertyOrder({
  SigningFailedError.JSON_PROPERTY_NAME,
  SigningFailedError.JSON_PROPERTY_MESSAGE,
  SigningFailedError.JSON_PROPERTY_HTTP_STATUS_CODE,
  SigningFailedError.JSON_PROPERTY_TRACE_ID,
  SigningFailedError.JSON_PROPERTY_DETAILS
})
...
public class SigningFailedError {
  ...
  public SigningFailedError name(@javax.annotation.Nonnull NameEnum name) {
  ...
  public SigningFailedError message(@javax.annotation.Nonnull MessageEnum message) {
  ...
  public SigningFailedError httpStatusCode(@javax.annotation.Nonnull HttpStatusCodeEnum httpStatusCode) {
  ...
  public SigningFailedError traceId(@javax.annotation.Nonnull String traceId) {
  ...
  public SigningFailedError details(@javax.annotation.Nullable List<ServiceErrorResponseDetailsInner> details) {
