 ...
 * SignJwtTokenOK
 */
@JsonPropertyOrder({ SignJwtTokenOK.JSON_PROPERTY_SIGNED_JWT })
...
public class SignJwtTokenOK {
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getSignedJwt() != null) {
            try {
                joiner.add(String.format("%ssignedJwt%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getSignedJwt()), "UTF-8").replaceAll("\\+", "%20")));
