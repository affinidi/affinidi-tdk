 ...
 */
@JsonPropertyOrder({ DidWebInputParams.JSON_PROPERTY_NAME, DidWebInputParams.JSON_PROPERTY_DESCRIPTION,
        DidWebInputParams.JSON_PROPERTY_DID_METHOD, DidWebInputParams.JSON_PROPERTY_DID_WEB_URL })
...
public class DidWebInputParams {
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getDidMethod() != null) {
            try {
                joiner.add(String.format("%sdidMethod%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getDidMethod()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getDidWebUrl() != null) {
            try {
                joiner.add(String.format("%sdidWebUrl%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getDidWebUrl()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
