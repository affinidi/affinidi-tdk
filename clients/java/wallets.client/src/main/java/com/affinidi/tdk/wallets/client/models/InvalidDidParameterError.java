 ...
 */
@JsonPropertyOrder({
  InvalidDidParameterError.JSON_PROPERTY_NAME,
  InvalidDidParameterError.JSON_PROPERTY_MESSAGE,
  InvalidDidParameterError.JSON_PROPERTY_HTTP_STATUS_CODE,
  InvalidDidParameterError.JSON_PROPERTY_TRACE_ID,
  InvalidDidParameterError.JSON_PROPERTY_DETAILS
})
...
public class InvalidDidParameterError {
  ...
  public enum NameEnum {
    INVALID_DID_PARAMETER_ERROR(String.valueOf("InvalidDidParameterError"));
  ...
  public enum MessageEnum {
    GIVEN_DID_IN_FIELD_TO_DID_IS_INVALID_USE_ONLY_RESOLVABLE_FORM_OF_DID_(String.valueOf("Given did in field toDid is invalid. Use only resolvable form of did."));
  ...
  public InvalidDidParameterError name(@javax.annotation.Nonnull NameEnum name) {
  ...
  public InvalidDidParameterError message(@javax.annotation.Nonnull MessageEnum message) {
  ...
  public InvalidDidParameterError httpStatusCode(@javax.annotation.Nonnull HttpStatusCodeEnum httpStatusCode) {
  ...
  public InvalidDidParameterError traceId(@javax.annotation.Nonnull String traceId) {
  ...
  public InvalidDidParameterError details(@javax.annotation.Nullable List<ServiceErrorResponseDetailsInner> details) {
