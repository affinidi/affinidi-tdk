...
public class InvalidParameterError {
  ...
  public enum MessageEnum {
    INVALID_PARAMETER(String.valueOf("Invalid parameter"));
  ...
  public InvalidParameterError details(@javax.annotation.Nullable List<InvalidJwtTokenErrorDetailsInner> details) {
    
    this.details = details;
    return this;
  }

  public InvalidParameterError addDetailsItem(InvalidJwtTokenErrorDetailsInner detailsItem) {
