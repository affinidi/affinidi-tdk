...
package com.affinidi.tdk.consumer.iam.client;
...
import com.affinidi.tdk.consumer.iam.client.auth.Authentication;
import com.affinidi.tdk.consumer.iam.client.auth.ApiKeyAuth;

@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class ApiClient extends JavaTimeFormatter {
  private Map<String, String> defaultHeaderMap = new HashMap<String, String>();
  private Map<String, String> defaultCookieMap = new HashMap<String, String>();
  private String basePath = "https://apse1.api.affinidi.io/cid";
  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://apse1.api.affinidi.io/cid",
