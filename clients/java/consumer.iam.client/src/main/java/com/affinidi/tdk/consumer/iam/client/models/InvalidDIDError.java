...
public class InvalidDIDError {
  ...
  public enum MessageEnum {
    UNABLE_TO_RESOLVE_DID_METHOD(String.valueOf("Unable to resolve DID method"));
  ...
  public InvalidDIDError details(@javax.annotation.Nullable List<InvalidJwtTokenErrorDetailsInner> details) {
    
    this.details = details;
    return this;
  }

  public InvalidDIDError addDetailsItem(InvalidJwtTokenErrorDetailsInner detailsItem) {
