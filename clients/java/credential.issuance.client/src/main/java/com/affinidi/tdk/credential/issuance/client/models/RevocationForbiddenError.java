 ...
 */
@JsonPropertyOrder({
  RevocationForbiddenError.JSON_PROPERTY_NAME,
  RevocationForbiddenError.JSON_PROPERTY_MESSAGE,
  RevocationForbiddenError.JSON_PROPERTY_HTTP_STATUS_CODE,
  RevocationForbiddenError.JSON_PROPERTY_TRACE_ID,
  RevocationForbiddenError.JSON_PROPERTY_DETAILS
})
...
public class RevocationForbiddenError {
  ...
  public enum NameEnum {
    REVOCATION_FORBIDDEN_ERROR(String.valueOf("RevocationForbiddenError"));
  ...
  public enum MessageEnum {
    RELATED_VC_HAS_NOT_BEEN_CLAIMED_YET(String.valueOf("Related VC has not been claimed yet"));
  ...
  public RevocationForbiddenError name(@javax.annotation.Nonnull NameEnum name) {
  ...
  public RevocationForbiddenError message(@javax.annotation.Nonnull MessageEnum message) {
  ...
  public RevocationForbiddenError httpStatusCode(@javax.annotation.Nonnull HttpStatusCodeEnum httpStatusCode) {
  ...
  public RevocationForbiddenError traceId(@javax.annotation.Nonnull String traceId) {
  ...
  public RevocationForbiddenError details(@javax.annotation.Nullable List<ActionForbiddenErrorDetailsInner> details) {
