...
public class ConfigurationApi extends BaseApi {
     ...
     *
     * @param createIssuanceConfigInput
     *            Request body of create configuration (required)
     *
    ...
    public IssuanceConfigDto createIssuanceConfig(CreateIssuanceConfigInput createIssuanceConfigInput,
        ...
        if (createIssuanceConfigInput == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'createIssuanceConfigInput' when calling createIssuanceConfig");
        }
     ...
     *             if fails to make API call
     */
    public void deleteIssuanceConfigById(String configurationId, Map<String, String> additionalHeaders)
            throws ApiException {
        ...
        if (configurationId == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'configurationId' when calling deleteIssuanceConfigById");
        }
     ...
     *             if fails to make API call
     */
    public IssuanceConfigDto getIssuanceConfigById(String configurationId, Map<String, String> additionalHeaders)
            throws ApiException {
        Object localVarPostBody = null;
        ...
        if (configurationId == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'configurationId' when calling getIssuanceConfigById");
        }
     ...
     *            Request body of update configuration (required)
     *
     * @return IssuanceConfigDto
     *
     * @throws ApiException
     *             if fails to make API call
     */
    public IssuanceConfigDto updateIssuanceConfigById(String configurationId,
            UpdateIssuanceConfigInput updateIssuanceConfigInput) throws ApiException {
     ...
     */
    public IssuanceConfigDto updateIssuanceConfigById(String configurationId,
            UpdateIssuanceConfigInput updateIssuanceConfigInput, Map<String, String> additionalHeaders)
            throws ApiException {
        ...
        if (configurationId == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'configurationId' when calling updateIssuanceConfigById");
        }

        // verify the required parameter 'updateIssuanceConfigInput' is set
        if (updateIssuanceConfigInput == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'updateIssuanceConfigInput' when calling updateIssuanceConfigById");
        }
