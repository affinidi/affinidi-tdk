...
public class CorsGetWellKnownOpenIdCredentialIssuerOK {
    ...
    public CorsGetWellKnownOpenIdCredentialIssuerOK corsGetWellKnownOpenIdCredentialIssuerOk(
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.corsGetWellKnownOpenIdCredentialIssuerOk,
                corsGetWellKnownOpenIdCredentialIssuerOK.corsGetWellKnownOpenIdCredentialIssuerOk);
    }
    ...
    public String toString() {
        ...
        sb.append("    corsGetWellKnownOpenIdCredentialIssuerOk: ")
                .append(toIndentedString(corsGetWellKnownOpenIdCredentialIssuerOk)).append("\n");
        sb.append("}");
        return sb.toString();
    }
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getCorsGetWellKnownOpenIdCredentialIssuerOk() != null) {
            try {
                joiner.add(String.format("%scorsGetWellKnownOpenIdCredentialIssuerOk%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getCorsGetWellKnownOpenIdCredentialIssuerOk()), "UTF-8")
                                .replaceAll("\\+", "%20")));
