 ...
 */
@JsonPropertyOrder({
  ProjectCredentialConfigNotExistError.JSON_PROPERTY_NAME,
  ProjectCredentialConfigNotExistError.JSON_PROPERTY_MESSAGE,
  ProjectCredentialConfigNotExistError.JSON_PROPERTY_HTTP_STATUS_CODE,
...
public class ProjectCredentialConfigNotExistError {
  ...
  public enum NameEnum {
    PROJECT_CREDENTIAL_CONFIG_NOT_EXIST_ERROR(String.valueOf("ProjectCredentialConfigNotExistError"));
  ...
  public enum MessageEnum {
    CREDENTIAL_CONFIG_IS_NOT_AVAILABLE_FOR_THE_PROJECT(String.valueOf("Credential config is not available for the project"));
  ...
  public ProjectCredentialConfigNotExistError name(@javax.annotation.Nonnull NameEnum name) {
  ...
  public ProjectCredentialConfigNotExistError message(@javax.annotation.Nonnull MessageEnum message) {
  ...
  public ProjectCredentialConfigNotExistError httpStatusCode(@javax.annotation.Nonnull HttpStatusCodeEnum httpStatusCode) {
  ...
  public ProjectCredentialConfigNotExistError traceId(@javax.annotation.Nonnull String traceId) {
  ...
  public ProjectCredentialConfigNotExistError details(@javax.annotation.Nullable List<ActionForbiddenErrorDetailsInner> details) {
