...
public class CredentialOfferResponseGrantsUrnIetfParamsOauthGrantTypePreAuthorizedCode {
    ...
    public CredentialOfferResponseGrantsUrnIetfParamsOauthGrantTypePreAuthorizedCode preAuthorizedCode(
    ...
    public CredentialOfferResponseGrantsUrnIetfParamsOauthGrantTypePreAuthorizedCode txCode(
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.preAuthorizedCode,
                credentialOfferResponseGrantsUrnIetfParamsOauthGrantTypePreAuthorizedCode.preAuthorizedCode)
                && Objects.equals(this.txCode,
                        credentialOfferResponseGrantsUrnIetfParamsOauthGrantTypePreAuthorizedCode.txCode);
    }
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getPreAuthorizedCode() != null) {
            try {
                joiner.add(String.format("%spre-authorized_code%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getPreAuthorizedCode()), "UTF-8").replaceAll("\\+", "%20")));
