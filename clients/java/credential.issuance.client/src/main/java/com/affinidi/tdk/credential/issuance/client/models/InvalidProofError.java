 ...
 */
@JsonPropertyOrder({
  InvalidProofError.JSON_PROPERTY_NAME,
  InvalidProofError.JSON_PROPERTY_MESSAGE,
  InvalidProofError.JSON_PROPERTY_HTTP_STATUS_CODE,
  InvalidProofError.JSON_PROPERTY_TRACE_ID,
  InvalidProofError.JSON_PROPERTY_DETAILS
})
...
public class InvalidProofError {
  ...
  public InvalidProofError name(@javax.annotation.Nonnull NameEnum name) {
  ...
  public InvalidProofError message(@javax.annotation.Nonnull MessageEnum message) {
  ...
  public InvalidProofError httpStatusCode(@javax.annotation.Nonnull HttpStatusCodeEnum httpStatusCode) {
  ...
  public InvalidProofError traceId(@javax.annotation.Nonnull String traceId) {
  ...
  public InvalidProofError details(@javax.annotation.Nullable List<ActionForbiddenErrorDetailsInner> details) {
