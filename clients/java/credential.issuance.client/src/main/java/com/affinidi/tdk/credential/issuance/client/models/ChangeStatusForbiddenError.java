 ...
 */
@JsonPropertyOrder({
  ChangeStatusForbiddenError.JSON_PROPERTY_NAME,
  ChangeStatusForbiddenError.JSON_PROPERTY_MESSAGE,
  ChangeStatusForbiddenError.JSON_PROPERTY_HTTP_STATUS_CODE,
  ChangeStatusForbiddenError.JSON_PROPERTY_TRACE_ID,
  ChangeStatusForbiddenError.JSON_PROPERTY_DETAILS
})
...
public class ChangeStatusForbiddenError {
  ...
  public ChangeStatusForbiddenError name(@javax.annotation.Nonnull NameEnum name) {
  ...
  public ChangeStatusForbiddenError message(@javax.annotation.Nonnull MessageEnum message) {
  ...
  public ChangeStatusForbiddenError httpStatusCode(@javax.annotation.Nonnull HttpStatusCodeEnum httpStatusCode) {
  ...
  public ChangeStatusForbiddenError traceId(@javax.annotation.Nonnull String traceId) {
  ...
  public ChangeStatusForbiddenError details(@javax.annotation.Nullable List<ActionForbiddenErrorDetailsInner> details) {
