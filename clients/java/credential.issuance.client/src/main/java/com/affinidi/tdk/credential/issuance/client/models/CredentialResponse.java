 ...
 * CredentialResponse
 */
@JsonPropertyOrder({ CredentialResponse.JSON_PROPERTY_CREDENTIAL, CredentialResponse.JSON_PROPERTY_C_NONCE,
        CredentialResponse.JSON_PROPERTY_C_NONCE_EXPIRES_IN, CredentialResponse.JSON_PROPERTY_TRANSACTION_ID })
...
public class CredentialResponse {
    ...
    /**
     * String identifying a Deferred Issuance transaction. This claim is contained in the response if the Credential
     * Issuer was unable to immediately issue the Credential.
     *
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getcNonceExpiresIn() != null) {
            try {
                joiner.add(String.format("%sc_nonce_expires_in%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getcNonceExpiresIn()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getTransactionId() != null) {
            try {
                joiner.add(String.format("%stransaction_id%s=%s", prefix, suffix,
