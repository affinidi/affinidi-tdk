 ...
 */
@JsonPropertyOrder({ SupportedCredentialMetadataDisplayInnerLogo.JSON_PROPERTY_URL,
...
public class SupportedCredentialMetadataDisplayInnerLogo extends HashMap<String, Object> {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.url, supportedCredentialMetadataDisplayInnerLogo.url)
                && Objects.equals(this.altText, supportedCredentialMetadataDisplayInnerLogo.altText) && super.equals(o);
    }
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getAltText() != null) {
            try {
                joiner.add(String.format("%saltText%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getAltText()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
