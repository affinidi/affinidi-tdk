 ...
 */
@JsonPropertyOrder({
  ProjectCredentialConfigExistError.JSON_PROPERTY_NAME,
...
public class ProjectCredentialConfigExistError {
  ...
  public enum NameEnum {
    PROJECT_CREDENTIAL_CONFIG_EXIST_ERROR(String.valueOf("ProjectCredentialConfigExistError"));
  ...
  public enum MessageEnum {
    CREDENTIAL_CONFIGURATION_ALREADY_EXISTS_FOR_THIS_PROJECT_AND_ONLY_ONE_CONFIGURATION_IS_ALLOWED_PER_PROJECT(String.valueOf("Credential configuration already exists for this project and only one configuration is allowed per project"));
  ...
  public ProjectCredentialConfigExistError name(@javax.annotation.Nonnull NameEnum name) {
  ...
  public ProjectCredentialConfigExistError message(@javax.annotation.Nonnull MessageEnum message) {
  ...
  public ProjectCredentialConfigExistError httpStatusCode(@javax.annotation.Nonnull HttpStatusCodeEnum httpStatusCode) {
  ...
  public ProjectCredentialConfigExistError traceId(@javax.annotation.Nonnull String traceId) {
  ...
  public ProjectCredentialConfigExistError details(@javax.annotation.Nullable List<ActionForbiddenErrorDetailsInner> details) {
