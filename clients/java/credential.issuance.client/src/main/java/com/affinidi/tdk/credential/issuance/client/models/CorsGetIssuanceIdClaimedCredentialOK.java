...
public class CorsGetIssuanceIdClaimedCredentialOK {
  ...
  /**
   * Get corsGetIssuanceIdClaimedCredentialOk
  ...
  public String getCorsGetIssuanceIdClaimedCredentialOk() {
    return corsGetIssuanceIdClaimedCredentialOk;
  }
  ...
  public boolean equals(Object o) {
    ...
    CorsGetIssuanceIdClaimedCredentialOK corsGetIssuanceIdClaimedCredentialOK = (CorsGetIssuanceIdClaimedCredentialOK) o;
    return Objects.equals(this.corsGetIssuanceIdClaimedCredentialOk, corsGetIssuanceIdClaimedCredentialOK.corsGetIssuanceIdClaimedCredentialOk);
  }

  @Override
  public int hashCode() {
    return Objects.hash(corsGetIssuanceIdClaimedCredentialOk);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CorsGetIssuanceIdClaimedCredentialOK {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `corsGetIssuanceIdClaimedCredentialOk` to the URL query string
    if (getCorsGetIssuanceIdClaimedCredentialOk() != null) {
      try {
        joiner.add(String.format("%scorsGetIssuanceIdClaimedCredentialOk%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getCorsGetIssuanceIdClaimedCredentialOk()), "UTF-8").replaceAll("\\+", "%20")));
