...
public class CredentialsApi extends BaseApi {
     ...
     * @param createCredentialInput
     *            Request body to issue credentials (required)
     *
    ...
    public CredentialResponse generateCredentials(String projectId, CreateCredentialInput createCredentialInput,
        ...
        if (createCredentialInput == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'createCredentialInput' when calling generateCredentials");
        }

        // create path and map variables
        String localVarPath = "/v1/{projectId}/credential".replaceAll("\\{" + "projectId" + "\\}",
