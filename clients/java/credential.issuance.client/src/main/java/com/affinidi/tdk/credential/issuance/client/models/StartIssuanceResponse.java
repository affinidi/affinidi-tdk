 ...
 */
@JsonPropertyOrder({ StartIssuanceResponse.JSON_PROPERTY_CREDENTIAL_OFFER_URI,
        StartIssuanceResponse.JSON_PROPERTY_TX_CODE, StartIssuanceResponse.JSON_PROPERTY_ISSUANCE_ID,
...
public class StartIssuanceResponse {
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getCredentialOfferUri() != null) {
            try {
                joiner.add(String.format("%scredentialOfferUri%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getCredentialOfferUri()), "UTF-8").replaceAll("\\+", "%20")));
        ...
        if (getTxCode() != null) {
            try {
                joiner.add(String.format("%stxCode%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getTxCode()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getExpiresIn() != null) {
            try {
                joiner.add(String.format("%sexpiresIn%s=%s", prefix, suffix,
