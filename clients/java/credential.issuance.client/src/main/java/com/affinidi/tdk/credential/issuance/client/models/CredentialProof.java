 ...
 */
@JsonPropertyOrder({ CredentialProof.JSON_PROPERTY_PROOF_TYPE, CredentialProof.JSON_PROPERTY_JWT })
...
public class CredentialProof {
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getProofType() != null) {
            try {
                joiner.add(String.format("%sproof_type%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getProofType()), "UTF-8").replaceAll("\\+", "%20")));
