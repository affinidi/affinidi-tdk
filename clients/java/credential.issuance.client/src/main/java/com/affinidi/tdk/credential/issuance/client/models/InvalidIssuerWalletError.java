 ...
 */
@JsonPropertyOrder({
  InvalidIssuerWalletError.JSON_PROPERTY_NAME,
  InvalidIssuerWalletError.JSON_PROPERTY_MESSAGE,
  InvalidIssuerWalletError.JSON_PROPERTY_HTTP_STATUS_CODE,
  InvalidIssuerWalletError.JSON_PROPERTY_TRACE_ID,
  InvalidIssuerWalletError.JSON_PROPERTY_DETAILS
})
...
public class InvalidIssuerWalletError {
  ...
  public InvalidIssuerWalletError name(@javax.annotation.Nonnull NameEnum name) {
  ...
  public InvalidIssuerWalletError message(@javax.annotation.Nonnull MessageEnum message) {
  ...
  public InvalidIssuerWalletError httpStatusCode(@javax.annotation.Nonnull HttpStatusCodeEnum httpStatusCode) {
  ...
  public InvalidIssuerWalletError traceId(@javax.annotation.Nonnull String traceId) {
  ...
  public InvalidIssuerWalletError details(@javax.annotation.Nullable List<ActionForbiddenErrorDetailsInner> details) {
