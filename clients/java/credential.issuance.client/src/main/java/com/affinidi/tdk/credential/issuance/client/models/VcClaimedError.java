 ...
 */
@JsonPropertyOrder({
  VcClaimedError.JSON_PROPERTY_NAME,
  VcClaimedError.JSON_PROPERTY_MESSAGE,
  VcClaimedError.JSON_PROPERTY_HTTP_STATUS_CODE,
  VcClaimedError.JSON_PROPERTY_TRACE_ID,
  VcClaimedError.JSON_PROPERTY_DETAILS
})
...
public class VcClaimedError {
  ...
  public VcClaimedError name(@javax.annotation.Nonnull NameEnum name) {
  ...
  public VcClaimedError message(@javax.annotation.Nonnull MessageEnum message) {
  ...
  public VcClaimedError httpStatusCode(@javax.annotation.Nonnull HttpStatusCodeEnum httpStatusCode) {
  ...
  public VcClaimedError traceId(@javax.annotation.Nonnull String traceId) {
  ...
  public VcClaimedError details(@javax.annotation.Nullable List<ActionForbiddenErrorDetailsInner> details) {
