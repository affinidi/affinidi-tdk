 ...
 */
@JsonPropertyOrder({ SupportedCredentialMetadata.JSON_PROPERTY_DISPLAY })
...
public class SupportedCredentialMetadata extends HashMap<String, Object> {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.display, supportedCredentialMetadata.display) && super.equals(o);
    }
                ...
                if (getDisplay().get(i) != null) {
                    try {
                        joiner.add(String.format("%sdisplay%s%s=%s", prefix, suffix,
                                ...
                                URLEncoder.encode(String.valueOf(getDisplay().get(i)), "UTF-8").replaceAll("\\+",
                                        "%20")));
