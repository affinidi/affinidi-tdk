 ...
 */
@JsonPropertyOrder({ WellKnownOpenIdCredentialIssuerResponse.JSON_PROPERTY_AUTHORIZATION_ENDPOINT,
...
public class WellKnownOpenIdCredentialIssuerResponse extends HashMap<String, Object> {
    ...
    public WellKnownOpenIdCredentialIssuerResponse credentialsSupported(
    ...
    public WellKnownOpenIdCredentialIssuerResponse addCredentialsSupportedItem(
            WellKnownOpenIdCredentialIssuerResponseCredentialsSupportedInner credentialsSupportedItem) {
    ...
    @JsonProperty(JSON_PROPERTY_CREDENTIALS_SUPPORTED)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setCredentialsSupported(
            List<WellKnownOpenIdCredentialIssuerResponseCredentialsSupportedInner> credentialsSupported) {
        this.credentialsSupported = credentialsSupported;
    }
    ...
    public WellKnownOpenIdCredentialIssuerResponse grantTypesSupported(
            List<GrantTypesSupportedEnum> grantTypesSupported) {

        this.grantTypesSupported = grantTypesSupported;
        return this;
    }

    public WellKnownOpenIdCredentialIssuerResponse addGrantTypesSupportedItem(
            GrantTypesSupportedEnum grantTypesSupportedItem) {
    ...
    public WellKnownOpenIdCredentialIssuerResponse tokenEndpointAuthMethodsSupported(
            List<TokenEndpointAuthMethodsSupportedEnum> tokenEndpointAuthMethodsSupported) {

        this.tokenEndpointAuthMethodsSupported = tokenEndpointAuthMethodsSupported;
        return this;
    }

    public WellKnownOpenIdCredentialIssuerResponse addTokenEndpointAuthMethodsSupportedItem(
            TokenEndpointAuthMethodsSupportedEnum tokenEndpointAuthMethodsSupportedItem) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.authorizationEndpoint, wellKnownOpenIdCredentialIssuerResponse.authorizationEndpoint)
                ...
                && Objects.equals(this.credentialsSupported,
                        wellKnownOpenIdCredentialIssuerResponse.credentialsSupported)
                && Objects.equals(this.deferredCredentialEndpoint,
                        wellKnownOpenIdCredentialIssuerResponse.deferredCredentialEndpoint)
                ...
                && Objects.equals(this.tokenEndpointAuthMethodsSupported,
                        wellKnownOpenIdCredentialIssuerResponse.tokenEndpointAuthMethodsSupported)
                && super.equals(o);
    }

    @Override
    public int hashCode() {
        return Objects.hash(authorizationEndpoint, credentialEndpoint, credentialIssuer, credentialsSupported,
                deferredCredentialEndpoint, grantTypesSupported, jwksUri, scopesSupported, tokenEndpoint,
                tokenEndpointAuthMethodsSupported, super.hashCode());
    }
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getCredentialEndpoint() != null) {
            try {
                joiner.add(String.format("%scredential_endpoint%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getCredentialEndpoint()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
        ...
        if (getCredentialsSupported() != null) {
            for (int i = 0; i < getCredentialsSupported().size(); i++) {
                if (getCredentialsSupported().get(i) != null) {
                    joiner.add(getCredentialsSupported().get(i).toUrlQueryString(String.format(
                            "%scredentials_supported%s%s", prefix, suffix,
        ...
        if (getDeferredCredentialEndpoint() != null) {
            try {
                joiner.add(String.format("%sdeferred_credential_endpoint%s=%s", prefix, suffix, URLEncoder
                        .encode(String.valueOf(getDeferredCredentialEndpoint()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
