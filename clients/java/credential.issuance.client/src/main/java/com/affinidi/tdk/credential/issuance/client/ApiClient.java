...
import com.affinidi.tdk.credential.issuance.client.auth.Authentication;
import com.affinidi.tdk.credential.issuance.client.auth.HttpBasicAuth;
import com.affinidi.tdk.credential.issuance.client.auth.HttpBearerAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://apse1.api.affinidi.io/cis";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://apse1.api.affinidi.io/cis",
    ...
    public ApiClient() {
        ...
        authentications.put("AwsSigV4", new ApiKeyAuth("header", "Authorization"));
        authentications.put("ApiKey", new ApiKeyAuth("header", "x-api-key"));
        authentications.put("bearerAuth", new HttpBearerAuth("bearer"));
        authentications.put("ConsumerTokenAuth", new ApiKeyAuth("header", "authorization"));
        authentications.put("UserTokenAuth", new ApiKeyAuth("header", "authorization"));
        authentications.put("ProjectTokenAuth", new ApiKeyAuth("header", "authorization"));
        authentications.put("HeritageTokenAuth", new ApiKeyAuth("header", "authorization"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://apse1.api.affinidi.io/cis
     ...
     * @return a {@link com.affinidi.tdk.credential.issuance.client.ApiClient} object
     */
    ...
    */
     ...
     * @throws com.affinidi.tdk.credential.issuance.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.affinidi.tdk.credential.issuance.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.affinidi.tdk.credential.issuance.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.affinidi.tdk.credential.issuance.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.affinidi.tdk.credential.issuance.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.affinidi.tdk.credential.issuance.client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.affinidi.tdk.credential.issuance.client.ApiException If fails to update the parameters
     */
     ...
     * @throws com.affinidi.tdk.credential.issuance.client.ApiException If fail to serialize the request body object into a string
     */
