...
public class ApiClient extends JavaTimeFormatter {
    ...
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(
            Arrays.asList(new ServerConfiguration("https://apse1.api.affinidi.io/cis", "No description provided",
    ...
    /**
     * Custom helper to set auth token hook for further authentication.
     *
     * @param authTokenHook
     */
    public void setAuthTokenHook(Supplier<String> authTokenHook) {
        for (Authentication auth : authentications.values()) {
            if (auth instanceof ApiKeyAuth) {
                ((ApiKeyAuth) auth).setApiKeySupplier(authTokenHook);
            }
        }
    }
    ...
    public HttpEntity serialize(Object obj, Map<String, Object> formParams, ContentType contentType)
        ...
        if (isJsonMime(mimeType)) {
            try {
                return new StringEntity(objectMapper.writeValueAsString(obj),
            ...
            for (Entry<String, Object> paramEntry : formParams.entrySet()) {
                ...
                if (value instanceof File) {
                    ...
                    if (charset != null) {
                        ContentType customContentType = ContentType.create(ContentType.TEXT_PLAIN.getMimeType(),
                                charset);
    ...
    public <T> T deserialize(CloseableHttpResponse response, TypeReference<T> valueType)
        ...
        if (mimeType == null || isJsonMime(mimeType)) {
            ...
            throw new ApiException(
                    ...
                    response.getCode(), responseHeaders, EntityUtils.toString(entity));
        }
    }
