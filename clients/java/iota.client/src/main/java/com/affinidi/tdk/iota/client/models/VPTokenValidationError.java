...
public class VPTokenValidationError {
  ...
  public enum NameEnum {
    VP_TOKEN_VALIDATION_ERROR(String.valueOf("VPTokenValidationError"));
  ...
  public enum MessageEnum {
    VP_TOKEN_VALIDATION_ENDED_WITH_AN_ERROR(String.valueOf("VP token validation ended with an error"));
  ...
  public VPTokenValidationError name(@javax.annotation.Nonnull NameEnum name) {
  ...
  public VPTokenValidationError message(@javax.annotation.Nonnull MessageEnum message) {
  ...
  public VPTokenValidationError httpStatusCode(@javax.annotation.Nonnull HttpStatusCodeEnum httpStatusCode) {
  ...
  public VPTokenValidationError traceId(@javax.annotation.Nonnull String traceId) {
  ...
  public VPTokenValidationError details(@javax.annotation.Nullable List<InvalidParameterErrorDetailsInner> details) {
