 ...
 */
@JsonPropertyOrder({ CorsInitiateDataSharingRequestOK.JSON_PROPERTY_CORS_INITIATE_DATA_SHARING_REQUEST_OK })
...
public class CorsInitiateDataSharingRequestOK {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.corsInitiateDataSharingRequestOk,
    ...
    public String toString() {
        ...
        sb.append("    corsInitiateDataSharingRequestOk: ").append(toIndentedString(corsInitiateDataSharingRequestOk))
                .append("\n");
        sb.append("}");
        return sb.toString();
    }
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getCorsInitiateDataSharingRequestOk() != null) {
            try {
                joiner.add(String.format("%scorsInitiateDataSharingRequestOk%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getCorsInitiateDataSharingRequestOk()), "UTF-8")
                                .replaceAll("\\+", "%20")));
