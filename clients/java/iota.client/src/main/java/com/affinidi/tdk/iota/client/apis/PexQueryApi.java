...
public class PexQueryApi extends BaseApi {
     ...
     *            ID of the Affinidi Iota Framework configuration. (required)
     * @param createPexQueryInput
     *            CreatePexQuery (required)
     *
     * @return PexQueryDto
     *
     * @throws ApiException
    ...
    public PexQueryDto createPexQuery(String configurationId, CreatePexQueryInput createPexQueryInput,
        ...
        if (createPexQueryInput == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'createPexQueryInput' when calling createPexQuery");
        }

        // create path and map variables
        String localVarPath = "/v1/configurations/{configurationId}/pex-queries".replaceAll(
                "\\{" + "configurationId" + "\\}",
     ...
     * @param configurationId
     *            ID of the Affinidi Iota Framework configuration. (required)
     * @param deletePexQueriesInput
     *            DeletePexQueriesInput (required)
     *
     * @return Object
     *
     * @throws ApiException
    ...
    public Object deletePexQueries(String configurationId, DeletePexQueriesInput deletePexQueriesInput,
        ...
        if (configurationId == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'configurationId' when calling deletePexQueries");
        }

        // verify the required parameter 'deletePexQueriesInput' is set
        if (deletePexQueriesInput == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'deletePexQueriesInput' when calling deletePexQueries");
        }

        // create path and map variables
        String localVarPath = "/v1/configurations/{configurationId}/delete-queries".replaceAll(
                "\\{" + "configurationId" + "\\}",
                apiClient.escapeString(apiClient.parameterToString(configurationId)));
     ...
     *             if fails to make API call
     */
    public void deletePexQueryById(String configurationId, String queryId, Map<String, String> additionalHeaders)
            throws ApiException {
        ...
        if (configurationId == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'configurationId' when calling deletePexQueryById");
        }
     ...
     *             if fails to make API call
     */
    public PexQueryDto getPexQueryById(String configurationId, String queryId, Map<String, String> additionalHeaders)
            throws ApiException {
        Object localVarPostBody = null;
        ...
        if (configurationId == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'configurationId' when calling getPexQueryById");
        }
     ...
     *             if fails to make API call
     */
    public ListPexQueriesOK listPexQueries(String configurationId, Integer limit, String exclusiveStartKey)
            throws ApiException {
     ...
     * @param configurationId
     *            ID of the Affinidi Iota Framework configuration. (required)
     * @param savePexQueriesUpdateInput
     *            SavePexQueriesInput (required)
     *
     * @return Object
     *
     * @throws ApiException
    ...
    public Object savePexQueries(String configurationId, SavePexQueriesUpdateInput savePexQueriesUpdateInput,
        ...
        if (savePexQueriesUpdateInput == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'savePexQueriesUpdateInput' when calling savePexQueries");
        }

        // create path and map variables
        String localVarPath = "/v1/configurations/{configurationId}/save-queries".replaceAll(
                "\\{" + "configurationId" + "\\}",
                apiClient.escapeString(apiClient.parameterToString(configurationId)));
     ...
     * @param queryId
     *            The ID of the query. (required)
     * @param updatePexQueryInput
     *            UpdatePexQueryById (required)
     *
     * @return PexQueryDto
     *
     * @throws ApiException
     *             if fails to make API call
     */
    public PexQueryDto updatePexQueryById(String configurationId, String queryId,
            UpdatePexQueryInput updatePexQueryInput) throws ApiException {
     ...
     */
    public PexQueryDto updatePexQueryById(String configurationId, String queryId,
            UpdatePexQueryInput updatePexQueryInput, Map<String, String> additionalHeaders) throws ApiException {
        Object localVarPostBody = updatePexQueryInput;

        // verify the required parameter 'configurationId' is set
        if (configurationId == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'configurationId' when calling updatePexQueryById");
        }
        ...
        if (updatePexQueryInput == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'updatePexQueryInput' when calling updatePexQueryById");
        }
