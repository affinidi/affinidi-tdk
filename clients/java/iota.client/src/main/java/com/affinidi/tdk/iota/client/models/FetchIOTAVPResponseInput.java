 ...
 */
@JsonPropertyOrder({ FetchIOTAVPResponseInput.JSON_PROPERTY_CORRELATION_ID,
        FetchIOTAVPResponseInput.JSON_PROPERTY_TRANSACTION_ID, FetchIOTAVPResponseInput.JSON_PROPERTY_RESPONSE_CODE,
...
public class FetchIOTAVPResponseInput {
    ...
    /**
     * A unique, randomly generated identifier data-sharing request flow is initiated. This value is used with the
     * response code to fetch the callback response data.
     *
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getResponseCode() != null) {
            try {
                joiner.add(String.format("%sresponseCode%s=%s", prefix, suffix,
