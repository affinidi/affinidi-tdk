 ...
 */
@JsonPropertyOrder({
  MessagePublishingError.JSON_PROPERTY_NAME,
  MessagePublishingError.JSON_PROPERTY_MESSAGE,
  MessagePublishingError.JSON_PROPERTY_HTTP_STATUS_CODE,
...
public class MessagePublishingError {
  ...
  public enum NameEnum {
    MESSAGE_PUBLISHING_ERROR(String.valueOf("MessagePublishingError"));
  ...
  public enum MessageEnum {
    NOT_ABLE_TO_PUBLISH_MESSAGES_TO_TOPIC(String.valueOf("Not able to publish messages to topic"));
  ...
  public MessagePublishingError name(@javax.annotation.Nonnull NameEnum name) {
  ...
  public MessagePublishingError message(@javax.annotation.Nonnull MessageEnum message) {
  ...
  public MessagePublishingError httpStatusCode(@javax.annotation.Nonnull HttpStatusCodeEnum httpStatusCode) {
  ...
  public MessagePublishingError traceId(@javax.annotation.Nonnull String traceId) {
  ...
  public MessagePublishingError details(@javax.annotation.Nullable List<InvalidParameterErrorDetailsInner> details) {
