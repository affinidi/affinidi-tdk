 ...
 */
@JsonPropertyOrder({ UpdateConfigurationByIdOK.JSON_PROPERTY_UPDATE_CONFIGURATION_BY_ID_OK })
...
public class UpdateConfigurationByIdOK {
    ...
    public String toUrlQueryString(String prefix) {
        ...
        // add `updateConfigurationByIdOk` to the URL query string
        if (getUpdateConfigurationByIdOk() != null) {
            try {
                joiner.add(String.format("%supdateConfigurationByIdOk%s=%s", prefix, suffix, URLEncoder
                        .encode(String.valueOf(getUpdateConfigurationByIdOk()), "UTF-8").replaceAll("\\+", "%20")));
