 ...
 * PrepareRequest
 */
@JsonPropertyOrder({ PrepareRequest.JSON_PROPERTY_CONNECTION_CLIENT_ID, PrepareRequest.JSON_PROPERTY_QUERY_ID,
        PrepareRequest.JSON_PROPERTY_CORRELATION_ID, PrepareRequest.JSON_PROPERTY_TOKEN_MAX_AGE,
...
public class PrepareRequest {
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getAudience() != null) {
            try {
                joiner.add(String.format("%saudience%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getAudience()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
