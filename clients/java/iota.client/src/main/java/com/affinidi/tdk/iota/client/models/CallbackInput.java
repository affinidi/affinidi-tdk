 ...
 * CallbackInput
 */
@JsonPropertyOrder({ CallbackInput.JSON_PROPERTY_STATE, CallbackInput.JSON_PROPERTY_PRESENTATION_SUBMISSION,
        CallbackInput.JSON_PROPERTY_VP_TOKEN, CallbackInput.JSON_PROPERTY_ERROR,
        CallbackInput.JSON_PROPERTY_ERROR_DESCRIPTION, CallbackInput.JSON_PROPERTY_ONBOARDED })
...
public class CallbackInput {
    ...
    /**
     * A short string indicating the error code reported by the service. It follows the OAuth 2.0 error code format
     * (e.g., invalid_request, access_denied). The default is access_denied.
     *
     * @return error
     */
    @javax.annotation.Nullable
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getOnboarded() != null) {
            try {
                joiner.add(String.format("%sonboarded%s=%s", prefix, suffix,
                        URLEncoder.encode(String.valueOf(getOnboarded()), "UTF-8").replaceAll("\\+", "%20")));
            } catch (UnsupportedEncodingException e) {
                // Should never happen, UTF-8 is always supported
                throw new RuntimeException(e);
            }
