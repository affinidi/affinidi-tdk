 ...
 */
@JsonPropertyOrder({ InitiateDataSharingRequestInput.JSON_PROPERTY_QUERY_ID,
        InitiateDataSharingRequestInput.JSON_PROPERTY_CORRELATION_ID,
        InitiateDataSharingRequestInput.JSON_PROPERTY_TOKEN_MAX_AGE,
        InitiateDataSharingRequestInput.JSON_PROPERTY_NONCE, InitiateDataSharingRequestInput.JSON_PROPERTY_REDIRECT_URI,
...
public class InitiateDataSharingRequestInput {
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getRedirectUri() != null) {
            try {
                joiner.add(String.format("%sredirectUri%s=%s", prefix, suffix,
