...
public class CorsFetchIotaVpResponseOK {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getCorsFetchIotaVpResponseOk() != null) {
      try {
        joiner.add(String.format("%scorsFetchIotaVpResponseOk%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getCorsFetchIotaVpResponseOk()), "UTF-8").replaceAll("\\+", "%20")));
