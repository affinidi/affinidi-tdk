...
public class CorsIotaExchangeCredentialsOK {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getCorsIotaExchangeCredentialsOk() != null) {
      try {
        joiner.add(String.format("%scorsIotaExchangeCredentialsOk%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getCorsIotaExchangeCredentialsOk()), "UTF-8").replaceAll("\\+", "%20")));
