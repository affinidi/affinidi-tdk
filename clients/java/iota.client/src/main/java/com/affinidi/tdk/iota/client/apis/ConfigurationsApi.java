...
public class ConfigurationsApi extends BaseApi {
     ...
     *
     * @param createIotaConfigurationInput
    ...
    public IotaConfigurationDto createIotaConfiguration(CreateIotaConfigurationInput createIotaConfigurationInput,
        ...
        if (createIotaConfigurationInput == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'createIotaConfigurationInput' when calling createIotaConfiguration");
        }
     ...
     *             if fails to make API call
     */
    public void deleteIotaConfigurationById(String configurationId, Map<String, String> additionalHeaders)
            throws ApiException {
        ...
        if (configurationId == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'configurationId' when calling deleteIotaConfigurationById");
        }

        // create path and map variables
        String localVarPath = "/v1/configurations/{configurationId}".replaceAll("\\{" + "configurationId" + "\\}",
     ...
     *             if fails to make API call
     */
    public IotaConfigurationDto getIotaConfigurationById(String configurationId, Map<String, String> additionalHeaders)
            throws ApiException {
        Object localVarPostBody = null;
        ...
        if (configurationId == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'configurationId' when calling getIotaConfigurationById");
        }
    ...
    public GetIotaConfigurationMetaDataOK getIotaConfigurationMetaData(String projectId, String configurationId,
        ...
        if (projectId == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'projectId' when calling getIotaConfigurationMetaData");
        }

        // verify the required parameter 'configurationId' is set
        if (configurationId == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'configurationId' when calling getIotaConfigurationMetaData");
        }
     ...
     * @param configurationId
     *            ID of the Affinidi Iota Framework configuration. (required)
     * @param updateConfigurationByIdInput
     *            UpdateConfigurationById (required)
     *
     * @return IotaConfigurationDto
     *
     * @throws ApiException
     *             if fails to make API call
     */
    public IotaConfigurationDto updateIotaConfigurationById(String configurationId,
            UpdateConfigurationByIdInput updateConfigurationByIdInput) throws ApiException {
     ...
     */
    public IotaConfigurationDto updateIotaConfigurationById(String configurationId,
            UpdateConfigurationByIdInput updateConfigurationByIdInput, Map<String, String> additionalHeaders)
            throws ApiException {
        ...
        if (configurationId == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'configurationId' when calling updateIotaConfigurationById");
        }

        // verify the required parameter 'updateConfigurationByIdInput' is set
        if (updateConfigurationByIdInput == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'updateConfigurationByIdInput' when calling updateIotaConfigurationById");
        }
