 ...
 */
@JsonPropertyOrder({
  ResourceLimitExceededError.JSON_PROPERTY_NAME,
  ResourceLimitExceededError.JSON_PROPERTY_MESSAGE,
  ResourceLimitExceededError.JSON_PROPERTY_HTTP_STATUS_CODE,
...
public class ResourceLimitExceededError {
  ...
  public enum NameEnum {
    RESOURCE_LIMIT_EXCEEDED_ERROR(String.valueOf("ResourceLimitExceededError"));
  ...
  public enum MessageEnum {
    RESOURCE_LIMIT_EXCEEDED_PARAM_(String.valueOf("Resource limit exceeded: ${param}."));
  ...
  public enum HttpStatusCodeEnum {
    NUMBER_422(Integer.valueOf(422));
  ...
  public ResourceLimitExceededError name(@javax.annotation.Nonnull NameEnum name) {
  ...
  public ResourceLimitExceededError message(@javax.annotation.Nonnull MessageEnum message) {
  ...
  public ResourceLimitExceededError httpStatusCode(@javax.annotation.Nonnull HttpStatusCodeEnum httpStatusCode) {
  ...
  public ResourceLimitExceededError traceId(@javax.annotation.Nonnull String traceId) {
  ...
  public ResourceLimitExceededError details(@javax.annotation.Nullable List<InvalidParameterErrorDetailsInner> details) {
