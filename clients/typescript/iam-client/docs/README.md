...
| ----------------- | ---------------------------------------------------------------------------------- | ------------------------------------------------ | --------------------------------------- |
| _AuthzApi_        | [**deleteAccessVfs**](Apis/AuthzApi.md#deleteaccessvfs)                            | **DELETE** /v1/authz/vfs/access/{subjectDID}     | delete access of subjectDiD             |
...
| _AuthzApi_        | [**updateAccessVfs**](Apis/AuthzApi.md#updateaccessvfs)                            | **PUT** /v1/authz/vfs/access/{subjectDID}        | Update access of subjectDiD             |
