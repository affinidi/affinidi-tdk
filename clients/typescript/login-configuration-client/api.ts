  ...
  return {
    ...
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap['AllowListApi.allowGroups']?.[
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AllowListApi.disallowGroups']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
...
export const ConfigurationApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['ConfigurationApi.listLoginConfigurations']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
...
export const DenyListApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['DenyListApi.blockGroups']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['DenyListApi.blockUsers']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['DenyListApi.listBlockedGroups']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['DenyListApi.listBlockedUsers']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['DenyListApi.unblockGroups']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['DenyListApi.unblockUsers']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
...
export const GroupApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['GroupApi.addUserToGroup']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['GroupApi.listGroupUserMappings']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['GroupApi.removeUserFromGroup']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
...
export const GroupApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    listGroups(options?: RawAxiosRequestConfig): AxiosPromise<GroupsList> {
      return localVarFp
        .listGroups(options)
        .then((request) => request(axios, basePath))
    },
...
export const IdpApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['IdpApi.v1LoginProjectProjectIdUserinfoGet']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
