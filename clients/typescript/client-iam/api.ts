  ...
  return {
    ...
    > {
      ...
      const operationBasePath =
        operationServerMap['ConsumerAuthApi.consumerAuthTokenEndpoint']?.[index]
          ?.url;
...
export const CorsApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    corsConsumerAuthTokenEndpoint: async (
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      const localVarPath = `/v1/consumer/oauth2/token`;
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const CorsApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async corsConsumerAuthTokenEndpoint(
      options?: RawAxiosRequestConfig
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<CorsConsumerAuthTokenEndpointOK>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.corsConsumerAuthTokenEndpoint(options);
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['CorsApi.corsConsumerAuthTokenEndpoint']?.[index]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
...
export const CorsApiFactory = function (
  ...
  return {
    ...
    corsConsumerAuthTokenEndpoint(
      ...
      return localVarFp
        .corsConsumerAuthTokenEndpoint(options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class CorsApi extends BaseAPI {
   ...
   * @memberof CorsApi
   */
  public corsConsumerAuthTokenEndpoint(options?: RawAxiosRequestConfig) {
...
export const DefaultApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    v1IdpUiProxyDelete: async (
      proxy: string,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'proxy' is not null or undefined
      assertParamExists('v1IdpUiProxyDelete', 'proxy', proxy);
      const localVarPath = `/v1/idp/ui/{proxy+}`.replace(
        `{${'proxy'}}`,
        encodeURIComponent(String(proxy))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const DefaultApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.v1AuthAdminProxyDelete(proxy, options);
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['DefaultApi.v1AuthAdminProxyDelete']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.v1AuthAdminProxyGet(proxy, options);
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['DefaultApi.v1AuthAdminProxyGet']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.v1AuthAdminProxyPatch(proxy, options);
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['DefaultApi.v1AuthAdminProxyPatch']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.v1AuthAdminProxyPost(proxy, options);
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['DefaultApi.v1AuthAdminProxyPost']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.v1AuthAdminProxyPut(proxy, options);
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['DefaultApi.v1AuthAdminProxyPut']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.v1IdpUiProxyDelete(proxy, options);
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['DefaultApi.v1IdpUiProxyDelete']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async v1IdpUiProxyGet(
      proxy: string,
      options?: RawAxiosRequestConfig
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v1IdpUiProxyGet(
        proxy,
        options
      );
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['DefaultApi.v1IdpUiProxyGet']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.v1IdpUiProxyPatch(proxy, options);
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['DefaultApi.v1IdpUiProxyPatch']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.v1IdpUiProxyPost(proxy, options);
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['DefaultApi.v1IdpUiProxyPost']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async v1IdpUiProxyPut(
      proxy: string,
      options?: RawAxiosRequestConfig
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v1IdpUiProxyPut(
        proxy,
        options
      );
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['DefaultApi.v1IdpUiProxyPut']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const DefaultApiFactory = function (
  ...
  return {
    ...
    v1AuthAdminProxyDelete(proxy: string, options?: any): AxiosPromise<void> {
      return localVarFp
        .v1AuthAdminProxyDelete(proxy, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    v1AuthAdminProxyGet(proxy: string, options?: any): AxiosPromise<void> {
      return localVarFp
        .v1AuthAdminProxyGet(proxy, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    v1AuthAdminProxyPatch(proxy: string, options?: any): AxiosPromise<void> {
      return localVarFp
        .v1AuthAdminProxyPatch(proxy, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    v1AuthAdminProxyPost(proxy: string, options?: any): AxiosPromise<void> {
      return localVarFp
        .v1AuthAdminProxyPost(proxy, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    v1AuthAdminProxyPut(proxy: string, options?: any): AxiosPromise<void> {
      return localVarFp
        .v1AuthAdminProxyPut(proxy, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    v1IdpUiProxyDelete(proxy: string, options?: any): AxiosPromise<void> {
      return localVarFp
        .v1IdpUiProxyDelete(proxy, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    v1IdpUiProxyPatch(proxy: string, options?: any): AxiosPromise<void> {
      return localVarFp
        .v1IdpUiProxyPatch(proxy, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    v1IdpUiProxyPost(proxy: string, options?: any): AxiosPromise<void> {
      return localVarFp
        .v1IdpUiProxyPost(proxy, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
...
export const PoliciesApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['PoliciesApi.getPolicies']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['PoliciesApi.updatePolicies']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const ProjectsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['ProjectsApi.addPrincipalToProject']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['ProjectsApi.createProject']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['ProjectsApi.deletePrincipalFromProject']?.[index]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['ProjectsApi.listPrincipalsOfProject']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['ProjectsApi.listProject']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['ProjectsApi.updateProject']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const StsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['StsApi.createProjectScopedToken']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['StsApi.whoami']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const TokensApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['TokensApi.createToken']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['TokensApi.deleteToken']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['TokensApi.getToken']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['TokensApi.listToken']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['TokensApi.updateToken']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const WellKnownApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    WellKnownApiAxiosParamCreator(configuration);
  return {
    /**
     *
     * @param {*} [options] Override http request option.
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['WellKnownApi.getWellKnownJwks']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const XAffinidiTdkApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['XAffinidiTdkApi.addPrincipalToProject']?.[index]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['XAffinidiTdkApi.consumerAuthTokenEndpoint']?.[index]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['XAffinidiTdkApi.createProject']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['XAffinidiTdkApi.createProjectScopedToken']?.[index]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['XAffinidiTdkApi.createToken']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['XAffinidiTdkApi.deletePrincipalFromProject']?.[
          index
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['XAffinidiTdkApi.deleteToken']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['XAffinidiTdkApi.getPolicies']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['XAffinidiTdkApi.getToken']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['XAffinidiTdkApi.getWellKnownJwks']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['XAffinidiTdkApi.listPrincipalsOfProject']?.[index]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['XAffinidiTdkApi.listProject']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['XAffinidiTdkApi.listToken']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['XAffinidiTdkApi.updatePolicies']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['XAffinidiTdkApi.updateProject']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['XAffinidiTdkApi.updateToken']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['XAffinidiTdkApi.v1AuthProxyDelete']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['XAffinidiTdkApi.v1AuthProxyGet']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['XAffinidiTdkApi.v1AuthProxyPatch']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['XAffinidiTdkApi.v1AuthProxyPost']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['XAffinidiTdkApi.v1AuthProxyPut']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['XAffinidiTdkApi.v1IdpProxyDelete']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['XAffinidiTdkApi.v1IdpProxyGet']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['XAffinidiTdkApi.v1IdpProxyPatch']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['XAffinidiTdkApi.v1IdpProxyPost']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['XAffinidiTdkApi.v1IdpProxyPut']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap['XAffinidiTdkApi.whoami']?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
