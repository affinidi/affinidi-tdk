...
export interface WalletV2Dto {
  ...
  /**
   *
   * @type {Array<WalletV2DtoKeysInner>}
   * @memberof WalletV2Dto
   */
  keys?: Array<WalletV2DtoKeysInner>
  /**
 ...
 *
 * @export
 * @interface WalletV2DtoKeysInner
 */
export interface WalletV2DtoKeysInner {
  /**
   * wallet-scoped key identifier (e.g., \"key-1\")
   * @type {string}
   * @memberof WalletV2DtoKeysInner
   */
  keyId: string
  /**
