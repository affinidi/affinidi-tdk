...
| _ConfigurationApi_ | [**getConfiguration**](Apis/ConfigurationApi.md#getconfiguration)       | **GET** /v1/config                                    | Retrieves the user profile name and the maximum number of profiles, with default values set to 'default' and 1, respectively.                                                                                                 |
...
- [CorsGetConfigurationOK](./Models/CorsGetConfigurationOK.md)
