...
| _PexQueryApi_       | [**deletePexQueries**](Apis/PexQueryApi.md#deletepexqueries)                                 | **POST** /v1/configurations/{configurationId}/delete-queries               | deletes pex queries                                               |
...
| _PexQueryApi_       | [**savePexQueries**](Apis/PexQueryApi.md#savepexqueries)                                     | **POST** /v1/configurations/{configurationId}/save-queries                 | saves all pex queries                                             |
