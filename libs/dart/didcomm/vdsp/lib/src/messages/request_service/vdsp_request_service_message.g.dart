...
part of 'vdsp_request_service_message.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

VdspRequestServiceMessage _$VdspRequestServiceMessageFromJson(
...
Map<String, dynamic> _$VdspRequestServiceMessageToJson(
        VdspRequestServiceMessage instance) =>
    <String, dynamic>{
      'id': instance.id,
